...
Module Admin
    ...
    Function VersionOK(Ver As String) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
        ...
        Try
            ...
            Call _
                SendData(SendTarget.ToAll, 0,
                         PrepareMessageConsoleMsg("Servidor> Iniciando WorldSave", FontTypeNames.FONTTYPE_SERVER))
    ...
    Public Sub Encarcelar(UserIndex As Short, Minutos As Integer,
    ...
    Public Sub BorrarUsuario(UserName As String)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Function BANCheck(name As String) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Function MD5ok(md5formateado As String) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Sub BanIpAgrega(ip As String)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Function BanIpBuscar(ip As String) As Integer
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Function BanIpQuita(ip As String) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Function UserDarPrivilegioLevel(name As String) As PlayerType
        '***************************************************
        'Author: Unknown
    ...
    Public Sub BanCharacter(bannerUserIndex As Short, UserName As String, reason As String)
        '***************************************************
