    ...
    static class SecurityIp
    {
        ...
        public static bool IPSecuritySuperaLimiteConexiones(int ip)
        {
            ...
            if (IpTableIndex >= 0)
            {
                ...
                {
                    General.LogIP("Agregamos conexion a " + ip + " iptableindex=" + IpTableIndex + ". Conexiones: " + MaxConTables[IpTableIndex + 1]);
                ...
                {
                    General.LogIP("rechazamos conexion de " + ip + " iptableindex=" + IpTableIndex + ". Conexiones: " + MaxConTables[IpTableIndex + 1]);
            ...
            else
            {
                ...
                {
                    string argdesc = "SecurityIP.IPSecuritySuperaLimiteConexiones: Se supero la disponibilidad de slots.";
        ...
        public static void DumpTables()
        {
            ...
            {
                string argdesc = wskapiAO.GetAscIP(MaxConTables[i]) + " > " + MaxConTables[i + 1];
                General.LogCriticEvent(ref argdesc);
            }
        }
    }
