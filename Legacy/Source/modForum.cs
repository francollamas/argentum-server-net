...
namespace Legacy
{
    static class modForum
    {
        ...
        public struct tForo
        {
            [VBFixedArray(MAX_MENSAJES_FORO)]
            public tPost[] vsPost;
            [VBFixedArray(MAX_ANUNCIOS_FORO)]
        ...
        public static void AddForum(string sForoID)
        {
...

            {
                ...
                if (System.IO.File.Exists(ForumPath))
                {
                    ...
                    withBlock.CantPosts = Convert.ToByte(Migration.ParseVal(ES.GetVar(ForumPath, "INFO", "CantMSG", EmptySpaces: ref argEmptySpaces)));
                    int argEmptySpaces1 = 1024;
                    withBlock.CantAnuncios = Convert.ToByte(Migration.ParseVal(ES.GetVar(ForumPath, "INFO", "CantAnuncios", EmptySpaces: ref argEmptySpaces1)));
                    ...
                    for (PostIndex = 1; PostIndex <= loopTo; PostIndex++)
                    {
                        ...
                        using (var reader = new System.IO.StreamReader(PostPath))
                        {
                            // Titulo
        ...
        private static void SaveForum(short ForumIndex)
        {
...

            {
                ...
                ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + "Foros/" + withBlock.ID + ".for", "INFO", "CantMSG", withBlock.CantPosts.ToString());
                ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + "Foros/" + withBlock.ID + ".for", "INFO", "CantAnuncios", withBlock.CantAnuncios.ToString());
                ...
                for (PostIndex = 1; PostIndex <= loopTo; PostIndex++)
                {
                    ...
                    using (var writer = new System.IO.StreamWriter(PostPath))
                    {
        ...
        public static void CleanForum(short ForumIndex)
        {
...

            {
                ...
                if (System.IO.File.Exists(ForumPath))
                {
                    ...
                    int argEmptySpaces = 1024;
                    NumPost = Convert.ToInt16(Migration.ParseVal(ES.GetVar(ForumPath, "INFO", "CantMSG", EmptySpaces: ref argEmptySpaces)));

                    // Elimino los post viejos
                    var loopTo = NumPost;
                    for (PostIndex = 1; PostIndex <= loopTo; PostIndex++)
                        FileSystem.Kill(AppDomain.CurrentDomain.BaseDirectory + "Foros/" + withBlock.ID + PostIndex + ".for");


                    int argEmptySpaces1 = 1024;
                    NumPost = Convert.ToInt16(Migration.ParseVal(ES.GetVar(ForumPath, "INFO", "CantAnuncios", EmptySpaces: ref argEmptySpaces1)));

                    // Elimino los post viejos
                    var loopTo1 = NumPost;
                    for (PostIndex = 1; PostIndex <= loopTo1; PostIndex++)
                        FileSystem.Kill(AppDomain.CurrentDomain.BaseDirectory + "Foros/" + withBlock.ID + PostIndex + "a.for");
        ...
        public static bool SendPosts(short UserIndex, ref string ForoID)
        {
            ...
            if (ForumIndex > 0)
            {
                    ...
                    {
                        {
                            ...
                            Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieGeneral, withBlock1.sTitulo, withBlock1.Autor, withBlock1.sPost);
                        }
                    }
                    ...
                    {
                        {
                            ...
                            Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieGENERAL_STICKY, withBlock2.sTitulo, withBlock2.Autor, withBlock2.sPost);
                        }
                    }
                ...
                if (Extra.esCaos(UserIndex) | bEsGm)
                {
                    ...
                    string argsForoID = FORO_CAOS_ID;
...

                    {
                        ...
                        for (PostIndex = 1; PostIndex <= loopTo2; PostIndex++)
                        {

                            {
                                ...
                                Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieCAOS, withBlock4.sTitulo, withBlock4.Autor, withBlock4.sPost);
                            }
                        ...
                        {
                            {
                                ...
                                Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieCAOS_STICKY, withBlock5.sTitulo, withBlock5.Autor, withBlock5.sPost);
                            }
                        }
                ...
                if (Extra.esArmada(UserIndex) | bEsGm)
                {
                    ...
                    string argsForoID1 = FORO_REAL_ID;
...

                    {
                        ...
                        for (PostIndex = 1; PostIndex <= loopTo4; PostIndex++)
                        {

                            {
                                ...
                                Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieREAL, withBlock7.sTitulo, withBlock7.Autor, withBlock7.sPost);
                            }
                        ...
                        {
                            {
                                ...
                                Protocol.WriteAddForumMsg(UserIndex, (Declaraciones.eForumType)Declaraciones.eForumMsgType.ieREAL_STICKY, withBlock8.sTitulo, withBlock8.Autor, withBlock8.sPost);
                            }
                        }
