...
namespace Legacy
{
    static class Declaraciones
    {
        ...
        // 
        public static List<WorldPos> TrashCollector = new List<WorldPos>();
        ...
        public const string STANDARD_BOUNTY_HUNTER_MESSAGE = "Se te ha otorgado un premio por ayudar al proyecto reportando bugs, el mismo está disponible en tu bóveda.";
        ...
        public struct Inventario
        {
            ...
            [VBFixedArray(MAX_INVENTORY_SLOTS)]
        ...
        public struct tForo
        {
            [VBFixedArray(MAX_STICKY_POST)]
            public string[] StickyTitle;
            [VBFixedArray(MAX_STICKY_POST)]
            public string[] StickyPost;
            [VBFixedArray(MAX_GENERAL_POST)]
        ...
        public static List<string> BanIps = new List<string>();
        ...
        public static cCola Ayuda = new cCola();
        public static ConsultasPopulares ConsultaPopular = new ConsultasPopulares();
        public static SoundMapInfo SonidosMapas = new SoundMapInfo();
