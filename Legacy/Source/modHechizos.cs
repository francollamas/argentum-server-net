    ...
    static class modHechizos
    {
        ...
        public static void NpcLanzaSpellSobreUser(short NpcIndex, short UserIndex, short Spell)
        {
            ...
            if (Declaraciones.Npclist[NpcIndex].CanAttack == 0)
                return;
            if (Declaraciones.UserList[UserIndex].flags.invisible == 1 | Declaraciones.UserList[UserIndex].flags.Oculto == 1)
                return;
...

            {
                ...
                if (Declaraciones.Hechizos[Spell].SubeHP == 1)
                {
                    ...
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Hechizos[Spell].WAV), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, Declaraciones.Hechizos[Spell].FXgrh, Declaraciones.Hechizos[Spell].loops));
                ...
                else if (Declaraciones.Hechizos[Spell].SubeHP == 2)
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                    {
                        ...
                        {
                            daño = Convert.ToInt16(daño - Matematicas.RandomNumber(Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].DefensaMagicaMin, Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].DefensaMagicaMax));
                        }

                        if (withBlock.Invent.AnilloEqpObjIndex > 0)
                        {
                            daño = Convert.ToInt16(daño - Matematicas.RandomNumber(Declaraciones.ObjData_Renamed[withBlock.Invent.AnilloEqpObjIndex].DefensaMagicaMin, Declaraciones.ObjData_Renamed[withBlock.Invent.AnilloEqpObjIndex].DefensaMagicaMax));
                        }
                ...
                if (Declaraciones.Hechizos[Spell].Paraliza == 1 | Declaraciones.Hechizos[Spell].Inmoviliza == 1)
                {
                    if (withBlock.flags.Paralizado == 0)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, " Tu anillo rechaza los efectos del hechizo.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                            return;
                        }
        ...
        public static void NpcLanzaSpellSobreNpc(short NpcIndex, short TargetNPC, short Spell)
        {
            ...
            if (Declaraciones.Hechizos[Spell].SubeHP == 2)
            {
                ...
                daño = Convert.ToInt16(Matematicas.RandomNumber(Declaraciones.Hechizos[Spell].MinHp, Declaraciones.Hechizos[Spell].MaxHp));
                modSendData.SendData(modSendData.SendTarget.ToNPCArea, TargetNPC, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Hechizos[Spell].WAV), Convert.ToByte(Declaraciones.Npclist[TargetNPC].Pos.X), Convert.ToByte(Declaraciones.Npclist[TargetNPC].Pos.Y)));
                modSendData.SendData(modSendData.SendTarget.ToNPCArea, TargetNPC, Protocol.PrepareMessageCreateFX(Declaraciones.Npclist[TargetNPC].Char_Renamed.CharIndex, Declaraciones.Hechizos[Spell].FXgrh, Declaraciones.Hechizos[Spell].loops));
        ...
        public static void AgregarHechizo(short UserIndex, short Slot)
        {
...

            {
                ...
                if (!TieneHechizo(hIndex, UserIndex))
                {
                    ...
                    if (withBlock.Stats.UserHechizos[j] != 0)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes espacio para más hechizos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
            ...
            {
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageChatOverHead(SpellWords, withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Cyan)));
        ...
        public static bool PuedeLanzar(short UserIndex, short HechizoIndex)
        {
...

            {
                ...
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No puedes lanzar hechizos estando muerto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                ...
                if (Declaraciones.Hechizos[HechizoIndex].NeedStaff > 0)
                {
                    if (withBlock.clase == Declaraciones.eClass.Mage)
                    {
                        ...
                        {
                            if (Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].StaffPower < Declaraciones.Hechizos[HechizoIndex].NeedStaff)
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "No posees un báculo lo suficientemente poderoso para poder lanzar el conjuro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return PuedeLanzarRet;
                            }
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes lanzar este conjuro sin la ayuda de un báculo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeLanzarRet;
                        }
                    }
                }

                if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Magia] < Declaraciones.Hechizos[HechizoIndex].MinSkill)
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes puntos de magia para lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return PuedeLanzarRet;
                }
                ...
                if (withBlock.Stats.MinSta < Declaraciones.Hechizos[HechizoIndex].StaRequerido)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Estás muy cansado para lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Estás muy cansada para lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    return PuedeLanzarRet;
                }
                ...
                if (withBlock.clase == Declaraciones.eClass.Druid)
                {
                    ...
                    if (Declaraciones.Hechizos[HechizoIndex].Warp == 1)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Debes poseer toda tu maná para poder lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeLanzarRet;
                        }
                        // Si no tiene mascotas, no tiene sentido que lo use
                        else if (withBlock.NroMascotas == 0)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Debes poseer alguna mascota para poder lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeLanzarRet;
                        }
                    }
                }
                    ...
                    for (TempX = Convert.ToInt16(PosCasteadaX - 8); TempX <= loopTo; TempX++)
                    {
                        ...
                        for (TempY = Convert.ToInt16(PosCasteadaY - 8); TempY <= loopTo1; TempY++)
                        {
                            if (Extra.InMapBounds(PosCasteadaM, TempX, TempY))
                            {
                                ...
                                {
                                    // hay un user
                                    if (Declaraciones.UserList[Declaraciones.MapData[PosCasteadaM, TempX, TempY].UserIndex].flags.invisible == 1 & Declaraciones.UserList[Declaraciones.MapData[PosCasteadaM, TempX, TempY].UserIndex].flags.AdminInvisible == 0)

                                    {
                                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(Declaraciones.UserList[Declaraciones.MapData[PosCasteadaM, TempX, TempY].UserIndex].Char_Renamed.CharIndex, Declaraciones.Hechizos[H].FXgrh, Declaraciones.Hechizos[H].loops));
                                    }
                                }
                            }
                        }
        ...
        public static void HechizoInvocacion(short UserIndex, ref bool HechizoCasteado)
        {
            ...
            {
                {
                    ...
                    if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk == false | Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].trigger == Declaraciones.eTrigger.ZONASEGURA)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes invocar criaturas en zona segura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    ...
                    else
                    {
                        ...
                        for (NroNpcs = 1; NroNpcs <= loopTo; NroNpcs++)
                        {
                            ...
                            if (withBlock.NroMascotas < Declaraciones.MAXMASCOTAS)
                            {
                                NpcIndex = NPCs.SpawnNpc(Declaraciones.Hechizos[SpellIndex].NumNpc, ref TargetPos, true, false);
                                if (NpcIndex > 0)
                                {
            ...
            catch (Exception ex)
            {
                Console.WriteLine("Error in AgregarHechizo: " + ex.Message);
                {
                    ...
                    string argdesc = "[" + ex.GetType().Name + "] " + ex.Message + " por el usuario " + withBlock2.name + "(" + UserIndex + ") en (" + withBlock2.Pos.Map + ", " + withBlock2.Pos.X + ", " + withBlock2.Pos.Y + "). Tratando de tirar el hechizo " + Declaraciones.Hechizos[SpellIndex].Nombre + "(" + SpellIndex + ") en la posicion ( " + withBlock2.flags.TargetX + ", " + withBlock2.flags.TargetY + ")";
        ...
        public static void HandleHechizoNPC(short UserIndex, short HechizoIndex)
        {
...

            {
                ...
                if (HechizoCasteado)
                {
                    ...
                    // Quito la estamina requerida
                    withBlock.Stats.MinSta = (short)(withBlock.Stats.MinSta - Declaraciones.Hechizos[HechizoIndex].StaRequerido);
                    if (withBlock.Stats.MinSta < 0)
                        withBlock.Stats.MinSta = 0;
        ...
        public static void LanzarHechizo(short SpellIndex, short UserIndex)
        {
            ...
            try
            {

                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes lanzar hechizos si estás en consulta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                            ...
                            case Declaraciones.TargetType.uUsuarios:
                                {
                                    ...
                                    {
                                        if (Math.Abs((short)(Declaraciones.UserList[withBlock.flags.TargetUser].Pos.Y - withBlock.Pos.Y)) <= AI.RANGO_VISION_Y)
                                        {
                                            HandleHechizoUsuario(UserIndex, SpellIndex);
                                        }
                                        else
                                        {
                                            Protocol.WriteConsoleMsg(UserIndex, "Estás demasiado lejos para lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                                        }
                                    }
                                    else
                                    {
                                        Protocol.WriteConsoleMsg(UserIndex, "Este hechizo actúa sólo sobre usuarios.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    }
                            ...
                            case Declaraciones.TargetType.uNPC:
                                {
                                    ...
                                    {
                                        if (Math.Abs((short)(Declaraciones.Npclist[withBlock.flags.TargetNPC].Pos.Y - withBlock.Pos.Y)) <= AI.RANGO_VISION_Y)
                                        {
                                    ...
                                    {
                                        Protocol.WriteConsoleMsg(UserIndex, "Este hechizo sólo afecta a los npcs.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    }
                            ...
                            case Declaraciones.TargetType.uUsuariosYnpc:
                                {
                                    ...
                                    {
                                        Protocol.WriteConsoleMsg(UserIndex, "Target inválido.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en LanzarHechizo. Error " + ex.GetType().Name + " : " + ex.Message + " Hechizo: " + Declaraciones.Hechizos[SpellIndex].Nombre + "(" + SpellIndex + "). Casteado por: " + Declaraciones.UserList[UserIndex].name + "(" + UserIndex + ").";
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void HechizoEstadoUsuario(short UserIndex, ref bool HechizoCasteado)
        {
            ...
            bool EraCriminal;
            {
                ...
                if (Declaraciones.Hechizos[HechizoIndex].Invisibilidad == 1)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "¡El usuario está muerto!", Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    if (Declaraciones.UserList[TargetIndex].Counters.Saliendo)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡El hechizo no tiene efecto!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                            return;
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡No puedes hacerte invisible mientras te encuentras saliendo!", Protocol.FontTypeNames.FONTTYPE_WARNING);
                            HechizoCasteado = false;
                            return;
                        }
                    }
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "¡La invisibilidad no funciona aquí!", Protocol.FontTypeNames.FONTTYPE_INFO);
                        HechizoCasteado = false;
                        return;
                    }
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                    {
                        if ((int)(~Declaraciones.UserList[TargetIndex].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                        {
                            HechizoCasteado = false;
                            return;
                        }
                ...
                if (Declaraciones.Hechizos[HechizoIndex].Mimetiza == 1)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Ya te encuentras mimetizado. El hechizo no ha tenido efecto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    ...
                    withBlock.Char_Renamed.WeaponAnim = UsUaRiOs.GetWeaponAnim(UserIndex, Declaraciones.UserList[TargetIndex].Invent.WeaponEqpObjIndex);
                ...
                if (Declaraciones.Hechizos[HechizoIndex].Envenena == 1)
                {
                    if (UserIndex == TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes atacarte a vos mismo.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        return;
                    }
                ...
                if (Declaraciones.Hechizos[HechizoIndex].Paraliza == 1 | Declaraciones.Hechizos[HechizoIndex].Inmoviliza == 1)
                {
                    if (UserIndex == TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes atacarte a vos mismo.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    ...
                    if (Declaraciones.UserList[TargetIndex].flags.Paralizado == 0)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(TargetIndex, " Tu anillo rechaza los efectos del hechizo.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                            Protocol.WriteConsoleMsg(UserIndex, " ¡El hechizo no tiene efecto!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                ...
                if (Declaraciones.Hechizos[HechizoIndex].Revivir == 1)
                {
                    if (Declaraciones.UserList[TargetIndex].flags.Muerto == 1)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡El espíritu no tiene intenciones de regresar al mundo de los vivos!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                            return;
                        }
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡Revivir no está permitido aquí! Retirate de la Zona si deseas utilizar el Hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                            return;
                        }
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes resucitar si no tienes tu barra de energía llena.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                            return;
                        }
                        ...
                        if (withBlock.clase == Declaraciones.eClass.Mage)
                        {
                            if (withBlock.Invent.WeaponEqpObjIndex > 0)
                            {
                                if (Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].StaffPower < Declaraciones.Hechizos[HechizoIndex].NeedStaff)
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Necesitas un báculo mejor para lanzar este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    HechizoCasteado = false;
                                    return;
                                }
                            }
                        ...
                        {
                            if (withBlock.Invent.AnilloEqpObjIndex != Declaraciones.LAUDELFICO & withBlock.Invent.AnilloEqpObjIndex != Declaraciones.LAUDMAGICO)
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Necesitas un instrumento mágico para devolver la vida.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                HechizoCasteado = false;
                                return;
                            }
                        }
                        ...
                        {
                            if (withBlock.Invent.AnilloEqpObjIndex != Declaraciones.FLAUTAELFICA & withBlock.Invent.AnilloEqpObjIndex != Declaraciones.FLAUTAMAGICA)
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Necesitas un instrumento mágico para devolver la vida.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                HechizoCasteado = false;
                                return;
                        ...
                        if (!ES.criminal(TargetIndex))
                        {
                            if (TargetIndex != UserIndex)
                            {
                                ...
                                Protocol.WriteConsoleMsg(UserIndex, "¡Los Dioses te sonríen, has ganado 500 puntos de nobleza!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                        ...
                        if (SistemaCombate.TriggerZonaPelea(UserIndex, TargetIndex) != Declaraciones.eTrigger6.TRIGGER6_PERMITE)
                        {
                            // Solo saco vida si es User. no quiero que exploten GMs por ahi.
                            if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                            {
                                withBlock.Stats.MinHp = Convert.ToInt16(withBlock.Stats.MinHp * (1d - Declaraciones.UserList[TargetIndex].Stats.ELV * 0.015d));
                            }
                        }
                        ...
                        {
                            UsUaRiOs.UserDie(UserIndex);
                            Protocol.WriteConsoleMsg(UserIndex, "El esfuerzo de resucitar fue demasiado grande.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "El esfuerzo de resucitar te ha debilitado.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = true;
                        }
        ...
        public static void HechizoEstadoNPC(short NpcIndex, short SpellIndex, ref bool HechizoCasteado, short UserIndex)
        {
...

            {
                ...
                if (Declaraciones.Hechizos[SpellIndex].Paraliza == 1)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "El NPC es inmune a este hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        HechizoCasteado = false;
                        return;
                    }
                }
                ...
                if (Declaraciones.Hechizos[SpellIndex].RemoverParalisis == 1)
                {
                    if (withBlock.flags.Paralizado == 1 | withBlock.flags.Inmovilizado == 1)
                    {
                        ...
                        else if (withBlock.NPCtype == Declaraciones.eNPCType.GuardiaReal)
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Sólo puedes remover la parálisis de los Guardias si perteneces a su facción.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                HechizoCasteado = false;
                                return;
                            }

                            Protocol.WriteConsoleMsg(UserIndex, "Solo puedes remover la parálisis de los NPCs que te consideren su amo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            HechizoCasteado = false;
                            return;
                        }
                        else if (withBlock.NPCtype == Declaraciones.eNPCType.Guardiascaos)
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Solo puedes remover la parálisis de los Guardias si perteneces a su facción.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                HechizoCasteado = false;
                                return;
                            }
                        }
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Este NPC no está paralizado", Protocol.FontTypeNames.FONTTYPE_INFO);
                        HechizoCasteado = false;
                        return;
                    }
                }
                ...
                if (Declaraciones.Hechizos[SpellIndex].Inmoviliza == 1)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "El NPC es inmune al hechizo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                }
            }
            ...
            {
                {
                    ...
                    if (withBlock1.clase == Declaraciones.eClass.Druid)
                    {
                        ...
                        UsUaRiOs.ChangeUserChar(UserIndex, withBlock1.Char_Renamed.body, withBlock1.Char_Renamed.Head, (byte)withBlock1.Char_Renamed.heading, withBlock1.Char_Renamed.WeaponAnim, withBlock1.Char_Renamed.ShieldAnim, withBlock1.Char_Renamed.CascoAnim);
                    }

                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Sólo los druidas pueden mimetizarse con criaturas.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
        ...
        public static void HechizoPropNPC(short SpellIndex, short NpcIndex, short UserIndex, ref bool HechizoCasteado)
        {
...

            {
                ...
                {
                    daño = Matematicas.RandomNumber(Declaraciones.Hechizos[SpellIndex].MinHp, Declaraciones.Hechizos[SpellIndex].MaxHp);
                    ...
                    if (withBlock.Stats.MinHp > withBlock.Stats.MaxHp)
                        withBlock.Stats.MinHp = withBlock.Stats.MaxHp;
                    Protocol.WriteConsoleMsg(UserIndex, "Has curado " + daño + " puntos de vida a la criatura.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    HechizoCasteado = true;
                }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeHP == 2)
                {
                    ...
                    if (Declaraciones.Hechizos[SpellIndex].StaffAffected)
                    {
                        if (Declaraciones.UserList[UserIndex].clase == Declaraciones.eClass.Mage)
                        {
                            ...
                            {
                                daño = Convert.ToInt32(daño * (Declaraciones.ObjData_Renamed[Declaraciones.UserList[UserIndex].Invent.WeaponEqpObjIndex].StaffDamageBonus + 70) / 100d);
                            }
                            // Aumenta daño segun el staff-
                            // Daño = (Daño* (70 + BonifBáculo)) / 100
                            else
                            {
                                daño = Convert.ToInt32(daño * 0.7d);
                            } // Baja daño a 70% del original
                        }
                    }
                    if (Declaraciones.UserList[UserIndex].Invent.AnilloEqpObjIndex == Declaraciones.LAUDELFICO | Declaraciones.UserList[UserIndex].Invent.AnilloEqpObjIndex == Declaraciones.FLAUTAELFICA)
                    {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, NpcIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(withBlock.flags.Snd2), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                    }
                    ...
                    withBlock.Stats.MinHp = withBlock.Stats.MinHp - daño;
                    Protocol.WriteConsoleMsg(UserIndex, "¡Le has quitado " + daño + " puntos de vida a la criatura!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
        ...
        public static void InfoHechizo(short UserIndex)
        {
...

            {
                ...
                if (tUser > 0)
                {
                    ...
                    {
                        string argdatos = Protocol.PrepareMessageCreateFX(Declaraciones.UserList[tUser].Char_Renamed.CharIndex, Declaraciones.Hechizos[SpellIndex].FXgrh, Declaraciones.Hechizos[SpellIndex].loops);
                        TCP.EnviarDatosASlot(UserIndex, ref argdatos);
                        string argdatos1 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Hechizos[SpellIndex].WAV), Convert.ToByte(Declaraciones.UserList[tUser].Pos.X), Convert.ToByte(Declaraciones.UserList[tUser].Pos.Y));
                        TCP.EnviarDatosASlot(UserIndex, ref argdatos1);
                    }
                    else
                    {
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, tUser, Protocol.PrepareMessageCreateFX(Declaraciones.UserList[tUser].Char_Renamed.CharIndex, Declaraciones.Hechizos[SpellIndex].FXgrh, Declaraciones.Hechizos[SpellIndex].loops));
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, tUser, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Hechizos[SpellIndex].WAV), Convert.ToByte(Declaraciones.UserList[tUser].Pos.X), Convert.ToByte(Declaraciones.UserList[tUser].Pos.Y)));
                    } // Esta linea faltaba. Pablo (ToxicWaste)
                }
                else if (tNPC > 0)
                {
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, tNPC, Protocol.PrepareMessageCreateFX(Declaraciones.Npclist[tNPC].Char_Renamed.CharIndex, Declaraciones.Hechizos[SpellIndex].FXgrh, Declaraciones.Hechizos[SpellIndex].loops));
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, tNPC, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Hechizos[SpellIndex].WAV), Convert.ToByte(Declaraciones.Npclist[tNPC].Pos.X), Convert.ToByte(Declaraciones.Npclist[tNPC].Pos.Y)));
                }
                ...
                if (tUser > 0)
                {
                    if (UserIndex != tUser)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, Declaraciones.Hechizos[SpellIndex].HechizeroMsg + " " + Declaraciones.UserList[tUser].name, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(UserIndex, Declaraciones.Hechizos[SpellIndex].HechizeroMsg + " alguien.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                        Protocol.WriteConsoleMsg(tUser, withBlock.name + " " + Declaraciones.Hechizos[SpellIndex].TargetMsg, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, Declaraciones.Hechizos[SpellIndex].PropioMsg, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                }
                else if (tNPC > 0)
                {
                    Protocol.WriteConsoleMsg(UserIndex, Declaraciones.Hechizos[SpellIndex].HechizeroMsg + " " + "la criatura.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
            }
        }
        ...
        public static bool HechizoPropUsuario(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.Muerto != 0)
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No puedes lanzar este hechizo a un muerto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeHam == 1)
                {
                    ...
                    daño = Matematicas.RandomNumber(Declaraciones.Hechizos[SpellIndex].MinHam, Declaraciones.Hechizos[SpellIndex].MaxHam);
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has restaurado " + daño + " puntos de hambre a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha restaurado " + daño + " puntos de hambre.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has restaurado " + daño + " puntos de hambre.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeHam == 2)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has quitado " + daño + " puntos de hambre a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha quitado " + daño + " puntos de hambre.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has quitado " + daño + " puntos de hambre.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeSed == 1)
                {
                    ...
                    daño = Matematicas.RandomNumber(Declaraciones.Hechizos[SpellIndex].MinSed, Declaraciones.Hechizos[SpellIndex].MaxSed);
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has restaurado " + daño + " puntos de sed a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha restaurado " + daño + " puntos de sed.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has restaurado " + daño + " puntos de sed.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeSed == 2)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has quitado " + daño + " puntos de sed a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha quitado " + daño + " puntos de sed.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has quitado " + daño + " puntos de sed.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeAgilidad == 1)
                {
                    ...
                    InfoHechizo(UserIndex);
                    daño = Matematicas.RandomNumber(Declaraciones.Hechizos[SpellIndex].MinAgilidad, Declaraciones.Hechizos[SpellIndex].MaxAgilidad);

                    withBlock.flags.DuracionEfecto = 1200;
                    withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = (byte)(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] + Convert.ToByte(daño));
                    if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] > SistemaCombate.MinimoInt(Declaraciones.MAXATRIBUTOS, withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Agilidad] * 2))

                        withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Convert.ToByte(SistemaCombate.MinimoInt(Declaraciones.MAXATRIBUTOS, withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Agilidad] * 2));
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeFuerza == 1)
                {
                    ...
                    InfoHechizo(UserIndex);
                    daño = Matematicas.RandomNumber(Declaraciones.Hechizos[SpellIndex].MinFuerza, Declaraciones.Hechizos[SpellIndex].MaxFuerza);

                    withBlock.flags.DuracionEfecto = 1200;

                    withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = (byte)(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] + Convert.ToByte(daño));
                    if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] > SistemaCombate.MinimoInt(Declaraciones.MAXATRIBUTOS, withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Fuerza] * 2))

                        withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Convert.ToByte(SistemaCombate.MinimoInt(Declaraciones.MAXATRIBUTOS, withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Fuerza] * 2));
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeHP == 1)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has restaurado " + daño + " puntos de vida a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha restaurado " + daño + " puntos de vida.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has restaurado " + daño + " puntos de vida.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeHP == 2)
                {
                    ...
                    if (withBlock.Invent.CascoEqpObjIndex > 0)
                    {
                        daño = daño - Matematicas.RandomNumber(Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].DefensaMagicaMin, Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].DefensaMagicaMax);
                    }

                    // anillos
                    if (withBlock.Invent.AnilloEqpObjIndex > 0)
                    {
                        daño = daño - Matematicas.RandomNumber(Declaraciones.ObjData_Renamed[withBlock.Invent.AnilloEqpObjIndex].DefensaMagicaMin, Declaraciones.ObjData_Renamed[withBlock.Invent.AnilloEqpObjIndex].DefensaMagicaMax);
                    }
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "Le has quitado " + daño + " puntos de vida a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha quitado " + daño + " puntos de vida.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeMana == 1)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has restaurado " + daño + " puntos de maná a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha restaurado " + daño + " puntos de maná.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has restaurado " + daño + " puntos de maná.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeMana == 2)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has quitado " + daño + " puntos de maná a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha quitado " + daño + " puntos de maná.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has quitado " + daño + " puntos de maná.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                ...
                if (Declaraciones.Hechizos[SpellIndex].SubeSta == 1)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has restaurado " + daño + " puntos de energía a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha restaurado " + daño + " puntos de energía.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has restaurado " + daño + " puntos de energía.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                }
                ...
                else if (Declaraciones.Hechizos[SpellIndex].SubeSta == 2)
                {
                    ...
                    if (UserIndex != TargetIndex)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Le has quitado " + daño + " puntos de energía a " + withBlock.name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        Protocol.WriteConsoleMsg(TargetIndex, Declaraciones.UserList[UserIndex].name + " te ha quitado " + daño + " puntos de energía.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Te has quitado " + daño + " puntos de energía.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
        ...
        public static bool CanSupportUser(short CasterIndex, short TargetIndex, bool DoCriminal = false)
        {
            ...
            try
            {

                {
                    ...
                    if (withBlock.flags.EnConsulta)
                    {
                        Protocol.WriteConsoleMsg(CasterIndex, "No puedes ayudar usuarios mientras estas en consulta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return CanSupportUserRet;
                    }

                    // Si estas en la arena, esta todo permitido
                    if (SistemaCombate.TriggerZonaPelea(CasterIndex, TargetIndex) == Declaraciones.eTrigger6.TRIGGER6_PERMITE)
                    {
                        CanSupportUserRet = true;
                        return CanSupportUserRet;
                    }
                    ...
                    if (ES.criminal(TargetIndex))
                    {
                        ...
                        if (!ES.criminal(CasterIndex))
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(CasterIndex, "Los miembros del ejército real no pueden ayudar a los criminales.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return CanSupportUserRet;
                            }
                            ...
                            {
                                Protocol.WriteConsoleMsg(CasterIndex, "Para ayudar criminales debes sacarte el seguro ya que te volverás criminal como ellos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return CanSupportUserRet;
                            }
                            // Penalizacion
                            else if (DoCriminal)
                            ...
                            {
                                int argNoblePts = Convert.ToInt32(withBlock.Reputacion.NobleRep * 0.5d);
                                int argBandidoPts = 10000;
                    ...
                    {
                        Protocol.WriteConsoleMsg(CasterIndex, "Los miembros de la legión oscura no pueden ayudar a los ciudadanos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return CanSupportUserRet;
                    }
                    ...
                    else if (!ES.criminal(CasterIndex))
                    {
                        ...
                        if (Declaraciones.UserList[TargetIndex].flags.AtacablePor > 0)
                        {
                            ...
                            if (Declaraciones.UserList[TargetIndex].flags.AtacablePor != CasterIndex)
                            {
                                ...
                                if (Extra.esArmada(CasterIndex))
                                {
                                    Protocol.WriteConsoleMsg(CasterIndex, "Los miembros del ejército real no pueden ayudar a ciudadanos en estado atacable.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return CanSupportUserRet;
                                }
                                ...
                                if (withBlock.flags.Seguro)
                                {
                                    Protocol.WriteConsoleMsg(CasterIndex, "Para ayudar ciudadanos en estado atacable debes sacarte el seguro, pero te puedes volver criminal.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return CanSupportUserRet;
                                }
                                else
                                {
                                    int argNoblePts1 = Convert.ToInt32(withBlock.Reputacion.NobleRep * 0.5d);
                                    int argBandidoPts1 = 10000;
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en CanSupportUser, Error: " + ex.GetType().Name + " - " + ex.Message + " CasterIndex: " + CasterIndex + ", TargetIndex: " + TargetIndex;
                General.LogError(ref argdesc);
            }
        ...
        public static void DesplazarHechizo(short UserIndex, short Dire, short HechizoDesplazado)
        {
...

            {
                ...
                if (Dire == 1) // Mover arriba
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes mover el hechizo en esa dirección.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    else
                    {
        ...
        public static void DisNobAuBan(short UserIndex, ref int NoblePts, ref int BandidoPts)
        {
...

            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero)) != 0)
                {
                    ...
                    if (withBlock.Reputacion.NobleRep < 0)
                    {
