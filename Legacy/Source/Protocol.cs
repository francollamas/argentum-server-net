...
namespace Legacy
{
    ...
    static class Protocol
    {
        ...
        private readonly static char SEPARATOR = '\0';
        ...
        public static void HandleIncomingData(short UserIndex)
        {
            ...
            try
            {
                ...
                if (!(packetID == (byte)ClientPacketID.ThrowDices | packetID == (byte)ClientPacketID.LoginExistingChar | packetID == (byte)ClientPacketID.LoginNewChar))
                ...
                else if (Information.Err().Number != 0 & !(Information.Err().Number == Declaraciones.UserList[UserIndex].incomingData.NotEnoughDataErrCode))
                {
                    // An error ocurred, log it and kick player.
                    string argdesc = "Error: " + Information.Err().Number + " [" + Information.Err().Description + "] " + " Source: " + Information.Err().Source + Constants.vbTab + " HelpFile: " + Information.Err().HelpFile + Constants.vbTab + " HelpContext: " + Information.Err().HelpContext + Constants.vbTab + " LastDllError: " + Information.Err().LastDllError + Constants.vbTab + " - UserIndex: " + UserIndex + " - producido al manejar el paquete: " + packetID.ToString();
        ...
        public static void WriteMultiMessage(short UserIndex, short MessageIndex, int Arg1 = 0, int Arg2 = 0, int Arg3 = 0, string StringArg1 = "")
        {
            ...
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.MultiMessage); withBlock.WriteByte(Convert.ToByte(MessageIndex)); switch (MessageIndex) { case (short)Declaraciones.eMessages.DontSeeAnything: case (short)Declaraciones.eMessages.NPCSwing: case (short)Declaraciones.eMessages.NPCKillUser: case (short)Declaraciones.eMessages.BlockedWithShieldUser: case (short)Declaraciones.eMessages.BlockedWithShieldother: case (short)Declaraciones.eMessages.UserSwing: case (short)Declaraciones.eMessages.SafeModeOn: case (short)Declaraciones.eMessages.SafeModeOff: case (short)Declaraciones.eMessages.ResuscitationSafeOff: case (short)Declaraciones.eMessages.ResuscitationSafeOn: case (short)Declaraciones.eMessages.NobilityLost: case (short)Declaraciones.eMessages.CantUseWhileMeditating: case (short)Declaraciones.eMessages.CancelHome: case (short)Declaraciones.eMessages.FinishHome: { break; } case (short)Declaraciones.eMessages.NPCHitUser: { withBlock.WriteByte(Convert.ToByte(Arg1)); withBlock.WriteInteger(Convert.ToInt16(Arg2)); break; } case (short)Declaraciones.eMessages.UserHitNPC: { withBlock.WriteLong(Arg1); break; } case (short)Declaraciones.eMessages.UserAttackedSwing: { withBlock.WriteInteger(Declaraciones.UserList[Arg1].Char_Renamed.CharIndex); break; } case (short)Declaraciones.eMessages.UserHittedByUser: { withBlock.WriteInteger(Convert.ToInt16(Arg1)); withBlock.WriteByte(Convert.ToByte(Arg2)); withBlock.WriteInteger(Convert.ToInt16(Arg3)); break; } case (short)Declaraciones.eMessages.UserHittedUser: { withBlock.WriteInteger(Convert.ToInt16(Arg1)); withBlock.WriteByte(Convert.ToByte(Arg2)); withBlock.WriteInteger(Convert.ToInt16(Arg3)); break; } case (short)Declaraciones.eMessages.WorkRequestTarget: { withBlock.WriteByte(Convert.ToByte(Arg1)); break; } case (short)Declaraciones.eMessages.HaveKilledUser: { withBlock.WriteInteger(Declaraciones.UserList[Arg1].Char_Renamed.CharIndex); withBlock.WriteLong(Arg2); break; } case (short)Declaraciones.eMessages.UserKill: { withBlock.WriteInteger(Declaraciones.UserList[Arg1].Char_Renamed.CharIndex); break; } case (short)Declaraciones.eMessages.EarnExp: { break; } case (short)Declaraciones.eMessages.Home: { withBlock.WriteByte(Convert.ToByte(Arg1)); withBlock.WriteInteger(Convert.ToInt16(Arg2)); withBlock.WriteASCIIString(StringArg1); break; } } } }, () => FlushBuffer(UserIndex)); // Target
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             // damage
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             // damage
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             // AttackerIndex
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             // Target
        ...
        private static void HandleGMCommands(short UserIndex)
        {
            ...
            var Command_Renamed = default(byte);
            ...
            try
            {

                {
                    ...
                    Command_Renamed = withBlock.incomingData.PeekByte();
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en GmCommands. Error: " + ex.GetType().Name + " - " + ex.Message + ". Paquete: " + Command_Renamed;
                General.LogError(ref argdesc);
            }
        }
        ...
        private static void HandleHome(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                {
                    UsUaRiOs.setHome(UserIndex, (Declaraciones.eCiudad)Declaraciones.Npclist[withBlock.flags.TargetNPC].Ciudad, withBlock.flags.TargetNPC);
                }
                else if (withBlock.flags.Muerto == 1)
                {
                    // Si es un mapa común y no está en cana
                    if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Restringir.ToUpper() == "NO" & withBlock.Counters.Pena == 0)
                    {
                ...
                {
                    WriteConsoleMsg(UserIndex, "Debes estar muerto para utilizar este comando.", FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        private static void HandleLoginExistingChar(short UserIndex)
        {
            ...
            try
            {
                ...
                {
                    WriteErrorMsg(UserIndex, "Se te ha prohibido la entrada a Argentum Online debido a tu mal comportamiento. Puedes consultar el reglamento y el sistema de soporte desde www.argentumonline.com.ar");
                }
                else if (!Admin.VersionOK(version))
                {
                    WriteErrorMsg(UserIndex, "Esta versión del juego es obsoleta, la versión correcta es la " + Declaraciones.ULTIMAVERSION + ". La misma se encuentra disponible en www.argentumonline.com.ar");
                }
                else
                {
        ...
        private static void HandleThrowDices(short UserIndex)
        {
...

            {
                ...
                withBlock.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Convert.ToByte(SistemaCombate.MaximoInt(15, 13 + Matematicas.RandomNumber(0, 3) + Matematicas.RandomNumber(0, 2)));
                withBlock.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Convert.ToByte(SistemaCombate.MaximoInt(15, 12 + Matematicas.RandomNumber(0, 3) + Matematicas.RandomNumber(0, 3)));
                withBlock.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] = Convert.ToByte(SistemaCombate.MaximoInt(16, 13 + Matematicas.RandomNumber(0, 3) + Matematicas.RandomNumber(0, 2)));
                withBlock.UserAtributos[(int)Declaraciones.eAtributos.Carisma] = Convert.ToByte(SistemaCombate.MaximoInt(15, 12 + Matematicas.RandomNumber(0, 3) + Matematicas.RandomNumber(0, 3)));
                withBlock.UserAtributos[(int)Declaraciones.eAtributos.Constitucion] = Convert.ToByte(16 + Matematicas.RandomNumber(0, 1) + Matematicas.RandomNumber(0, 1));
            }
        ...
        private static void HandleLoginNewChar(short UserIndex)
        {
            ...
            try
            {
                ...
                Declaraciones.eClass Class_Renamed;
                short Head;
                string mail;
                ...
                Class_Renamed = (Declaraciones.eClass)buffer.ReadByte();
                ...
                {
                    TCP.ConnectNewUser(UserIndex, ref UserName, ref Password, race, gender, Class_Renamed, ref mail, homeland, Head);
                }
        ...
        private static void HandleTalk(short UserIndex)
        {
            ...
            try
            {
                ...
                string Chat;
                {
                    ...
                    // [Consejeros & GMs]
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        string argtexto = "Dijo: " + Chat;
                    ...
                    if (withBlock.flags.Oculto > 0)
                    {
                        ...
                        if (withBlock.flags.Navegando == 1)
                        {
                            if (withBlock.clase == Declaraciones.eClass.Pirat)
                            {
                                ...
                                UsUaRiOs.ChangeUserChar(UserIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, (byte)withBlock.Char_Renamed.heading, Declaraciones.NingunArma, Declaraciones.NingunEscudo, Declaraciones.NingunCasco);
                            }
                        }
                        else if (withBlock.flags.invisible == 0)
                        {
                            UsUaRiOs.SetInvisible(UserIndex, Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex, false);
                    ...
                    if (Migration.migr_LenB(Chat) != 0)
                    {
                        ...
                        if (!(withBlock.flags.AdminInvisible == 1))
                        {
                            ...
                            {
                                modSendData.SendData(modSendData.SendTarget.ToDeadArea, UserIndex, PrepareMessageChatOverHead(Chat, withBlock.Char_Renamed.CharIndex, Declaraciones.CHAT_COLOR_DEAD_CHAR));
                            }
                            else
                            {
                                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageChatOverHead(Chat, withBlock.Char_Renamed.CharIndex, withBlock.flags.ChatColor));
                            }
                        }
                        else if (!string.IsNullOrEmpty(Chat.TrimEnd()))
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageConsoleMsg("Gm> " + Chat, FontTypeNames.FONTTYPE_GM));
                        }
                    }
                ...
                string Chat;
                {
                    ...
                    if (Migration.migr_LenB(Chat) != 0)
                    {
                        ...
                        if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                        {
                            ...
                            {
                                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageChatOverHead(Chat, withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Red)));
                            }
                        }
                        else if (!(withBlock.flags.AdminInvisible == 1))
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageChatOverHead(Chat, withBlock.Char_Renamed.CharIndex, Declaraciones.CHAT_COLOR_GM_YELL));
                        }
                        else
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageConsoleMsg("Gm> " + Chat, FontTypeNames.FONTTYPE_GM));
        ...
        private static void HandleWhisper(short UserIndex)
        {
            ...
            try
            {
                ...
                Declaraciones.PlayerType targetPriv;
                {
                    ...
                    {
                        WriteConsoleMsg(UserIndex, "¡¡Estás muerto!! Los muertos no pueden comunicarse con el mundo de los vivos. ", FontTypeNames.FONTTYPE_INFO);
                    }
                    ...
                    else
                    {
                        ...
                        if ((targetPriv & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                        {
                            // Controlamos que no este invisible
                            if (Declaraciones.UserList[TargetUserIndex].flags.AdminInvisible != 1)
                            {
                                WriteConsoleMsg(UserIndex, "No puedes susurrarle a los Dioses y Admins.", FontTypeNames.FONTTYPE_INFO);
                                // A los Consejeros y SemiDioses no vale susurrarles si sos un PJ común.
                            }
                        }
                        else if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0 & (int)(~targetPriv & Declaraciones.PlayerType.User) != 0)
                        {
                            // Controlamos que no este invisible
                            if (Declaraciones.UserList[TargetUserIndex].flags.AdminInvisible != 1)
                            {
                        ...
                        else
                        {
                            ...
                            if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                            {
                                string argtexto = "Le dijo a '" + Declaraciones.UserList[TargetUserIndex].name + "' " + Chat;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                            ...
                            if (Migration.migr_LenB(Chat) != 0)
                            {
                                ...
                                if (!(withBlock.flags.AdminInvisible == 1))
                                {
                                    WriteChatOverHead(UserIndex, Chat, withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Blue));
                                    WriteChatOverHead(TargetUserIndex, Chat, withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Blue));
                                    FlushBuffer(TargetUserIndex);

                                    // [CDT 17-02-2004]
                                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero)) != 0)
                                    {
                                        modSendData.SendData(modSendData.SendTarget.ToAdminsAreaButConsejeros, UserIndex, PrepareMessageChatOverHead("A " + Declaraciones.UserList[TargetUserIndex].name + "> " + Chat, withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Yellow)));
                                    }
                                }
                                else
                                {
                                    ...
                                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero)) != 0)
                                    {
                                        modSendData.SendData(modSendData.SendTarget.ToAdminsAreaButConsejeros, UserIndex, PrepareMessageConsoleMsg("Gm dijo a " + Declaraciones.UserList[TargetUserIndex].name + "> " + Chat, FontTypeNames.FONTTYPE_GM));
                                    }
                                }
                            }
                        }
        ...
        private static void HandleWalk(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.TimesWalk >= 30)
                {
                    ...
                    if (dummy < 5800)
                    {
                        if (TempTick - withBlock.flags.CountSH > 30000)
                        {
                        ...
                        if (!(withBlock.flags.CountSH == 0))
                        {
                            ...
                            string argtexto = "Tramposo SH: " + withBlock.name + " , " + dummy;
                            General.LogHackAttemp(ref argtexto);
                            modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg("Servidor> " + withBlock.name + " ha sido echado por el servidor por posible uso de SH.", FontTypeNames.FONTTYPE_SERVER));
                            TCP.CloseSocket(UserIndex);
                ...
                if (withBlock.flags.Paralizado == 0)
                {
                    if (withBlock.flags.Meditando)
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, 0, 0));
                    }
                    else
                    {
                        // Move user
        ...
        private static void HandleAttack(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                {
                    if (Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].proyectil == 1)
                    {
        ...
        private static void HandleSafeToggle(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                {
                    WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.SafeModeOff); // Call WriteSafeModeOff(UserIndex)
                }
                else
                {
                    WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.SafeModeOn);
        ...
        private static void HandleUserCommerceEnd(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (withBlock.ComUsu.DestUsu > 0)
                {
                    ...
                    {
                        WriteConsoleMsg(withBlock.ComUsu.DestUsu, withBlock.name + " ha dejado de comerciar con vos.", FontTypeNames.FONTTYPE_TALK);
        ...
        private static void HandleUserCommerceReject(short UserIndex)
        {
...

            {
                ...
                if (otherUser > 0)
                {
                    ...
                    {
                        WriteConsoleMsg(otherUser, withBlock.name + " ha rechazado tu oferta.", FontTypeNames.FONTTYPE_TALK);
        ...
        private static void HandleDrop(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.Navegando == 1 | withBlock.flags.Muerto == 1 | (withBlock.flags.Privilegios & Declaraciones.PlayerType.Consejero) != 0 & (int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0)
                    return;
                    ...
                    case Declaraciones.eSkill.Ocultarse:
                        {
                            ...
                            if (withBlock.flags.Navegando == 1)
                            {
                                if (withBlock.clase != Declaraciones.eClass.Pirat)
                                {
                                    ...
                                    {
                                        WriteConsoleMsg(UserIndex, "No puedes ocultarte si estás navegando.", FontTypeNames.FONTTYPE_INFO);
        ...
        private static void HandleInitCrafting(short UserIndex)
        {
...

            {
                ...
                if (TotalItems > 0)
                {
                    ...
                    withBlock.Construir.PorCiclo = Convert.ToInt16(SistemaCombate.MinimoInt(Trabajo.MaxItemsConstruibles(UserIndex), ItemsPorCiclo));
        ...
        private static void HandleUseSpellMacro(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToAdmins, UserIndex, PrepareMessageConsoleMsg(withBlock.name + " fue expulsado por Anti-macro de hechizos.", FontTypeNames.FONTTYPE_VENENO));
                WriteErrorMsg(UserIndex, "Has sido expulsado por usar macro de hechizos. Recomendamos leer el reglamento sobre el tema macros.");
                FlushBuffer(UserIndex);
                TCP.CloseSocket(UserIndex);
            }
        }
        ...
        private static void HandleUseItem(short UserIndex)
        {
            ...
            byte Slot;
            {
                ...
                if (withBlock.flags.Meditando)
                {
                    return; // The error message should have been provided by the client.
                }
        ...
        private static void HandleCraftBlacksmith(short UserIndex)
        {
            ...
            short Item;
            {
                ...
                if (Declaraciones.ObjData_Renamed[Item].SkHerreria == 0)
                    return;
        ...
        private static void HandleCraftCarpenter(short UserIndex)
        {
            ...
            short Item;
            {
                ...
                if (Declaraciones.ObjData_Renamed[Item].SkCarpinteria == 0)
                    return;
        ...
        private static void HandleWorkLeftClick(short UserIndex)
        {
            ...
            bool Atacked; // Target NPC 'Target user
            {
                ...
                if (withBlock.flags.Muerto == 1 | withBlock.flags.Descansar | withBlock.flags.Meditando | !Extra.InMapBounds(withBlock.Pos.Map, X, Y))
                    return;
                    ...
                    case Declaraciones.eSkill.Proyectiles:
                        {
                            ...
                            // Make sure the item is valid and there is ammo equipped.
                            {
                                ...
                                // En un slot válido?
                                else if (withBlock1.WeaponEqpSlot < 1 | withBlock1.WeaponEqpSlot > Declaraciones.UserList[UserIndex].CurrentInventorySlots)
                                {
                                    DummyInt = 1;
                                }
                                // Usa munición? (Si no la usa, puede ser un arma arrojadiza)
                                else if (Declaraciones.ObjData_Renamed[withBlock1.WeaponEqpObjIndex].Municion == 1)
                                {
                                    // La municion esta equipada en un slot valido?
                                    if (withBlock1.MunicionEqpSlot < 1 | withBlock1.MunicionEqpSlot > Declaraciones.UserList[UserIndex].CurrentInventorySlots)
                                    {
                                        DummyInt = 1;
                                    }
                                    // Tiene munición?
                                    ...
                                    // Son flechas?
                                    else if (Declaraciones.ObjData_Renamed[withBlock1.MunicionEqpObjIndex].OBJType != Declaraciones.eOBJType.otFlechas)
                                    {
                                        DummyInt = 1;
                                    }
                                    // Tiene suficientes?
                                    else if (withBlock1.Object_Renamed[withBlock1.MunicionEqpSlot].Amount < 1)
                                    {
                                        DummyInt = 1;
                                    }
                                }
                                // Es un arma de proyectiles?
                                else if (Declaraciones.ObjData_Renamed[withBlock1.WeaponEqpObjIndex].proyectil != 1)
                                {
                                    DummyInt = 2;
                                }
                            ...
                            if (tU > 0)
                            {
                                ...
                                {
                                    WriteConsoleMsg(UserIndex, "Estás demasiado lejos para atacar.", FontTypeNames.FONTTYPE_WARNING);
                                    return;
                                }
                            ...
                            {
                                // Only allow to atack if the other one can retaliate (can see us)
                                if (Math.Abs((short)(Declaraciones.Npclist[tN].Pos.Y - withBlock.Pos.Y)) > AI.RANGO_VISION_Y & Math.Abs((short)(Declaraciones.Npclist[tN].Pos.X - withBlock.Pos.X)) > AI.RANGO_VISION_X)
                                {
                                    WriteConsoleMsg(UserIndex, "Estás demasiado lejos para atacar.", FontTypeNames.FONTTYPE_WARNING);
                                    return;
                                }
                            ...
                            {
                                {
                                    ...
                                    if (Declaraciones.ObjData_Renamed[withBlock2.WeaponEqpObjIndex].Municion == 1)
                                    {
                                        ...
                                        if (withBlock2.Object_Renamed[DummyInt].Amount > 0)
                                        {
                                            // QuitarUserInvItem unequips the ammo, so we equip it again
                                            withBlock2.MunicionEqpSlot = Convert.ToByte(DummyInt);
                                            withBlock2.MunicionEqpObjIndex = withBlock2.Object_Renamed[DummyInt].ObjIndex;
                                            withBlock2.Object_Renamed[DummyInt].Equipped = 1;
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        if (withBlock2.Object_Renamed[DummyInt].Amount > 0)
                                        {
                                            ...
                                            withBlock2.WeaponEqpObjIndex = withBlock2.Object_Renamed[DummyInt].ObjIndex;
                                            withBlock2.Object_Renamed[DummyInt].Equipped = 1;
                                        }
                                        else
                                        {
                    ...
                    case Declaraciones.eSkill.Magia:
                        {
                            ...
                            if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].MagiaSinEfecto > 0)
                            {
                                WriteConsoleMsg(UserIndex, "Una fuerza oscura te impide canalizar tu energía.", FontTypeNames.FONTTYPE_FIGHT);
                                return;
                            }
                            ...
                            if (Math.Abs((short)(withBlock.Pos.X - X)) > AI.RANGO_VISION_X | Math.Abs((short)(withBlock.Pos.Y - Y)) > AI.RANGO_VISION_Y)
                            {
                                string argtexto = "Ataque fuera de rango de " + withBlock.name + "(" + withBlock.Pos.Map + "/" + withBlock.Pos.X + "/" + withBlock.Pos.Y + ") ip: " + withBlock.ip + " a la posición (" + withBlock.Pos.Map + "/" + X + "/" + Y + ")";
                            ...
                            {
                                WriteConsoleMsg(UserIndex, "¡Primero selecciona el hechizo que quieres lanzar!", FontTypeNames.FONTTYPE_INFO);
                            }
                    ...
                    case Declaraciones.eSkill.Pesca:
                        {
                            ...
                            if (General.HayAgua(withBlock.Pos.Map, X, Y))
                            {
                                ...
                                // Play sound!
                                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessagePlayWave(Declaraciones.SND_PESCAR, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                            }
                            else
                            {
                                WriteConsoleMsg(UserIndex, "No hay agua donde pescar. Busca un lago, río o mar.", FontTypeNames.FONTTYPE_INFO);
                            }
                            ...
                            if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk)
                            {
                                ...
                                if (tU > 0 & tU != UserIndex)
                                {
                                    ...
                                    if ((Declaraciones.UserList[tU].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                                    {
                                        ...
                                        {
                                            if (Math.Abs((short)(withBlock.Pos.X - X)) + Math.Abs((short)(withBlock.Pos.Y - Y)) > 1)
                                            {
                                            ...
                                            // 17/09/02
                                            // Check the trigger
                                            if (Declaraciones.MapData[Declaraciones.UserList[tU].Pos.Map, X, Y].trigger == Declaraciones.eTrigger.ZONASEGURA)
                                            {
                                                WriteConsoleMsg(UserIndex, "No puedes robar aquí.", FontTypeNames.FONTTYPE_WARNING);
                                                return;
                                            }

                                            if (Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].trigger == Declaraciones.eTrigger.ZONASEGURA)
                                            {
                                                WriteConsoleMsg(UserIndex, "No puedes robar aquí.", FontTypeNames.FONTTYPE_WARNING);
                                                return;
                                            }
                    ...
                    case Declaraciones.eSkill.Talar:
                        {
                            ...
                            if (withBlock.Invent.WeaponEqpObjIndex != Declaraciones.HACHA_LEÑADOR & withBlock.Invent.WeaponEqpObjIndex != Declaraciones.HACHA_LEÑA_ELFICA)
                            {
                            ...
                            if (DummyInt > 0)
                            {
                                ...
                                if (Declaraciones.ObjData_Renamed[DummyInt].OBJType == Declaraciones.eOBJType.otArboles & withBlock.Invent.WeaponEqpObjIndex == Declaraciones.HACHA_LEÑADOR)
                                {
                                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessagePlayWave(Declaraciones.SND_TALAR, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                                    Trabajo.DoTalar(UserIndex);
                                }
                                else if (Declaraciones.ObjData_Renamed[DummyInt].OBJType == Declaraciones.eOBJType.otArbolElfico & withBlock.Invent.WeaponEqpObjIndex == Declaraciones.HACHA_LEÑA_ELFICA)
                                {
                                    ...
                                    {
                                        WriteConsoleMsg(UserIndex, "El hacha utilizado no es suficientemente poderosa.", FontTypeNames.FONTTYPE_INFO);
                                    }
                                }
                            }
                            else
                    ...
                    case Declaraciones.eSkill.Mineria:
                        {
                            ...
                            if (DummyInt > 0)
                            {
                                ...
                                if (Declaraciones.ObjData_Renamed[DummyInt].OBJType == Declaraciones.eOBJType.otYacimiento)
                                {
                    ...
                    case Declaraciones.eSkill.Domar:
                        {
                            ...
                            if (tN > 0)
                            {
                                if (Declaraciones.Npclist[tN].flags.Domable > 0)
                                {
                                    ...
                                    {
                                        WriteConsoleMsg(UserIndex, "No puedes domar una criatura que está luchando con un jugador.", FontTypeNames.FONTTYPE_INFO);
                                        return;
                                    }
                    ...
                    case (Declaraciones.eSkill)Declaraciones.FundirMetal: // UGLY!!! This is a constant, not a skill!!
                        {
                            ...
                            {
                                if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObj].OBJType == Declaraciones.eOBJType.otFragua)
                                {
                                    // Validate other items
                                    if (withBlock.flags.TargetObjInvSlot < 1 | withBlock.flags.TargetObjInvSlot > withBlock.CurrentInventorySlots)
                                    {
                                        return;
                                    }

                                    // 'chequeamos que no se zarpe duplicando oro
                                    if (withBlock.Invent.Object_Renamed[withBlock.flags.TargetObjInvSlot].ObjIndex != withBlock.flags.TargetObjInvIndex)
                                    {
                                        if (withBlock.Invent.Object_Renamed[withBlock.flags.TargetObjInvSlot].ObjIndex == 0 | withBlock.Invent.Object_Renamed[withBlock.flags.TargetObjInvSlot].Amount == 0)
                                        {
                                    ...
                                    if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].OBJType == Declaraciones.eOBJType.otMinerales)
                                    {
                                        Trabajo.FundirMineral(UserIndex);
                                    }
                                    else if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].OBJType == Declaraciones.eOBJType.otWeapon)
                                    {
                    ...
                    case Declaraciones.eSkill.Herreria:
                        {
                            ...
                            if (withBlock.flags.TargetObj > 0)
                            {
                                if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObj].OBJType == Declaraciones.eOBJType.otYunque)
                                {
        ...
        private static void HandleCreateNewGuild(short UserIndex)
        {
            ...
            try
            {
                ...
                var errorStr = default(string);
                {
                    ...
                    if (modGuilds.CrearNuevoClan(UserIndex, ref desc, ref GuildName, ref site, ref codex, withBlock.FundandoGuildAlineacion, ref errorStr))
                    {
                        modSendData.SendData(modSendData.SendTarget.ToAll, UserIndex, PrepareMessageConsoleMsg(withBlock.name + " fundó el clan " + GuildName + " de alineación " + modGuilds.GuildAlignment(withBlock.GuildIndex) + ".", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessagePlayWave(44, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
                ...
                {
                    {
                        ...
                        // Send information
                        WriteConsoleMsg(UserIndex, "%%%%%%%%%%%% INFO DEL HECHIZO %%%%%%%%%%%%" + Constants.vbCrLf + "Nombre:" + withBlock1.Nombre + Constants.vbCrLf + "Descripción:" + withBlock1.desc + Constants.vbCrLf + "Skill requerido: " + withBlock1.MinSkill + " de magia." + Constants.vbCrLf + "Maná necesario: " + withBlock1.ManaRequerido + Constants.vbCrLf + "Energía necesaria: " + withBlock1.StaRequerido + Constants.vbCrLf + "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%", FontTypeNames.FONTTYPE_INFO);
                    }
                }
            }
        }
        ...
        private static void HandleEquipItem(short UserIndex)
        {
            ...
            byte itemSlot;
            {
                ...
                if (withBlock.Invent.Object_Renamed[itemSlot].ObjIndex == 0)
                    return;
        ...
        private static void HandleChangeHeading(short UserIndex)
        {
            ...
            var posY = default(short);
            {
                ...
                if (withBlock.flags.Paralizado == 1 & withBlock.flags.Inmovilizado == 0)
                {
                    ...
                    if (Extra.LegalPos(withBlock.Pos.Map, (short)(withBlock.Pos.X + posX), (short)(withBlock.Pos.Y + posY), Convert.ToBoolean(withBlock.flags.Navegando), !Convert.ToBoolean(withBlock.flags.Navegando)))
                    {
                        return;
                    }
                }
                ...
                {
                    withBlock.Char_Renamed.heading = heading;
                    UsUaRiOs.ChangeUserChar(UserIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, (byte)withBlock.Char_Renamed.heading, withBlock.Char_Renamed.WeaponAnim, withBlock.Char_Renamed.ShieldAnim, withBlock.Char_Renamed.CascoAnim);
                }
            }
        }
        ...
        private static void HandleModifySkills(short UserIndex)
        {
            ...
            var points = new byte[(Declaraciones.NUMSKILLS + 1)];
            {
                ...
                for (i = 1; i <= Declaraciones.NUMSKILLS; i++)
                {
                    ...
                    if (points[i] < 0)
                    {
                        string argtexto = withBlock.name + " IP:" + withBlock.ip + " trató de hackear los skills.";
                        General.LogHackAttemp(ref argtexto);
                ...
                {
                    string argtexto1 = withBlock.name + " IP:" + withBlock.ip + " trató de hackear los skills.";
                ...
                withBlock.Counters.AsignedSkills = Convert.ToByte(SistemaCombate.MinimoInt(10, withBlock.Counters.AsignedSkills + Count));
        ...
        private static void HandleTrain(short UserIndex)
        {
            ...
            byte PetIndex;
            {
                ...
                if (Declaraciones.Npclist[withBlock.flags.TargetNPC].Mascotas < Declaraciones.MAXMASCOTASENTRENADOR)
                {
                    ...
                    {
                        // Create the creature
                        SpawnedNpc = NPCs.SpawnNpc(Declaraciones.Npclist[withBlock.flags.TargetNPC].Criaturas[PetIndex].NpcIndex, ref Declaraciones.Npclist[withBlock.flags.TargetNPC].Pos, true, false);

                        if (SpawnedNpc > 0)
                        {
                            Declaraciones.Npclist[SpawnedNpc].MaestroNpc = withBlock.flags.TargetNPC;
                            Declaraciones.Npclist[withBlock.flags.TargetNPC].Mascotas = Convert.ToInt16(Declaraciones.Npclist[withBlock.flags.TargetNPC].Mascotas + 1);
                        }
                    }
                }
                else
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageChatOverHead("No puedo traer más criaturas, mata las existentes.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White)));
                }
            }
        }
        ...
        private static void HandleCommerceBuy(short UserIndex)
        {
            ...
            short Amount;
            {
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageChatOverHead("No tengo ningún interés en comerciar.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White)));
                    return;
                }
                ...
                // User compra el item
                modSistemaComercio.Comercio(modSistemaComercio.eModoComercio.Compra, UserIndex, withBlock.flags.TargetNPC, Slot, Amount);
            }
        }
        ...
        private static void HandleCommerceSell(short UserIndex)
        {
            ...
            short Amount;
            {
                ...
                modSistemaComercio.Comercio(modSistemaComercio.eModoComercio.Venta, UserIndex, withBlock.flags.TargetNPC, Slot, Amount);
            }
        }
                    ...
                    if (withBlock.flags.TargetObj > 0)
                    {
                        ...
                        switch (ForumType)
                        {
                            ...
                            case (byte)Declaraciones.eForumType.ieGeneral:
                                {
                                    ForumIndex = modForum.GetForumIndex(ref Declaraciones.ObjData_Renamed[withBlock.flags.TargetObj].ForoID);
                                    break;
                                }

                            case (byte)Declaraciones.eForumType.ieREAL:
                                {
                                    string argsForoID = modForum.FORO_REAL_ID;
                            ...
                            case (byte)Declaraciones.eForumType.ieCAOS:
                                {
                                    string argsForoID1 = modForum.FORO_CAOS_ID;
                        ...
                        modForum.AddPost(ForumIndex, ref Post, ref withBlock.name, ref Title, modForum.EsAnuncio((byte)ForumMsgType));
                    }
        ...
        private static void HandleMoveSpell(short UserIndex)
        {
            ...
            short dir_Renamed;
            {
                ...
                modHechizos.DesplazarHechizo(UserIndex, dir_Renamed, withBlock.ReadByte());
            }
        }
        ...
        private static void HandleMoveBank(short UserIndex)
        {
...

            {
                ...
                TempItem.ObjIndex = withBlock1.BancoInvent.Object_Renamed[Slot].ObjIndex;
                TempItem.Amount = withBlock1.BancoInvent.Object_Renamed[Slot].Amount;

                if (dir_Renamed == 1) // Mover arriba
                {
                    ...
                    withBlock1.BancoInvent.Object_Renamed[Slot] = withBlock1.BancoInvent.Object_Renamed[Slot - 1];
                    withBlock1.BancoInvent.Object_Renamed[Slot - 1].ObjIndex = TempItem.ObjIndex;
                    withBlock1.BancoInvent.Object_Renamed[Slot - 1].Amount = TempItem.Amount;
                }
                else // mover abajo
                {
                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto UserList().BancoInvent.Object(Slot). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ...
        private static void HandleUserCommerceOffer(short UserIndex)
        {
            ...
            var ObjIndex = default(short);
            {
                ...
                if ((Slot < 0 | Slot > Declaraciones.UserList[UserIndex].CurrentInventorySlots) & Slot != Declaraciones.FLAGORO)
                    return;
                ...
                if (Slot == Declaraciones.FLAGORO)
                {
                    ...
                    {
                        WriteCommerceChat(UserIndex, "No tienes esa cantidad de oro para agregar a la oferta.", FontTypeNames.FONTTYPE_TALK);
                        return;
                    }
                }
                else
                {
                    ...
                    // Can't offer more than he has
                    if (!Trabajo.TieneObjetos(ObjIndex, Convert.ToInt16(UsUaRiOs.TotalOfferItems(ObjIndex, UserIndex) + Amount), UserIndex))
                    {
                    ...
                    if (withBlock.flags.Navegando == 1)
                    {
                        ...
                        {
                            WriteCommerceChat(UserIndex, "No puedes vender tu barco mientras lo estés usando.", FontTypeNames.FONTTYPE_TALK);
                            return;
                        }
                    }
                    ...
                    if (withBlock.Invent.MochilaEqpSlot > 0)
                    {
                        ...
                        {
                            WriteCommerceChat(UserIndex, "No puedes vender tu mochila mientras la estés usando.", FontTypeNames.FONTTYPE_TALK);
                            return;
                        }
                    }
                }
        ...
        private static void HandleGuildAcceptPeace(short UserIndex)
        {
            ...
            try
            {
                ...
                string otherClanIndex;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("Tu clan ha firmado la paz con " + guild + ".", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, Convert.ToInt16(otherClanIndex), PrepareMessageConsoleMsg("Tu clan ha firmado la paz con " + modGuilds.GuildName(withBlock.GuildIndex) + ".", FontTypeNames.FONTTYPE_GUILD));
                    }
        ...
        private static void HandleGuildRejectAlliance(short UserIndex)
        {
            ...
            try
            {
                ...
                string otherClanIndex;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("Tu clan rechazado la propuesta de alianza de " + guild, FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, Convert.ToInt16(otherClanIndex), PrepareMessageConsoleMsg(modGuilds.GuildName(withBlock.GuildIndex) + " ha rechazado nuestra propuesta de alianza con su clan.", FontTypeNames.FONTTYPE_GUILD));
                    }
        ...
        private static void HandleGuildRejectPeace(short UserIndex)
        {
            ...
            try
            {
                ...
                string otherClanIndex;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("Tu clan rechazado la propuesta de paz de " + guild + ".", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, Convert.ToInt16(otherClanIndex), PrepareMessageConsoleMsg(modGuilds.GuildName(withBlock.GuildIndex) + " ha rechazado nuestra propuesta de paz con su clan.", FontTypeNames.FONTTYPE_GUILD));
                    }
        ...
        private static void HandleGuildAcceptAlliance(short UserIndex)
        {
            ...
            try
            {
                ...
                string otherClanIndex;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("Tu clan ha firmado la alianza con " + guild + ".", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, Convert.ToInt16(otherClanIndex), PrepareMessageConsoleMsg("Tu clan ha firmado la paz con " + modGuilds.GuildName(withBlock.GuildIndex) + ".", FontTypeNames.FONTTYPE_GUILD));
                    }
        ...
        private static void HandleGuildOfferPeace(short UserIndex)
        {
            ...
            try
            {
                ...
                var errorStr = default(string);
                {
                    ...
                    if (modGuilds.r_ClanGeneraPropuesta(UserIndex, ref guild, modGuilds.RELACIONES_GUILD.PAZ, ref proposal, ref errorStr))
                    {
        ...
        private static void HandleGuildOfferAlliance(short UserIndex)
        {
            ...
            try
            {
                ...
                var errorStr = default(string);
                {
                    ...
                    if (modGuilds.r_ClanGeneraPropuesta(UserIndex, ref guild, modGuilds.RELACIONES_GUILD.ALIADOS, ref proposal, ref errorStr))
                    {
        ...
        private static void HandleGuildAllianceDetails(short UserIndex)
        {
            ...
            try
            {
                ...
                string details;
                {
                    ...
                    details = modGuilds.r_VerPropuesta(UserIndex, ref guild, modGuilds.RELACIONES_GUILD.ALIADOS, ref errorStr);
        ...
        private static void HandleGuildRequestJoinerInfo(short UserIndex)
        {
            ...
            try
            {
                ...
                string User_Renamed;
                {
                    ...
                    details = modGuilds.a_DetallesAspirante(UserIndex, ref User_Renamed);

                    if (Migration.migr_LenB(details) == 0)
                    {
                        WriteConsoleMsg(UserIndex, "El personaje no ha mandado solicitud, o no estás habilitado para verla.", FontTypeNames.FONTTYPE_GUILD);
                    }
                    else
                    {
        ...
        private static void HandleGuildAlliancePropList(short UserIndex)
        {
            ...
            WriteAlianceProposalsList(UserIndex, modGuilds.r_ListaDePropuestas(UserIndex, modGuilds.RELACIONES_GUILD.ALIADOS));
        }
        ...
        private static void HandleGuildDeclareWar(short UserIndex)
        {
            ...
            try
            {
                ...
                short otherGuildIndex;
                {
                    ...
                    {
                        // WAR shall be!
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("TU CLAN HA ENTRADO EN GUERRA CON " + guild + ".", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, otherGuildIndex, PrepareMessageConsoleMsg(modGuilds.GuildName(withBlock.GuildIndex) + " LE DECLARA LA GUERRA A TU CLAN.", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessagePlayWave(45, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, otherGuildIndex, PrepareMessagePlayWave(45, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
                    }
        ...
        private static void HandleGuildNewWebsite(short UserIndex)
        {
            ...
            try
            {
                var buffer = new clsByteQueue();
                {
                    ...
                    string argWeb = buffer.ReadASCIIString();
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    else
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg(UserName + " ha sido aceptado como miembro del clan.", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessagePlayWave(43, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
                    }
        ...
        private static void HandleGuildKickMember(short UserIndex)
        {
            ...
            try
            {
                ...
                short GuildIndex;
                {
                    ...
                    if (GuildIndex > 0)
                    {
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GuildIndex, PrepareMessageConsoleMsg(UserName + " fue expulsado del clan.", FontTypeNames.FONTTYPE_GUILD));
                        modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GuildIndex, PrepareMessagePlayWave(45, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
                    }
                    else
                    {
        ...
        private static void HandleGuildUpdateNews(short UserIndex)
        {
            ...
            try
            {
                var buffer = new clsByteQueue();
                {
                    ...
                    string argdatos = buffer.ReadASCIIString();
        ...
        private static void HandleGuildOpenElections(short UserIndex)
        {
            ...
            var error_Renamed = default(string);
            {
                ref var withBlock = ref Declaraciones.UserList[UserIndex];
                // Remove packet ID
                withBlock.incomingData.ReadByte();
                ...
                if (!modGuilds.v_AbrirElecciones(UserIndex, ref error_Renamed))
                {
                    WriteConsoleMsg(UserIndex, error_Renamed, FontTypeNames.FONTTYPE_GUILD);
                }
                else
                {
                    modSendData.SendData(modSendData.SendTarget.ToGuildMembers, withBlock.GuildIndex, PrepareMessageConsoleMsg("¡Han comenzado las elecciones del clan! Puedes votar escribiendo /VOTO seguido del nombre del personaje, por ejemplo: /VOTO " + withBlock.name, FontTypeNames.FONTTYPE_GUILD));
                }
            }
        }
        ...
        private static void HandleGuildRequestMembership(short UserIndex)
        {
            ...
            try
            {
                ...
                var errorStr = default(string);
                {
                    ...
                    {
                        WriteConsoleMsg(UserIndex, "Tu solicitud ha sido enviada. Espera prontas noticias del líder de " + guild + ".", FontTypeNames.FONTTYPE_GUILD);
                    }
        ...
        private static void HandleGuildRequestDetails(short UserIndex)
        {
            ...
            try
            {
                var buffer = new clsByteQueue();
                {
                    ...
                    string argGuildName = buffer.ReadASCIIString();
        ...
        private static void HandleOnline(short UserIndex)
        {
...

            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    ...
                    {
                        if ((Declaraciones.UserList[i].flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero)) != 0)
                            Count = Count + 1;
                    }
                }

                WriteConsoleMsg(UserIndex, "Número de usuarios: " + Count.ToString(), FontTypeNames.FONTTYPE_INFO);
            }
        }
        ...
        private static void HandleGuildLeave(short UserIndex)
        {
...

            {
                ...
                if (GuildIndex > 0)
                {
                    ...
                    modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GuildIndex, PrepareMessageConsoleMsg(withBlock.name + " deja el clan.", FontTypeNames.FONTTYPE_GUILD));
                }
                else
                {
        ...
        private static void HandleRequestAccountState(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.TargetNPC == 0)
                {
                    WriteConsoleMsg(UserIndex, "Primero tienes que seleccionar un personaje, haz click izquierdo sobre él.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                switch (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype)
                {
                    case Declaraciones.eNPCType.Banquero:
                        {
                            WriteChatOverHead(UserIndex, "Tienes " + withBlock.Stats.Banco + " monedas de oro en tu cuenta.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                            break;
                        }
                    ...
                    case Declaraciones.eNPCType.Timbero:
                        {
                            if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                            {
                                ...
                                {
                                    Percentage = Convert.ToInt16(Conversion.Int(earnings * 100 / (double)Admin.Apuestas.Ganancias));
                                }

                                if (earnings < 0 & Admin.Apuestas.Perdidas != 0)
                                {
                                    Percentage = Convert.ToInt16(Conversion.Int(earnings * 100 / (double)Admin.Apuestas.Perdidas));
                                }

                                WriteConsoleMsg(UserIndex, "Entradas: " + Admin.Apuestas.Ganancias + " Salida: " + Admin.Apuestas.Perdidas + " Ganancia Neta: " + earnings + " (" + Percentage + "%) Jugadas: " + Admin.Apuestas.Jugadas, FontTypeNames.FONTTYPE_INFO);
                            }
        ...
        private static void HandleRest(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (withBlock.flags.Muerto == 1)
                {
                    WriteConsoleMsg(UserIndex, "¡¡Estás muerto!! Solo puedes usar ítems cuando estás vivo.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }

                short argObjIndex = Declaraciones.FOGATA;
                if (TCP.HayOBJarea(ref withBlock.Pos, ref argObjIndex))
                {
                    ...
                    if (!withBlock.flags.Descansar)
                    {
                        WriteConsoleMsg(UserIndex, "Te acomodás junto a la fogata y comienzas a descansar.", FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
        ...
        private static void HandleMeditate(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (withBlock.flags.Muerto == 1)
                {
                    WriteConsoleMsg(UserIndex, "¡¡Estás muerto!! Sólo puedes meditar cuando estás vivo.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                {
                    WriteConsoleMsg(UserIndex, "Sólo las clases mágicas conocen el arte de la meditación.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                if (withBlock.flags.Meditando)
                {
                    ...
                    WriteConsoleMsg(UserIndex, "Te estás concentrando. En " + Conversion.Fix(Declaraciones.TIEMPO_INICIOMEDITAR / 1000d) + " segundos comenzarás a meditar.", FontTypeNames.FONTTYPE_INFO);

                    withBlock.Char_Renamed.loops = Declaraciones.INFINITE_LOOPS;

                    // Show proper FX according to level
                    if (withBlock.Stats.ELV < 13)
                    {
                        withBlock.Char_Renamed.FX = (short)Declaraciones.FXIDs.FXMEDITARCHICO;
                    }

                    else if (withBlock.Stats.ELV < 25)
                    {
                        withBlock.Char_Renamed.FX = (short)Declaraciones.FXIDs.FXMEDITARMEDIANO;
                    }

                    else if (withBlock.Stats.ELV < 35)
                    {
                        withBlock.Char_Renamed.FX = (short)Declaraciones.FXIDs.FXMEDITARGRANDE;
                    }

                    else if (withBlock.Stats.ELV < 42)
                    {
                        withBlock.Char_Renamed.FX = (short)Declaraciones.FXIDs.FXMEDITARXGRANDE;
                    }

                    else
                    {
                        withBlock.Char_Renamed.FX = (short)Declaraciones.FXIDs.FXMEDITARXXGRANDE;
                    }

                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, withBlock.Char_Renamed.FX, Declaraciones.INFINITE_LOOPS));
                }
                else
                {
        ...
        private static void HandleResucitate(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.Revividor & (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.ResucitadorNewbie | !Extra.EsNewbie(UserIndex)) | withBlock.flags.Muerto == 0)
                    return;

                // Make sure it's close enough
                if (Matematicas.Distancia(ref withBlock.Pos, ref Declaraciones.Npclist[withBlock.flags.TargetNPC].Pos) > 10)
                {
                    WriteConsoleMsg(UserIndex, "El sacerdote no puede resucitarte debido a que estás demasiado lejos.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
        ...
        private static void HandleConsultation(string UserIndex)
        {
            ...
            string UserName;
            {
                ...
                if (UserConsulta == 0)
                {
                    WriteConsoleMsg(Convert.ToInt16(UserIndex), "Primero tienes que seleccionar un usuario, haz click izquierdo sobre él.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                {
                    WriteConsoleMsg(Convert.ToInt16(UserIndex), "No puedes iniciar el modo consulta con otro administrador.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                {
                    WriteConsoleMsg(Convert.ToInt16(UserIndex), "Has terminado el modo consulta con " + UserName + ".", FontTypeNames.FONTTYPE_INFOBOLD);
                    WriteConsoleMsg(UserConsulta, "Has terminado el modo consulta.", FontTypeNames.FONTTYPE_INFOBOLD);
                    string argtexto = "Termino consulta con " + UserName;
                    General.LogGM(ref withBlock.name, ref argtexto);
                ...
                {
                    WriteConsoleMsg(Convert.ToInt16(UserIndex), "Has iniciado el modo consulta con " + UserName + ".", FontTypeNames.FONTTYPE_INFOBOLD);
                    WriteConsoleMsg(UserConsulta, "Has iniciado el modo consulta.", FontTypeNames.FONTTYPE_INFOBOLD);
                    string argtexto1 = "Inicio consulta con " + UserName;
...

                    {
                        ...
                        if (withBlock1.flags.invisible == 1 | withBlock1.flags.Oculto == 1)
                        {
                            ...
                            UsUaRiOs.SetInvisible(UserConsulta, Declaraciones.UserList[UserConsulta].Char_Renamed.CharIndex, false);
                        }
                    }
                }
        ...
        private static void HandleHeal(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.Revividor & Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.ResucitadorNewbie | withBlock.flags.Muerto != 0)

                    return;

                if (Matematicas.Distancia(ref withBlock.Pos, ref Declaraciones.Npclist[withBlock.flags.TargetNPC].Pos) > 10)
                {
                    WriteConsoleMsg(UserIndex, "El sacerdote no puede curarte debido a que estás demasiado lejos.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
            ...
            short i;
            {
                ...
                if (withBlock.flags.TargetNPC > 0)
                {
                    ...
                    if (Declaraciones.Npclist[withBlock.flags.TargetNPC].Comercia == 0)
                    {
                        ...
                        {
                            WriteChatOverHead(UserIndex, "No tengo ningún interés en comerciar.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                        }
                ...
                else if (withBlock.flags.TargetUser > 0)
                {
                    ...
                    // Check distance
                    if (Matematicas.Distancia(ref Declaraciones.UserList[withBlock.flags.TargetUser].Pos, ref withBlock.Pos) > 3)
                    {
                    ...
                    if (Declaraciones.UserList[withBlock.flags.TargetUser].flags.Comerciando == true & Declaraciones.UserList[withBlock.flags.TargetUser].ComUsu.DestUsu != UserIndex)
                    {
                        WriteConsoleMsg(UserIndex, "No puedes comerciar con el usuario en este momento.", FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
        ...
        private static void HandleEnlist(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.Noble | withBlock.flags.Muerto != 0)
                    return;
        ...
        private static void HandleInformation(short UserIndex)
        {
...

            {
                ...
                if (Declaraciones.Npclist[withBlock.flags.TargetNPC].flags.Faccion == 0)
                {
                    ...
                    {
                        WriteChatOverHead(UserIndex, "¡¡No perteneces a las tropas reales!!", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                        return;
                    }
                    ...
                    if (Diferencia > 0)
                    {
                        WriteChatOverHead(UserIndex, "Tu deber es combatir criminales, mata " + Diferencia + " criminales más y te daré una recompensa.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                    else
                    {
                        WriteChatOverHead(UserIndex, "Tu deber es combatir criminales, y ya has matado los suficientes como para merecerte una recompensa.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                }
                else
                {
                    ...
                    {
                        WriteChatOverHead(UserIndex, "¡¡No perteneces a la legión oscura!!", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                        return;
                    }
                    ...
                    if (Diferencia > 0)
                    {
                        WriteChatOverHead(UserIndex, "Tu deber es sembrar el caos y la desesperanza, mata " + Diferencia + " ciudadanos más y te daré una recompensa.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                    else
                    {
                        WriteChatOverHead(UserIndex, "Tu deber es sembrar el caos y la desesperanza, y creo que estás en condiciones de merecer una recompensa.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                }
            }
        }
...

            {
                ...
                if (ES.criminal(UserIndex))
                {
                    ...
                    if (Extra.esCaos(UserIndex))
                    {
                        ...
                        {
                            WriteConsoleMsg(UserIndex, "Solo puedes compartir npcs con miembros de tu misma facción!!", FontTypeNames.FONTTYPE_INFO);
                            return;
                        }
                    }
                ...
                {
                    WriteConsoleMsg(SharingUserIndex, withBlock.name + " ha dejado de compartir sus npcs contigo.", FontTypeNames.FONTTYPE_INFO);
                    WriteConsoleMsg(UserIndex, "Has dejado de compartir tus npcs con " + Declaraciones.UserList[SharingUserIndex].name + ".", FontTypeNames.FONTTYPE_INFO);
                }

                withBlock.flags.ShareNpcWith = TargetUserIndex;

                WriteConsoleMsg(TargetUserIndex, withBlock.name + " ahora comparte sus npcs contigo.", FontTypeNames.FONTTYPE_INFO);
                WriteConsoleMsg(UserIndex, "Ahora compartes tus npcs con " + Declaraciones.UserList[TargetUserIndex].name + ".", FontTypeNames.FONTTYPE_INFO);
        ...
        private static void HandleStopSharingNpc(short UserIndex)
        {
...

            {
                ...
                if (SharingUserIndex != 0)
                {
                    ...
                    WriteConsoleMsg(SharingUserIndex, withBlock.name + " ha dejado de compartir sus npcs contigo.", FontTypeNames.FONTTYPE_INFO);
                    WriteConsoleMsg(SharingUserIndex, "Has dejado de compartir tus npcs con " + Declaraciones.UserList[SharingUserIndex].name + ".", FontTypeNames.FONTTYPE_INFO);
            ...
            try
            {
                ...
                string Chat;
                {
                    ...
                    if (Migration.migr_LenB(Chat) != 0)
                    {
                        ...
                        {
                            modSendData.SendData(modSendData.SendTarget.ToDiosesYclan, withBlock.GuildIndex, PrepareMessageGuildChat(withBlock.name + "> " + Chat));

                            if (!(withBlock.flags.AdminInvisible == 1))
                                modSendData.SendData(modSendData.SendTarget.ToClanArea, UserIndex, PrepareMessageChatOverHead("< " + Chat + " >", withBlock.Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.Yellow)));
                        }
                    }
        ...
        private static void HandleGuildOnline(short UserIndex)
        {
            ...
            string onlineList;
            {
                ...
                if (withBlock.GuildIndex != 0)
                {
                    WriteConsoleMsg(UserIndex, "Compañeros de tu clan conectados: " + onlineList, FontTypeNames.FONTTYPE_GUILDMSG);
                }
                else
                {
            ...
            try
            {
                ...
                string Chat;
                {
                    ...
                    if (Migration.migr_LenB(Chat) != 0)
                    {
                        ...
                        {
                            modSendData.SendData(modSendData.SendTarget.ToConsejo, UserIndex, PrepareMessageConsoleMsg("(Consejero) " + withBlock.name + "> " + Chat, FontTypeNames.FONTTYPE_CONSEJO));
                        }
                        else if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.ChaosCouncil) != 0)
                        {
                            modSendData.SendData(modSendData.SendTarget.ToConsejoCaos, UserIndex, PrepareMessageConsoleMsg("(Consejero) " + withBlock.name + "> " + Chat, FontTypeNames.FONTTYPE_CONSEJOCAOS));
                        }
                    }
            ...
            try
            {
                ...
                string request;
                {
                    ...
                    if (Migration.migr_LenB(request) != 0)
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.ToRolesMasters, 0, PrepareMessageConsoleMsg(withBlock.name + " PREGUNTA ROL: " + request, FontTypeNames.FONTTYPE_GUILDMSG));
                    }
        ...
        private static void HandleGMRequest(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                {
                    WriteConsoleMsg(UserIndex, "El mensaje ha sido entregado, ahora sólo debes esperar que se desocupe algún GM.", FontTypeNames.FONTTYPE_INFO);
                ...
                else
                {
                    ...
                    Declaraciones.Ayuda.Push(withBlock.name);
                    WriteConsoleMsg(UserIndex, "Ya habías mandado un mensaje, tu mensaje ha sido movido al final de la cola de mensajes.", FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        private static void HandleBugReport(short UserIndex)
        {
            ...
            try
            {
                ...
                string bugReport;
                {
                    ...
                    General.AppendLog("LOGS/BUGs.log", "Usuario:" + withBlock.name + "  Fecha:" + Conversions.ToString(DateTime.Today) + "    Hora:" + Conversions.ToString(DateAndTime.TimeOfDay));
            ...
            try
            {
                ...
                short Count;
                {
                    ...
                    if (Migration.migr_LenB(name) != 0)
                    {
                        ...
                        if ((ES.EsAdmin(name) | ES.EsDios(name) | ES.EsSemiDios(name) | ES.EsConsejero(name) | ES.EsRolesMaster(name)) & (Declaraciones.UserList[UserIndex].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                        {
                            WriteConsoleMsg(UserIndex, "No puedes ver las penas de los administradores.", FontTypeNames.FONTTYPE_INFO);
                        }
                        else if (System.IO.File.Exists(Declaraciones.CharPath + name + ".chr"))
                        {
                            int argEmptySpaces = 1024;
                            Count = Convert.ToInt16(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + name + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces)));
                            if (Count == 0)
                            {
                            ...
                            else
                            {
                                while (Count > 0)
                                {
                                    ...
                                    WriteConsoleMsg(UserIndex, Count + " - " + ES.GetVar(Declaraciones.CharPath + name + ".chr", "PENAS", "P" + Count, EmptySpaces: ref argEmptySpaces1), FontTypeNames.FONTTYPE_INFO);
        ...
        private static void HandleChangePassword(short UserIndex)
        {
            ...
            try
            {
                ...
                string oldPass2;
                {
                    ...
                    {
                        WriteConsoleMsg(UserIndex, "Debes especificar una contraseña nueva, inténtalo de nuevo.", FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
                        int argEmptySpaces = 1024;
                        oldPass2 = ES.GetVar(Declaraciones.CharPath + Declaraciones.UserList[UserIndex].name + ".chr", "INIT", "Password", EmptySpaces: ref argEmptySpaces).ToUpper();

                        if ((oldPass2 ?? "") != (oldPass ?? ""))
                        {
                            WriteConsoleMsg(UserIndex, "La contraseña actual proporcionada no es correcta. La contraseña no ha sido cambiada, inténtalo de nuevo.", FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            ES.WriteVar(Declaraciones.CharPath + Declaraciones.UserList[UserIndex].name + ".chr", "INIT", "Password", newPass);
        ...
        private static void HandleGamble(short UserIndex)
        {
            ...
            short Amount;
            {
                ...
                else if (Matematicas.Distancia(ref Declaraciones.Npclist[withBlock.flags.TargetNPC].Pos, ref withBlock.Pos) > 10)
                {
                    WriteConsoleMsg(UserIndex, "Estás demasiado lejos.", FontTypeNames.FONTTYPE_INFO);
                }
                else if (Declaraciones.Npclist[withBlock.flags.TargetNPC].NPCtype != Declaraciones.eNPCType.Timbero)
                {
                    WriteChatOverHead(UserIndex, "No tengo ningún interés en apostar.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else if (Amount < 1)
                {
                    WriteChatOverHead(UserIndex, "El mínimo de apuesta es 1 moneda.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else if (Amount > 5000)
                {
                    WriteChatOverHead(UserIndex, "El máximo de apuesta es 5000 monedas.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else if (withBlock.Stats.GLD < Amount)
                {
                    WriteChatOverHead(UserIndex, "No tienes esa cantidad.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else
                {
                    if (Matematicas.RandomNumber(1, 100) <= 47)
                    {
                        ...
                        WriteChatOverHead(UserIndex, "¡Felicidades! Has ganado " + Amount.ToString() + " monedas de oro.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));

                        Admin.Apuestas.Perdidas = Admin.Apuestas.Perdidas + Amount;
                        ES.WriteVar(Declaraciones.DatPath + "apuestas.dat", "Main", "Perdidas", Admin.Apuestas.Perdidas.ToString());
                    }
                    else
                    {
                        withBlock.Stats.GLD = withBlock.Stats.GLD - Amount;
                        WriteChatOverHead(UserIndex, "Lo siento, has perdido " + Amount.ToString() + " monedas de oro.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));

                        Admin.Apuestas.Ganancias = Admin.Apuestas.Ganancias + Amount;
                        ES.WriteVar(Declaraciones.DatPath + "apuestas.dat", "Main", "Ganancias", Admin.Apuestas.Ganancias.ToString());
                    }

                    Admin.Apuestas.Jugadas = Admin.Apuestas.Jugadas + 1;

                    ES.WriteVar(Declaraciones.DatPath + "apuestas.dat", "Main", "Jugadas", Admin.Apuestas.Jugadas.ToString());
        ...
        private static void HandleBankExtractGold(short UserIndex)
        {
            ...
            int Amount;
            {
                ...
                if (Amount > 0 & Amount <= withBlock.Stats.Banco)
                {
                    ...
                    withBlock.Stats.GLD = withBlock.Stats.GLD + Amount;
                    WriteChatOverHead(UserIndex, "Tenés " + withBlock.Stats.Banco + " monedas de oro en tu cuenta.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else
                {
                    WriteChatOverHead(UserIndex, "No tienes esa cantidad.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
        ...
        private static void HandleLeaveFaction(short UserIndex)
        {
...

            {
                ...
                if (withBlock.Faccion.ArmadaReal == 1)
                {
                    ...
                    if (TalkToDemon)
                    {
                        WriteChatOverHead(UserIndex, "¡¡¡Sal de aquí bufón!!!", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                    ...
                    else
                    {
                        ...
                        if (TalkToKing)
                        {
                            WriteChatOverHead(UserIndex, "Serás bienvenido a las fuerzas imperiales si deseas regresar.", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                        }

                        bool argExpulsado = false;
                ...
                else if (withBlock.Faccion.FuerzasCaos == 1)
                {
                    ...
                    if (TalkToKing)
                    {
                        WriteChatOverHead(UserIndex, "¡¡¡Sal de aquí maldito criminal!!!", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                    }
                    else
                    {
                        ...
                        if (TalkToDemon)
                        {
                            WriteChatOverHead(UserIndex, "Ya volverás arrastrandote.", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                        }

                        bool argExpulsado1 = false;
                ...
                {
                    WriteChatOverHead(UserIndex, "¡No perteneces a ninguna facción!", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
                else
                {
        ...
        private static void HandleBankDepositGold(short UserIndex)
        {
            ...
            int Amount;
            {
                ...
                {
                    WriteChatOverHead(UserIndex, "No tenés esa cantidad.", Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
                }
            }
        }
            ...
            try
            {
                ...
                string Text;
                {
                    ...
                    if (withBlock.flags.Silenciado == 0)
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg(withBlock.name.ToLower() + " DENUNCIA: " + Text, FontTypeNames.FONTTYPE_GUILDMSG));
        ...
        private static void HandleGuildFundate(short UserIndex)
        {
...

            {
                ...
                {
                    WriteConsoleMsg(UserIndex, "¡Ya has fundado un clan, no puedes fundar otro!", FontTypeNames.FONTTYPE_INFOBOLD);
                    return;
                }
        ...
        private static void HandleGuildFundation(short UserIndex)
        {
            ...
            var error_Renamed = default(string);
            {
                ...
                {
                    WriteConsoleMsg(UserIndex, "¡Ya has fundado un clan, no puedes fundar otro!", FontTypeNames.FONTTYPE_INFOBOLD);
                    string argtexto = "El usuario " + withBlock.name + " ha intentado fundar un clan ya habiendo fundado otro desde la IP " + withBlock.ip;
                    General.LogCheating(ref argtexto);
                    return;
                }
                ...
                if (modGuilds.PuedeFundarUnClan(UserIndex, withBlock.FundandoGuildAlineacion, ref error_Renamed))
                {
                ...
                short tUser;
                {
                    ...
                    if (mdParty.UserPuedeEjecutarComandos(UserIndex))
                    {
                        ...
                        else
                        {
                            ...
                            WriteConsoleMsg(UserIndex, UserName.ToLower() + " no pertenece a tu party.", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
        ...
        private static void HandlePartySetLeader(short UserIndex)
        {
            ...
            short rank;
            {
                ...
                rank = Convert.ToInt16((int)(Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero));
                ...
                if (mdParty.UserPuedeEjecutarComandos(UserIndex))
                {
                    ...
                    if (tUser > 0)
                    {
                        ...
                        if (((int)Admin.UserDarPrivilegioLevel(UserName) & rank) <= ((int)withBlock.flags.Privilegios & rank))
                        {
                            mdParty.TransformarEnLider(UserIndex, tUser);
                        }
                        else
                        {
                            WriteConsoleMsg(UserIndex, Declaraciones.UserList[tUser].name.ToLower() + " no pertenece a tu party.", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
                ...
                var bUserVivo = default(bool);
                {
                    ...
                    if (mdParty.UserPuedeEjecutarComandos(UserIndex) & bUserVivo)
                    {
                        ...
                        if (tUser > 0)
                        {
                            ...
                            if (((int)Declaraciones.UserList[tUser].flags.Privilegios & rank) <= ((int)withBlock.flags.Privilegios & rank))
                            {
                                mdParty.AprobarIngresoAParty(UserIndex, tUser);
                            }
                            else
                            {
                                WriteConsoleMsg(UserIndex, "No puedes incorporar a tu party a personajes de mayor jerarquía.", FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                        else
                        {
                            ...
                            if (((int)Admin.UserDarPrivilegioLevel(UserName) & rank) <= ((int)withBlock.flags.Privilegios & rank))
                            {
                                WriteConsoleMsg(UserIndex, UserName.ToLower() + " no ha solicitado ingresar a tu party.", FontTypeNames.FONTTYPE_PARTY);
                            }
                            else
                            {
                                WriteConsoleMsg(UserIndex, "No puedes incorporar a tu party a personajes de mayor jerarquía.", FontTypeNames.FONTTYPE_INFO);
        ...
        private static void HandleGuildMemberList(short UserIndex)
        {
            ...
            try
            {
                ...
                string UserName;
                {
                    ...
                    {
                        if (Migration.migr_InStrB(guild, @"\") != 0)
                        {
                            guild = guild.Replace(@"\", "");
                        }
                        if (Migration.migr_InStrB(guild, "/") != 0)
                        ...
                        if (!System.IO.File.Exists(AppDomain.CurrentDomain.BaseDirectory + "guilds/" + guild + "-members.mem"))
                        {
                        ...
                        {
                            int argEmptySpaces = 1024;
                            memberCount = Convert.ToInt16(Migration.ParseVal(ES.GetVar(AppDomain.CurrentDomain.BaseDirectory + "Guilds/" + guild + "-Members" + ".mem", "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces)));

                            var loopTo = (int)memberCount;
                            for (i = 1; i <= loopTo; i++)
                            {
                                int argEmptySpaces1 = 1024;
                                UserName = ES.GetVar(AppDomain.CurrentDomain.BaseDirectory + "Guilds/" + guild + "-Members" + ".mem", "Members", "Member" + i, EmptySpaces: ref argEmptySpaces1);
        ...
        private static void HandleGMMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                    {
                        string argtexto = "Mensaje a Gms:" + message;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        if (Migration.migr_LenB(message) != 0)
                        {
                            ...
                            modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg(withBlock.name + "> " + message, FontTypeNames.FONTTYPE_GMMSG));
                        }
                    }
        ...
        private static void HandleShowName(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.RoleMaster)) != 0)
        ...
        private static void HandleOnlineRoyalArmy(short UserIndex)
        {
            ...
            var list = default(string);
            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    if (Declaraciones.UserList[i].ConnID != -1)
                    {
                        ...
                        {
                            if ((Declaraciones.UserList[i].flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0 | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)
            ...
            if (list.Length > 0)
            {
                WriteConsoleMsg(UserIndex, "Reales conectados: " + list.Substring(0, Math.Min(list.Length - 2, list.Length)), FontTypeNames.FONTTYPE_INFO);
            }
            else
            {
        ...
        private static void HandleOnlineChaosLegion(short UserIndex)
        {
            ...
            if (list.Length > 0)
            {
                WriteConsoleMsg(UserIndex, "Caos conectados: " + list.Substring(0, Math.Min(list.Length - 2, list.Length)), FontTypeNames.FONTTYPE_INFO);
            }
            else
            {
        ...
        private static void HandleGoNearby(short UserIndex)
        {
            ...
            try
            {
                ...
                var found = default(bool);
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero)) != 0)
                    {
                        // Si es dios o Admins no podemos salvo que nosotros también lo seamos
                        if (!(ES.EsDios(UserName) | ES.EsAdmin(UserName)) | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)
                        {
                                ...
                                for (i = 2; i <= 5; i++) // esto for sirve ir cambiando la distancia destino
                                {
                                    ...
                                    for (X = Declaraciones.UserList[tIndex].Pos.X - i; X <= loopTo; X++)
                                    {
                                        ...
                                        for (Y = Declaraciones.UserList[tIndex].Pos.Y - i; Y <= loopTo1; Y++)
                                        {
                                            ...
                                            {
                                                if (Extra.LegalPos(Declaraciones.UserList[tIndex].Pos.Map, Convert.ToInt16(X), Convert.ToInt16(Y), true, true))
                                                {
                                                    UsUaRiOs.WarpUserChar(UserIndex, Declaraciones.UserList[tIndex].Pos.Map, Convert.ToInt16(X), Convert.ToInt16(Y), true);
                                                    string argtexto = "/IRCERCA " + UserName + " Mapa:" + Declaraciones.UserList[tIndex].Pos.Map + " X:" + Declaraciones.UserList[tIndex].Pos.X + " Y:" + Declaraciones.UserList[tIndex].Pos.Y;
                                                    General.LogGM(ref withBlock.name, ref argtexto);
                                                    found = true;
                                                    break;
                                                }
        ...
        private static void HandleComment(short UserIndex)
        {
            ...
            try
            {
                ...
                string comment;
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                    {
                        string argtexto = "Comentario: " + comment;
                        General.LogGM(ref withBlock.name, ref argtexto);
        ...
        private static void HandleServerTime(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = "Hora.";
                General.LogGM(ref withBlock.name, ref argtexto);
            }

            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Hora: " + Conversions.ToString(DateAndTime.TimeOfDay) + " " + Conversions.ToString(DateTime.Today), FontTypeNames.FONTTYPE_INFO));
        }
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                    {
                        ...
                        else if ((Declaraciones.UserList[tUser].flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0 | (Declaraciones.UserList[tUser].flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)

                        {
                            WriteConsoleMsg(UserIndex, "Ubicación  " + UserName + ": " + Declaraciones.UserList[tUser].Pos.Map + ", " + Declaraciones.UserList[tUser].Pos.X + ", " + Declaraciones.UserList[tUser].Pos.Y + ".", FontTypeNames.FONTTYPE_INFO);
                            string argtexto = "/Donde " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                    }
                ...
                if (General.MapaValido(Map))
                {
                    ...
                    for (i = 1; i <= loopTo; i++)
                    {
                        ...
                        if (Declaraciones.Npclist[i].Pos.Map == Map)
                        {
                            // ¿esta vivo?
                            // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                            if (Declaraciones.Npclist[i].flags.NPCActive & Declaraciones.Npclist[i].Hostile == 1 & Declaraciones.Npclist[i].Stats.Alineacion == 2)
                            {
                                ...
                                if (NPCcount1 == 0)
                                {
                                    ...
                                    NPCcount1 = 1;
                                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                    List1[0] = Declaraciones.Npclist[i].name + ": (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                    NPCcant1[0] = 1;
                                }
                                else
                                {
                                    ...
                                    {
                                        // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                        if ((List1[j].Substring(0, Math.Min(Declaraciones.Npclist[i].name.Length, List1[j].Length)) ?? "") == (Declaraciones.Npclist[i].name ?? ""))
                                        {
                                            // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                            List1[j] = List1[j] + ", (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                    ...
                                    if (j == NPCcount1)
                                    {
                                        ...
                                        // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                        List1[j] = Declaraciones.Npclist[i].name + ": (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                        NPCcant1[j] = 1;
                                    }
                                }
                            }
                            else if (NPCcount2 == 0)
                            {
                                ...
                                NPCcount2 = 1;
                                // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                List2[0] = Declaraciones.Npclist[i].name + ": (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                NPCcant2[0] = 1;
                            }
                            else
                            {
                                ...
                                {
                                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                    if ((List2[j].Substring(0, Math.Min(Declaraciones.Npclist[i].name.Length, List2[j].Length)) ?? "") == (Declaraciones.Npclist[i].name ?? ""))
                                    {
                                        // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                        List2[j] = List2[j] + ", (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                ...
                                if (j == NPCcount2)
                                {
                                    ...
                                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto i. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                    List2[j] = Declaraciones.Npclist[i].name + ": (" + Declaraciones.Npclist[i].Pos.X + "," + Declaraciones.Npclist[i].Pos.Y + ")";
                                    NPCcant2[j] = 1;
                                }
                            }
                        }
                    ...
                    string argtexto = "Numero enemigos en mapa " + Map;
                    General.LogGM(ref withBlock.name, ref argtexto);
                }
            }
        }
        ...
        private static void HandleWarpMeToTarget(short UserIndex)
        {
            ...
            short Y;
            {
                ...
                string argtexto = "/TELEPLOC a x:" + withBlock.flags.TargetX + " Y:" + withBlock.flags.TargetY + " Map:" + withBlock.Pos.Map;
                General.LogGM(ref withBlock.name, ref argtexto);
            }
        }
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                    {
                        if (General.MapaValido(Map) & Migration.migr_LenB(UserName) != 0)
                        {
                            ...
                            else if (Extra.InMapBounds(Map, X, Y))
                            {
                                ...
                                WriteConsoleMsg(UserIndex, Declaraciones.UserList[tUser].name + " transportado.", FontTypeNames.FONTTYPE_INFO);
                                string argtexto = "Transportó a " + Declaraciones.UserList[tUser].name + " hacia " + "Mapa" + Map + " X:" + X + " Y:" + Y;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                        }
                    }
                ...
                short tUser;
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                    {
                        ...
                        else if (Declaraciones.UserList[tUser].flags.Silenciado == 0)
                        {
                            ...
                            WriteShowMessageBox(tUser, "Estimado usuario, ud. ha sido silenciado por los administradores. Sus denuncias serán ignoradas por el servidor de aquí en más. Utilice /GM para contactar un administrador.");
                            string argtexto = "/silenciar " + Declaraciones.UserList[tUser].name;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        else
                        {
                            ...
                            string argtexto1 = "/DESsilenciar " + Declaraciones.UserList[tUser].name;
                            General.LogGM(ref withBlock.name, ref argtexto1);
                        }
                    }
        ...
        private static void HandleGoToChar(short UserIndex)
        {
            ...
            try
            {
                ...
                short Y;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero)) != 0)
                    {
                        // Si es dios o Admins no podemos salvo que nosotros también lo seamos
                        if (!(ES.EsDios(UserName) | ES.EsAdmin(UserName)) | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    WriteConsoleMsg(tUser, withBlock.name + " se ha trasportado hacia donde te encuentras.", FontTypeNames.FONTTYPE_INFO);
                                    FlushBuffer(tUser);
                                }

                                string argtexto = "/IRA " + UserName + " Mapa:" + Declaraciones.UserList[tUser].Pos.Map + " X:" + Declaraciones.UserList[tUser].Pos.X + " Y:" + Declaraciones.UserList[tUser].Pos.Y;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                        }
                    }
        ...
        private static void HandleRequestUserList(short UserIndex)
        {
...

            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.RoleMaster)) != 0)
                    return;
        ...
        private static void HandleHiding(short UserIndex)
        {
...

            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    if (Migration.migr_LenB(Declaraciones.UserList[i].name) != 0 & Declaraciones.UserList[i].Counters.Ocultando > 0)
                    {
                        users = users + Declaraciones.UserList[i].name + ", ";
                    }
                }
        ...
        private static void HandleJail(short UserIndex)
        {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if (UserName.IndexOf("+", 1 - 1) + 1 != 0)
                    {
                        UserName = UserName.Replace("+", " ");
                    }

                    // /carcel nick@motivo@<tiempo>
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                WriteConsoleMsg(UserIndex, "No puedes encarcelar a administradores.", FontTypeNames.FONTTYPE_INFO);
                            }
                            else if (jailTime > 60)
                            {
                                WriteConsoleMsg(UserIndex, "No puedés encarcelar por más de 60 minutos.", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                if (Migration.migr_InStrB(UserName, @"\") != 0)
                                {
                                    UserName = UserName.Replace(@"\", "");
                                }
                                if (Migration.migr_InStrB(UserName, "/") != 0)
                                ...
                                if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                                {
                                    int argEmptySpaces = 1024;
                                    Count = Convert.ToByte(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces)));
                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", (Count + 1).ToString());
                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + (Count + 1), withBlock.name.ToLower() + ": CARCEL " + jailTime + "m, MOTIVO: " + reason.ToLower() + " " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));
                                }

                                Admin.Encarcelar(tUser, jailTime, withBlock.name);
                                string argtexto = " encarceló a " + UserName;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                        }
                    }
        ...
        private static void HandleKillNPC(short UserIndex)
        {
            ...
            Declaraciones.npc auxNPC;
            {
                ...
                if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.Consejero) != 0)
                {
                    ...
                    {
                        WriteConsoleMsg(UserIndex, "Los consejeros no pueden usar este comando en el mapa pretoriano.", FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                }
                ...
                if (tNPC > 0)
                {
                    WriteConsoleMsg(UserIndex, "RMatas (con posible respawn) a: " + Declaraciones.Npclist[tNPC].name, FontTypeNames.FONTTYPE_INFO);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                                {
                                    ...
                                    Count = Convert.ToByte(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces)));
                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", (Count + 1).ToString());
                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + (Count + 1), withBlock.name.ToLower() + ": ADVERTENCIA por: " + reason.ToLower() + " " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));

                                    WriteConsoleMsg(UserIndex, "Has advertido a " + UserName.ToUpper() + ".", FontTypeNames.FONTTYPE_INFO);
                                    string argtexto = " advirtio a " + UserName;
                                    General.LogGM(ref withBlock.name, ref argtexto);
                                }
                            }
                        }
        ...
        private static void HandleEditChar(short UserIndex)
        {
            ...
            try
            {
                ...
                int bankGold;
                {
                    ...
                    if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0)
                    {
                        switch (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero))
                        {
                            case Declaraciones.PlayerType.Consejero:
                                {
                                    // Los RMs consejeros sólo se pueden editar su head, body y level
                                    valido = tUser == UserIndex & (opcion == (byte)eEditOptions.eo_Body | opcion == (byte)eEditOptions.eo_Head | opcion == (byte)eEditOptions.eo_Level);
                                    break;
                                }
                            ...
                            case Declaraciones.PlayerType.SemiDios:
                                {
                                    ...
                                    valido = opcion == (byte)eEditOptions.eo_Level & tUser == UserIndex | opcion == (byte)eEditOptions.eo_Body | opcion == (byte)eEditOptions.eo_Head;
                                    break;
                                }
                            ...
                            case Declaraciones.PlayerType.Dios:
                                {
                                    ...
                                    valido = opcion == (byte)eEditOptions.eo_Level & tUser == UserIndex | opcion == (byte)eEditOptions.eo_Body | opcion == (byte)eEditOptions.eo_Head | opcion == (byte)eEditOptions.eo_CiticensKilled | opcion == (byte)eEditOptions.eo_CriminalsKilled | opcion == (byte)eEditOptions.eo_Class | opcion == (byte)eEditOptions.eo_Skills | opcion == (byte)eEditOptions.eo_addGold;
                                    break;
                                }
                        }
                    }

                    else if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        else
                        {
                            ...
                            switch (opcion)
                            {
                                case (byte)eEditOptions.eo_Gold:
                                    {
                                        if (Migration.ParseVal(Arg1) <= Declaraciones.MAX_ORO_EDIT)
                                        {
                                            ...
                                            {
                                                Declaraciones.UserList[tUser].Stats.GLD = Convert.ToInt32(Migration.ParseVal(Arg1));
                                ...
                                case (byte)eEditOptions.eo_Experience:
                                    {
                                        if (Migration.ParseVal(Arg1) > 20000000d)
                                        {
                                        ...
                                        {
                                            int argEmptySpaces = 1024;
                                            Var = Convert.ToInt32(ES.GetVar(UserCharPath, "STATS", "EXP", EmptySpaces: ref argEmptySpaces));
                                            ES.WriteVar(UserCharPath, "STATS", "EXP", (Var + Migration.ParseVal(Arg1)).ToString());
                                            WriteConsoleMsg(UserIndex, "Charfile Alterado: " + UserName, FontTypeNames.FONTTYPE_INFO);
                                        }
                                        else // Online
                                        {
                                            Declaraciones.UserList[tUser].Stats.Exp = Declaraciones.UserList[tUser].Stats.Exp + Migration.ParseVal(Arg1);
                                ...
                                case (byte)eEditOptions.eo_Body:
                                    {
                                        ...
                                        {
                                            UsUaRiOs.ChangeUserChar(tUser, Convert.ToInt16(Migration.ParseVal(Arg1)), Declaraciones.UserList[tUser].Char_Renamed.Head, (byte)Declaraciones.UserList[tUser].Char_Renamed.heading, Declaraciones.UserList[tUser].Char_Renamed.WeaponAnim, Declaraciones.UserList[tUser].Char_Renamed.ShieldAnim, Declaraciones.UserList[tUser].Char_Renamed.CascoAnim);
                                        }
                                ...
                                case (byte)eEditOptions.eo_Head:
                                    {
                                        ...
                                        {
                                            UsUaRiOs.ChangeUserChar(tUser, Declaraciones.UserList[tUser].Char_Renamed.body, Convert.ToInt16(Migration.ParseVal(Arg1)), (byte)Declaraciones.UserList[tUser].Char_Renamed.heading, Declaraciones.UserList[tUser].Char_Renamed.WeaponAnim, Declaraciones.UserList[tUser].Char_Renamed.ShieldAnim, Declaraciones.UserList[tUser].Char_Renamed.CascoAnim);
                                        }
                                ...
                                case (byte)eEditOptions.eo_CriminalsKilled:
                                    {
                                        Var = Migration.ParseVal(Arg1) > Declaraciones.MAXUSERMATADOS ? Declaraciones.MAXUSERMATADOS : Convert.ToInt32(Migration.ParseVal(Arg1));
                                ...
                                case (byte)eEditOptions.eo_Level:
                                    {
                                        if (Migration.ParseVal(Arg1) > Declaraciones.STAT_MAXELV)
                                        {
                                            ...
                                            WriteConsoleMsg(UserIndex, "No puedes tener un nivel superior a " + Declaraciones.STAT_MAXELV + ".", FontTypeNames.FONTTYPE_INFO);
                                        }
                                        ...
                                        if (Migration.ParseVal(Arg1) >= 25d)
                                        {
                                            ...
                                            {
                                                int argEmptySpaces1 = 1024;
                                                GI = Convert.ToInt16(ES.GetVar(UserCharPath, "GUILD", "GUILDINDEX", EmptySpaces: ref argEmptySpaces1));
                                            }
                                            else
                                            {
                                            ...
                                            if (GI > 0)
                                            {
                                                if (modGuilds.GuildAlignment(GI) == "Del Mal" | modGuilds.GuildAlignment(GI) == "Real")
                                                {
                                                    ...
                                                    modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GI, PrepareMessageConsoleMsg(UserName + " deja el clan.", FontTypeNames.FONTTYPE_GUILD));
                                ...
                                case (byte)eEditOptions.eo_Skills:
                                    {
                                        ...
                                        {
                                            if ((Declaraciones.SkillsNames[LoopC].Replace(" ", "+").ToUpper() ?? "") == (Arg1.ToUpper() ?? ""))
                                                break;
                                        }
                                        ...
                                        else if (tUser <= 0) // Offline
                                        {
                                            ...
                                            {
                                                ES.WriteVar(UserCharPath, "Skills", "ELUSK" + LoopC, (Declaraciones.ELU_SKILL_INICIAL * Math.Pow(1.05d, Convert.ToDouble(Arg2))).ToString());
                                            }
                                            else
                                            {
                                        ...
                                        {
                                            Declaraciones.UserList[tUser].Stats.UserSkills[LoopC] = Convert.ToByte(Migration.ParseVal(Arg2));
                                ...
                                case (byte)eEditOptions.eo_SkillPointsLeft:
                                    {
                                        ...
                                        {
                                            Declaraciones.UserList[tUser].Stats.SkillPts = Convert.ToInt16(Migration.ParseVal(Arg1));
                                        }
                                ...
                                case (byte)eEditOptions.eo_Nobleza:
                                    {
                                        Var = Migration.ParseVal(Arg1) > Declaraciones.MAXREP ? Declaraciones.MAXREP : Convert.ToInt32(Migration.ParseVal(Arg1));
                                ...
                                case (byte)eEditOptions.eo_addGold:
                                    {
                                        ...
                                        else if (tUser <= 0)
                                        {
                                            ...
                                            bankGold = Convert.ToInt32(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "STATS", "BANCO", EmptySpaces: ref argEmptySpaces2));
                                            ES.WriteVar(UserCharPath, "STATS", "BANCO", (bankGold + Migration.ParseVal(Arg1) <= 0d ? 0d : bankGold + Migration.ParseVal(Arg1)).ToString());
                                            WriteConsoleMsg(UserIndex, "Se le ha agregado " + Arg1 + " monedas de oro a " + UserName + ".", FontTypeNames.FONTTYPE_TALK);
                                        }
                                        else
                                        {
                                            Declaraciones.UserList[tUser].Stats.Banco = Declaraciones.UserList[tUser].Stats.Banco + Convert.ToInt32(Migration.ParseVal(Arg1)) <= 0 ? 0 : Convert.ToInt32(Declaraciones.UserList[tUser].Stats.Banco + Migration.ParseVal(Arg1));
                                            WriteConsoleMsg(tUser, Declaraciones.STANDARD_BOUNTY_HUNTER_MESSAGE, FontTypeNames.FONTTYPE_TALK);
                                        }
                            ...
                            string argtexto1 = CommandString + " " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto1);
        ...
        private static void HandleRequestCharInfo(short UserIndex)
        {
            ...
            try
            {
                ...
                short TargetIndex;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)

                    {
                        ...
                        // don't allow to retrieve administrator's info
                        else if ((Declaraciones.UserList[TargetIndex].flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                        {
        ...
        private static void HandleRequestCharStats(short UserIndex)
        {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        string argtexto = "/STAT " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
            ...
            try
            {
                ...
                short tUser;
                {
...

                    {
                        ...
                        {
                            WriteConsoleMsg(UserIndex, "El usuario " + UserName + " tiene " + Declaraciones.UserList[tUser].Stats.Banco + " en el banco.", FontTypeNames.FONTTYPE_TALK);
                        }
                    }
        ...
        private static void HandleRequestCharSkills(short UserIndex)
        {
            ...
            try
            {
                ...
                var message = default(string);
                {
                    ...
                    {
                        string argtexto = "/STATS " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        if (tUser <= 0)
                        {
                            ...
                            {
                                int argEmptySpaces = 1024;
                                message = message + "CHAR>" + Declaraciones.SkillsNames[LoopC] + " = " + ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "SKILLS", "SK" + LoopC, EmptySpaces: ref argEmptySpaces) + Constants.vbCrLf;
                            }

                            int argEmptySpaces1 = 1024;
                            WriteConsoleMsg(UserIndex, message + "CHAR> Libres:" + ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "STATS", "SKILLPTSLIBRES", EmptySpaces: ref argEmptySpaces1), FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                        ...
                        {
                            {
                                ...
                                if (withBlock1.flags.Muerto == 1)
                                {
                                    ...
                                    UsUaRiOs.ChangeUserChar(tUser, withBlock1.Char_Renamed.body, withBlock1.OrigChar.Head, (byte)withBlock1.Char_Renamed.heading, withBlock1.Char_Renamed.WeaponAnim, withBlock1.Char_Renamed.ShieldAnim, withBlock1.Char_Renamed.CascoAnim);

                                    WriteConsoleMsg(tUser, Declaraciones.UserList[UserIndex].name + " te ha resucitado.", FontTypeNames.FONTTYPE_INFO);
                                }
                                else
                                {
                                    WriteConsoleMsg(tUser, Declaraciones.UserList[UserIndex].name + " te ha curado.", FontTypeNames.FONTTYPE_INFO);
                                }
                            ...
                            string argtexto = "Resucito a " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                    }
        ...
        private static void HandleOnlineMap(short UserIndex)
        {
            ...
            Declaraciones.PlayerType priv;
            {
                ...
                priv = Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios;
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)
                    priv = priv | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin;
                ...
                {
                    if (Migration.migr_LenB(Declaraciones.UserList[LoopC].name) != 0 & Declaraciones.UserList[LoopC].Pos.Map == Map)
                    {
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        ...
                        if (tUser > 0)
                        {
                            ...
                            {
                                string argtexto = "Intento perdonar un personaje de nivel avanzado.";
                                General.LogGM(ref withBlock.name, ref argtexto);
            ...
            try
            {
                ...
                short rank;
                {
...

                    {
                        ...
                        else if (((int)Declaraciones.UserList[tUser].flags.Privilegios & rank) > ((int)withBlock.flags.Privilegios & rank))
                        {
                            WriteConsoleMsg(UserIndex, "No puedes echar a alguien con jerarquía mayor a la tuya.", FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(withBlock.name + " echó a " + UserName + ".", FontTypeNames.FONTTYPE_INFO));
                            TCP.CloseSocket(tUser);
                            string argtexto = "Echó a " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                    }
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        ...
                        if (tUser > 0)
                        {
                            ...
                            {
                                WriteConsoleMsg(UserIndex, "¿¿Estás loco?? ¿¿Cómo vas a piñatear un gm?? :@", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                UsUaRiOs.UserDie(tUser);
                                modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(withBlock.name + " ha ejecutado a " + UserName + ".", FontTypeNames.FONTTYPE_EJECUCION));
                                string argtexto = " ejecuto a " + UserName;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                        }
                        else
            ...
            try
            {
                ...
                byte cantPenas;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        ...
                        {
                            int argEmptySpaces1 = 1024;
                            if (Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "FLAGS", "Ban", EmptySpaces: ref argEmptySpaces1)) == 1d)
                            {
                                Admin.UnBan(UserName);

                                // penas
                                int argEmptySpaces = 1024;
                                cantPenas = Convert.ToByte(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces)));
                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", (cantPenas + 1).ToString());
                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + (cantPenas + 1), withBlock.name.ToLower() + ": UNBAN. " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));

                                string argtexto = "/UNBAN a " + UserName;
                                General.LogGM(ref withBlock.name, ref argtexto);
                                WriteConsoleMsg(UserIndex, UserName + " unbanned.", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                WriteConsoleMsg(UserIndex, UserName + " no está baneado. Imposible unbanear.", FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                    }
            ...
            try
            {
                ...
                short Y;
                {
...

                    {
                        ...
                        else if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0 | (Declaraciones.UserList[tUser].flags.Privilegios & (Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.User)) != 0)
                        {
                            ...
                            string argtexto = "/SUM " + UserName + " Map:" + withBlock.Pos.Map + " X:" + withBlock.Pos.X + " Y:" + withBlock.Pos.Y;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                        else
                        {
        ...
        private static void HandleSpawnCreature(short UserIndex)
        {
            ...
            short npc_Renamed;
            {
                ...
                npc_Renamed = withBlock.incomingData.ReadInteger();

                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)

                {
                    if (npc_Renamed > 0 & npc_Renamed <= Declaraciones.SpawnList.Length - 1)
                        NPCs.SpawnNpc(Declaraciones.SpawnList[npc_Renamed].NpcIndex, ref withBlock.Pos, true, false);

                    string argtexto = "Sumoneo " + Declaraciones.SpawnList[npc_Renamed].NpcName;
                    General.LogGM(ref withBlock.name, ref argtexto);
                }
            }
        }
        ...
        private static void HandleResetNPCInventory(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.RoleMaster)) != 0)
                    return;
                if (withBlock.flags.TargetNPC == 0)
                    return;

                InvNpc.ResetNpcInv(withBlock.flags.TargetNPC);
                string argtexto = "/RESETINV " + Declaraciones.Npclist[withBlock.flags.TargetNPC].name;
                General.LogGM(ref withBlock.name, ref argtexto);
            }
        }
            ...
            try
            {
                ...
                string message;
                {
...

                    {
                        if (Migration.migr_LenB(message) != 0)
                        {
                            string argtexto = "Mensaje Broadcast:" + message;
                            General.LogGM(ref withBlock.name, ref argtexto);
                            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(Declaraciones.UserList[UserIndex].name + "> " + message, FontTypeNames.FONTTYPE_TALK));
                            // '''''''''''''''SOLO PARA EL TESTEO'''''''
        ...
        private static void HandleNickToIP(short UserIndex)
        {
            ...
            try
            {
                ...
                int LoopC;
                {
                    ...
                    {
                        tUser = Extra.NameIndex(UserName);
                        string argtexto = "NICK2IP Solicito la IP de " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);

                        if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0)
                        {
                            priv = Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin;
                        }
                        else
                        {
                        ...
                        if (tUser > 0)
                        {
                            ...
                            {
                                WriteConsoleMsg(UserIndex, "El ip de " + UserName + " es " + Declaraciones.UserList[tUser].ip, FontTypeNames.FONTTYPE_INFO);
                                ...
                                for (LoopC = 1; LoopC <= loopTo; LoopC++)
                                {
                                    ...
                                    {
                                        if (Migration.migr_LenB(Declaraciones.UserList[LoopC].name) != 0 & Declaraciones.UserList[LoopC].flags.UserLogged)
                                        {
                                            if ((Declaraciones.UserList[LoopC].flags.Privilegios & priv) != 0)
                                            {
        ...
        private static void HandleIPToNick(short UserIndex)
        {
            ...
            Declaraciones.PlayerType priv;
            {
                ...
                string argtexto = "IP2NICK Solicito los Nicks de IP " + ip;
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        private static void HandleGuildOnlineMembers(short UserIndex)
        {
            ...
            try
            {
                ...
                short tGuild;
                {
                    ...
                    if (Migration.migr_InStrB(GuildName, "+") != 0)
                    {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        ...
                        if (tGuild > 0)
                        {
                            WriteConsoleMsg(UserIndex, "Clan " + GuildName.ToUpper() + ": " + modGuilds.m_ListaDeMiembrosOnline(UserIndex, tGuild), FontTypeNames.FONTTYPE_GUILDMSG);
                        }
                    }
        ...
        private static void HandleTeleportCreate(short UserIndex)
        {
            ...
            Declaraciones.Obj ET;
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                    return;

                string argtexto = "/CT " + mapa + "," + X + "," + Y + "," + Radio;
                General.LogGM(ref withBlock.name, ref argtexto);
                ...
                {
                    WriteConsoleMsg(UserIndex, "No puedes crear un teleport que apunte a la entrada de otro.", FontTypeNames.FONTTYPE_INFO);
                    return;
                }
        ...
        private static void HandleTeleportDestroy(short UserIndex)
        {
            ...
            byte Y;
            {
...

                {
                    ...
                    if (Declaraciones.ObjData_Renamed[withBlock1.ObjInfo.ObjIndex].OBJType == Declaraciones.eOBJType.otTeleport & withBlock1.TileExit.Map > 0)
                    {
                        string argtexto = "/DT: " + mapa + "," + X + "," + Y;
                        ...
                        if (Declaraciones.MapData[withBlock1.TileExit.Map, withBlock1.TileExit.X, withBlock1.TileExit.Y].ObjInfo.ObjIndex == 651)
                        {
        ...
        private static void HandleSetCharDescription(short UserIndex)
        {
            ...
            try
            {
                ...
                string desc;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.Admin)) != 0 | (withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0)
                    {
            ...
            short mapa;
            {
...

                {
                    ...
                    if (midiID == 0)
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.toMap, mapa, PrepareMessagePlayMidi(Convert.ToByte(Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Music)));
                    }
                    else
                    {
        ...
        private static void HandleRoyalArmyMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToRealYRMs, 0, PrepareMessageConsoleMsg("EJÉRCITO REAL> " + message, FontTypeNames.FONTTYPE_TALK));
                    }
        ...
        private static void HandleChaosLegionMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToCaosYRMs, 0, PrepareMessageConsoleMsg("FUERZAS DEL CAOS> " + message, FontTypeNames.FONTTYPE_TALK));
                    }
        ...
        private static void HandleCitizenMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToCiudadanosYRMs, 0, PrepareMessageConsoleMsg("CIUDADANOS> " + message, FontTypeNames.FONTTYPE_TALK));
                    }
        ...
        private static void HandleCriminalMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToCriminalesYRMs, 0, PrepareMessageConsoleMsg("CRIMINALES> " + message, FontTypeNames.FONTTYPE_TALK));
                    }
            ...
            try
            {
                ...
                string message;
                {
...

                    {
                        ...
                        if (withBlock.flags.TargetNPC > 0)
                        {
                            modSendData.SendData(modSendData.SendTarget.ToNPCArea, withBlock.flags.TargetNPC, PrepareMessageChatOverHead(message, Declaraciones.Npclist[withBlock.flags.TargetNPC].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White)));
                        }
                        else
                        {
                            WriteConsoleMsg(UserIndex, "Debes seleccionar el NPC por el que quieres hablar antes de usar este comando.", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
                    ...
                    for (X = withBlock.Pos.X - Declaraciones.MinXBorder + 1; X <= loopTo1; X++)
                    {
                        if (X > 0 & Y > 0 & X < 101 & Y < 101)
                        {
                            if (Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.ObjIndex > 0)
                            {
                                ...
                                if (Extra.ItemNoEsDeMapa(Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.ObjIndex, bIsExit))
                                {
                                    InvUsuario.EraseObj(Declaraciones.MAX_INVENTORY_OBJS, withBlock.Pos.Map, Convert.ToInt16(X), Convert.ToInt16(Y));
                                }
                            }
                        }
                    }
        ...
        private static void HandleAcceptRoyalCouncilMember(short UserIndex)
        {
            ...
            try
            {
                ...
                byte LoopC;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        tUser = Extra.NameIndex(UserName);
                        if (tUser <= 0)
                        {
                        ...
                        {
                            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(UserName + " fue aceptado en el honorable Consejo Real de Banderbill.", FontTypeNames.FONTTYPE_CONSEJO));
                            {
                                ref var withBlock1 = ref Declaraciones.UserList[tUser];
                                if ((withBlock1.flags.Privilegios & Declaraciones.PlayerType.ChaosCouncil) != 0)
                                    withBlock1.flags.Privilegios = (Declaraciones.PlayerType)((int)withBlock1.flags.Privilegios - (int)Declaraciones.PlayerType.ChaosCouncil);
                                if ((withBlock1.flags.Privilegios & Declaraciones.PlayerType.RoyalCouncil) == 0)
                                    withBlock1.flags.Privilegios = (Declaraciones.PlayerType)((int)withBlock1.flags.Privilegios + (int)Declaraciones.PlayerType.RoyalCouncil);
            ...
            try
            {
                ...
                byte LoopC;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(UserName + " fue aceptado en el Concilio de las Sombras.", FontTypeNames.FONTTYPE_CONSEJO));
            ...
            int Y;
            {
                ...
                for (X = 5; X <= 95; X++)
                {
                    for (Y = 5; Y <= 95; Y++)
                    {
                        ...
                        if (tObj > 0)
                        {
                            if (Declaraciones.ObjData_Renamed[tObj].OBJType != Declaraciones.eOBJType.otArboles)
                            {
                                WriteConsoleMsg(UserIndex, "(" + X + "," + Y + ") " + Declaraciones.ObjData_Renamed[tObj].name, FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                    }
                }
        ...
        private static void HandleMakeDumb(short UserIndex)
        {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0 | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.RoleMaster)) == (Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.RoleMaster))
                    {
                        tUser = Extra.NameIndex(UserName);
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        if (tUser <= 0)
                        {
                            if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                            {
                                WriteConsoleMsg(UserIndex, "Usuario offline, echando de los consejos.", FontTypeNames.FONTTYPE_INFO);
                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "CONSEJO", "PERTENECE", 0.ToString());
                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "CONSEJO", "PERTENECECAOS", 0.ToString());
                            }
                            else
                            {
                                WriteConsoleMsg(UserIndex, "No se encuentra el charfile " + Declaraciones.CharPath + UserName + ".chr", FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                        else
                        {
                            {
                                ...
                                if ((withBlock1.flags.Privilegios & Declaraciones.PlayerType.RoyalCouncil) != 0)
                                {
                                    ...
                                    UsUaRiOs.WarpUserChar(tUser, withBlock1.Pos.Map, withBlock1.Pos.X, withBlock1.Pos.Y, false);
                                    modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(UserName + " fue expulsado del consejo de Banderbill.", FontTypeNames.FONTTYPE_CONSEJO));
                                }
                                ...
                                if ((withBlock1.flags.Privilegios & Declaraciones.PlayerType.ChaosCouncil) != 0)
                                {
                                    ...
                                    UsUaRiOs.WarpUserChar(tUser, withBlock1.Pos.Map, withBlock1.Pos.X, withBlock1.Pos.Y, false);
                                    modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(UserName + " fue expulsado del Concilio de las Sombras.", FontTypeNames.FONTTYPE_CONSEJO));
                                }
                            }
                        }
                    }
        ...
        private static void HandleSetTrigger(short UserIndex)
        {
            ...
            string tLog;
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.RoleMaster)) != 0)
                    return;

                if (tTrigger >= 0)
                {
                    Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].trigger = (Declaraciones.eTrigger)tTrigger;
                    tLog = "Trigger " + tTrigger + " en mapa " + withBlock.Pos.Map + " " + withBlock.Pos.X + "," + withBlock.Pos.Y;
        ...
        private static void HandleAskTrigger(short UserIndex)
        {
...

            {
                ...
                tTrigger = Convert.ToByte((int)Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].trigger);

                string argtexto = "Miro el trigger en " + withBlock.Pos.Map + "," + withBlock.Pos.X + "," + withBlock.Pos.Y + ". Era " + tTrigger;
                General.LogGM(ref withBlock.name, ref argtexto);

                WriteConsoleMsg(UserIndex, "Trigger " + tTrigger + " en mapa " + withBlock.Pos.Map + " " + withBlock.Pos.X + ", " + withBlock.Pos.Y, FontTypeNames.FONTTYPE_INFO);
            }
        }
            ...
            try
            {
                ...
                string tFile;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(withBlock.name + " baneó al clan " + GuildName.ToUpper(), FontTypeNames.FONTTYPE_FIGHT));

                            // baneamos a los miembros
                            string argtexto = "BANCLAN a " + GuildName.ToUpper();
                            General.LogGM(ref withBlock.name, ref argtexto);

                            int argEmptySpaces = 1024;
                            cantMembers = Convert.ToInt16(Migration.ParseVal(ES.GetVar(tFile, "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces)));

                            var loopTo = (int)cantMembers;
                            for (LoopC = 1; LoopC <= loopTo; LoopC++)
                            {
                                int argEmptySpaces1 = 1024;
                                member = ES.GetVar(tFile, "Members", "Member" + LoopC, EmptySpaces: ref argEmptySpaces1);
                                // member es la victima
                                ES.Ban(member, "Administracion del servidor", "Clan Banned");

                                modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg("   " + member + "<" + GuildName + "> ha sido expulsado del servidor.", FontTypeNames.FONTTYPE_FIGHT));
                                ...
                                // ponemos la pena
                                int argEmptySpaces2 = 1024;
                                Count = Convert.ToByte(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + member + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces2)));
                                ES.WriteVar(Declaraciones.CharPath + member + ".chr", "PENAS", "Cant", (Count + 1).ToString());
                                ES.WriteVar(Declaraciones.CharPath + member + ".chr", "PENAS", "P" + (Count + 1), withBlock.name.ToLower() + ": BAN AL CLAN: " + GuildName + " " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));
                            }
                        }
                    }
            ...
            try
            {
                ...
                int i;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            string argtexto = "/BanIP " + bannedIP + " por " + reason;
                            General.LogGM(ref withBlock.name, ref argtexto);

                            if (Admin.BanIpBuscar(bannedIP) > 0)
                            {
                                WriteConsoleMsg(UserIndex, "La IP " + bannedIP + " ya se encuentra en la lista de bans.", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                Admin.BanIpAgrega(bannedIP);
                                modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg(withBlock.name + " baneó la IP " + bannedIP + " por " + reason, FontTypeNames.FONTTYPE_FIGHT));
        ...
        private static void HandleCreateItem(short UserIndex)
        {
            ...
            Declaraciones.Obj Objeto;
            {
                ...
                if (Migration.migr_LenB(Declaraciones.ObjData_Renamed[tObj].name) == 0)
                    return;

                WriteConsoleMsg(UserIndex, "¡¡ATENCIÓN: FUERON CREADOS ***100*** ÍTEMS, TIRE Y /DEST LOS QUE NO NECESITE!!", FontTypeNames.FONTTYPE_GUILD);
        ...
        private static void HandleDestroyItems(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = "/DEST";
                General.LogGM(ref withBlock.name, ref argtexto);

                if (Declaraciones.ObjData_Renamed[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].ObjInfo.ObjIndex].OBJType == Declaraciones.eOBJType.otTeleport & Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].TileExit.Map > 0)
                {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        string argtexto = "ECHO DEL CAOS A: " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);

                        if (tUser > 0)
                        {
                            bool argExpulsado = true;
                            ModFacciones.ExpulsarFaccionCaos(tUser, ref argExpulsado);
                            Declaraciones.UserList[tUser].Faccion.Reenlistadas = 200;
                            WriteConsoleMsg(UserIndex, UserName + " expulsado de las fuerzas del caos y prohibida la reenlistada.", FontTypeNames.FONTTYPE_INFO);
                            WriteConsoleMsg(tUser, withBlock.name + " te ha expulsado en forma definitiva de las fuerzas del caos.", FontTypeNames.FONTTYPE_FIGHT);
                            FlushBuffer(tUser);
                        }
                        else if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                        {
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "EjercitoCaos", 0.ToString());
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "Reenlistadas", 200.ToString());
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "Extra", "Expulsado por " + withBlock.name);
                            WriteConsoleMsg(UserIndex, UserName + " expulsado de las fuerzas del caos y prohibida la reenlistada.", FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        string argtexto = "ECHÓ DE LA REAL A: " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        if (tUser > 0)
                        {
                            ...
                            Declaraciones.UserList[tUser].Faccion.Reenlistadas = 200;
                            WriteConsoleMsg(UserIndex, UserName + " expulsado de las fuerzas reales y prohibida la reenlistada.", FontTypeNames.FONTTYPE_INFO);
                            WriteConsoleMsg(tUser, withBlock.name + " te ha expulsado en forma definitiva de las fuerzas reales.", FontTypeNames.FONTTYPE_FIGHT);
                            FlushBuffer(tUser);
                        }
                        else if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                        {
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "EjercitoReal", 0.ToString());
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "Reenlistadas", 200.ToString());
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "FACCIONES", "Extra", "Expulsado por " + withBlock.name);
                            WriteConsoleMsg(UserIndex, UserName + " expulsado de las fuerzas reales y prohibida la reenlistada.", FontTypeNames.FONTTYPE_INFO);
                        }
        ...
        private static void HandleForceMIDIAll(short UserIndex)
        {
            ...
            byte midiID;
            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg(withBlock.name + " broadcast música: " + midiID, FontTypeNames.FONTTYPE_SERVER));
        ...
        private static void HandleForceWAVEAll(short UserIndex)
        {
            ...
            byte waveID;
            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessagePlayWave(waveID, Declaraciones.NO_3D_SOUND, Declaraciones.NO_3D_SOUND));
            }
        }
            ...
            try
            {
                ...
                string NewText;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            WriteConsoleMsg(UserIndex, "Utilice /borrarpena Nick@NumeroDePena@NuevaPena", FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            if (Migration.migr_InStrB(UserName, @"\") != 0)
                            ...
                            {
                                int argEmptySpaces = 1024;
                                string argtexto = " borro la pena: " + punishment + "-" + ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + punishment, EmptySpaces: ref argEmptySpaces) + " de " + UserName + " y la cambió por: " + NewText;
                                General.LogGM(ref withBlock.name, ref argtexto);

                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + punishment, withBlock.name.ToLower() + ": <" + NewText + "> " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));
        ...
        private static void HandleTileBlockedToggle(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                General.Bloquear(true, withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y, Convert.ToBoolean(Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].Blocked));
            }
        }
        ...
        private static void HandleKillNPCNoRespawn(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = "/MATA " + Declaraciones.Npclist[withBlock.flags.TargetNPC].name;
                General.LogGM(ref withBlock.name, ref argtexto);
            }
        }
        ...
        private static void HandleLastIP(short UserIndex)
        {
            ...
            try
            {
                ...
                bool validCheck;
                {
                    ...
                    priv = Convert.ToInt16((int)(Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero));
                    UserName = buffer.ReadASCIIString();
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios)) != 0)
                    {
                        ...
                        {
                            validCheck = ((int)Declaraciones.UserList[Extra.NameIndex(UserName)].flags.Privilegios & priv) == 0 | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0;
                        }
                        else
                        {
                            validCheck = ((int)Admin.UserDarPrivilegioLevel(UserName) & priv) == 0 | (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0;
                        }

                        if (validCheck)
                        {
                            string argtexto = "/LASTIP " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto);
                            ...
                            if (System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                            {
                                ...
                                {
                                    int argEmptySpaces = 1024;
                                    lista = lista + Constants.vbCrLf + LoopC + " - " + ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "INIT", "LastIP" + LoopC, EmptySpaces: ref argEmptySpaces);
                                }
                                WriteConsoleMsg(UserIndex, lista, FontTypeNames.FONTTYPE_INFO);
                            }
                            else
        ...
        public static void HandleChatColor(short UserIndex)
        {
            ...
            int color;
            {
                ...
                color = Information.RGB(withBlock.incomingData.ReadByte(), withBlock.incomingData.ReadByte(), withBlock.incomingData.ReadByte());

                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.RoleMaster)) != 0)

                {
                    withBlock.flags.ChatColor = color;
                }
            }
        }
        ...
        public static void HandleIgnored(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Consejero)) != 0)
                {
                    withBlock.flags.AdminPerseguible = !withBlock.flags.AdminPerseguible;
                }
            }
        }
        ...
        public static void HandleCheckSlot(short UserIndex)
        {
            ...
            try
            {
                ...
                short tIndex;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.SemiDios | Declaraciones.PlayerType.Dios)) != 0)

                    {
                        tIndex = Extra.NameIndex(UserName); // Que user index?

                        string argtexto = withBlock.name + " Checkeó el slot " + Slot + " de " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        if (tIndex > 0)
                        {
                            ...
                            {
                                if (Declaraciones.UserList[tIndex].Invent.Object_Renamed[Slot].ObjIndex > 0)
                                {
                                    WriteConsoleMsg(UserIndex, " Objeto " + Slot + ") " + Declaraciones.ObjData_Renamed[Declaraciones.UserList[tIndex].Invent.Object_Renamed[Slot].ObjIndex].name + " Cantidad:" + Declaraciones.UserList[tIndex].Invent.Object_Renamed[Slot].Amount, FontTypeNames.FONTTYPE_INFO);
                                }
                                else
                                {
                                    WriteConsoleMsg(UserIndex, "No hay ningún objeto en slot seleccionado.", FontTypeNames.FONTTYPE_INFO);
                                }
                            }
                            else
                            {
        ...
        public static void HandleResetAutoUpdate(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                WriteConsoleMsg(UserIndex, "TID: " + General.ReiniciarAutoUpdate().ToString(), FontTypeNames.FONTTYPE_INFO);
            }
        }
        ...
        public static void HandleRestart(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                // time and Time BUG!
                string argtexto = withBlock.name + " reinició el mundo.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleReloadObjects(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha recargado los objetos.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleReloadSpells(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha recargado los hechizos.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleReloadServerIni(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha recargado los INITs.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleReloadNPCs(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha recargado los NPCs.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleKickAllChars(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha echado a todos los personajes.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleShowServerForm(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha solicitado mostrar el formulario del servidor.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleCleanSOS(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha borrado los SOS.";
                General.LogGM(ref withBlock.name, ref argtexto);

                Declaraciones.Ayuda.Reset_Renamed();
            }
        }
        ...
        public static void HandleSaveChars(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha guardado todos los chars.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleChangeMapInfoBackup(short UserIndex)
        {
            ...
            bool doTheBackUp;
            {
                ...
                string argtexto = withBlock.name + " ha cambiado la información sobre el BackUp.";
                General.LogGM(ref withBlock.name, ref argtexto);

                // Change the boolean to byte in a fast way
                if (doTheBackUp)
                {
                    Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].BackUp = 1;
                }
                else
                {
                    Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].BackUp = 0;
                }

                // Change the boolean to string in a fast way
                ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + withBlock.Pos.Map + ".dat", "Mapa" + withBlock.Pos.Map, "backup", Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].BackUp.ToString());

                WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " Backup: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].BackUp, FontTypeNames.FONTTYPE_INFO);
            }
        }
        ...
        public static void HandleChangeMapInfoPK(short UserIndex)
        {
            ...
            bool isMapPk;
            {
                ...
                string argtexto = withBlock.name + " ha cambiado la información sobre si es PK el mapa.";
                General.LogGM(ref withBlock.name, ref argtexto);

                Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk = isMapPk;

                // Change the boolean to string in a fast way
                ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + withBlock.Pos.Map + ".dat", "Mapa" + withBlock.Pos.Map, "Pk", isMapPk ? "1" : "0");

                WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " PK: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk, FontTypeNames.FONTTYPE_INFO);
            }
        }
            ...
            try
            {
                ...
                var buffer = new clsByteQueue();
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            string argtexto = withBlock.name + " ha cambiado la información sobre si es restringido el mapa.";
                            General.LogGM(ref withBlock.name, ref argtexto);
                            Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Restringir = tStr;
                            ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "Restringir", tStr);
                            WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " Restringido: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Restringir, FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            WriteConsoleMsg(UserIndex, "Opciones para restringir: 'NEWBIE', 'NO', 'ARMADA', 'CAOS', 'FACCION'", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
        ...
        public static void HandleChangeMapInfoNoMagic(short UserIndex)
        {
...

            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                {
                    string argtexto = withBlock.name + " ha cambiado la información sobre si está permitido usar la magia el mapa.";
                    General.LogGM(ref withBlock.name, ref argtexto);
                    Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].MagiaSinEfecto = nomagic ? (byte)1 : (byte)0;
                    ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "MagiaSinEfecto", nomagic.ToString());
                    WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " MagiaSinEfecto: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].MagiaSinEfecto, FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void HandleChangeMapInfoNoInvi(short UserIndex)
        {
...

            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                {
                    string argtexto = withBlock.name + " ha cambiado la información sobre si está permitido usar la invisibilidad en el mapa.";
                    General.LogGM(ref withBlock.name, ref argtexto);
                    Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].InviSinEfecto = noinvi ? (byte)1 : (byte)0;
                    ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "InviSinEfecto", noinvi.ToString());
                    WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " InviSinEfecto: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].InviSinEfecto, FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void HandleChangeMapInfoNoResu(short UserIndex)
        {
...

            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                {
                    string argtexto = withBlock.name + " ha cambiado la información sobre si está permitido usar el resucitar en el mapa.";
                    General.LogGM(ref withBlock.name, ref argtexto);
                    Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].ResuSinEfecto = noresu ? (byte)1 : (byte)0;
                    ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "ResuSinEfecto", noresu.ToString());
                    WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " ResuSinEfecto: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].ResuSinEfecto, FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void HandleChangeMapInfoLand(short UserIndex)
        {
            ...
            try
            {
                ...
                var buffer = new clsByteQueue();
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        if (tStr == "BOSQUE" | tStr == "NIEVE" | tStr == "DESIERTO" | tStr == "CIUDAD" | tStr == "CAMPO" | tStr == "DUNGEON")
                        {
                            string argtexto = withBlock.name + " ha cambiado la información del terreno del mapa.";
                            General.LogGM(ref withBlock.name, ref argtexto);
                            Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Terreno = tStr;
                            ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "Terreno", tStr);
                            WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " Terreno: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Terreno, FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            WriteConsoleMsg(UserIndex, "Opciones para terreno: 'BOSQUE', 'NIEVE', 'DESIERTO', 'CIUDAD', 'CAMPO', 'DUNGEON'", FontTypeNames.FONTTYPE_INFO);
                            WriteConsoleMsg(UserIndex, "Igualmente, el único útil es 'NIEVE' ya que al ingresarlo, la gente muere de frío en el mapa.", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
            ...
            try
            {
                ...
                var buffer = new clsByteQueue();
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        if (tStr == "BOSQUE" | tStr == "NIEVE" | tStr == "DESIERTO" | tStr == "CIUDAD" | tStr == "CAMPO" | tStr == "DUNGEON")
                        {
                            string argtexto = withBlock.name + " ha cambiado la información de la zona del mapa.";
                            General.LogGM(ref withBlock.name, ref argtexto);
                            Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Zona = tStr;
                            ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + Declaraciones.MapPath + "mapa" + Declaraciones.UserList[UserIndex].Pos.Map + ".dat", "Mapa" + Declaraciones.UserList[UserIndex].Pos.Map, "Zona", tStr);
                            WriteConsoleMsg(UserIndex, "Mapa " + withBlock.Pos.Map + " Zona: " + Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Zona, FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            WriteConsoleMsg(UserIndex, "Opciones para terreno: 'BOSQUE', 'NIEVE', 'DESIERTO', 'CIUDAD', 'CAMPO', 'DUNGEON'", FontTypeNames.FONTTYPE_INFO);
                            WriteConsoleMsg(UserIndex, "Igualmente, el único útil es 'DUNGEON' ya que al ingresarlo, NO se sentirá el efecto de la lluvia en este mapa.", FontTypeNames.FONTTYPE_INFO);
                        }
                    }
        ...
        public static void HandleSaveMap(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha guardado el mapa " + withBlock.Pos.Map.ToString();
                General.LogGM(ref withBlock.name, ref argtexto);

                ES.GrabarMapa(withBlock.Pos.Map, AppDomain.CurrentDomain.BaseDirectory + "WorldBackUp/Mapa" + withBlock.Pos.Map);
        ...
        public static void HandleDoBackUp(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                string argtexto = withBlock.name + " ha hecho un backup.";
                General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleToggleCentinelActivated(short UserIndex)
        {
            ...
            // ***************************************************
            {
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg("El centinela ha sido activado.", FontTypeNames.FONTTYPE_SERVER));
                }
                else
                {
                    modSendData.SendData(modSendData.SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg("El centinela ha sido desactivado.", FontTypeNames.FONTTYPE_SERVER));
                }
            }
        }
                ...
                byte cantPenas;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (changeNameUI > 0)
                            {
                                WriteConsoleMsg(UserIndex, "El Pj está online, debe salir para hacer el cambio.", FontTypeNames.FONTTYPE_WARNING);
                            }
                            else if (!System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                            {
                                WriteConsoleMsg(UserIndex, "El pj " + UserName + " es inexistente.", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                int argEmptySpaces = 1024;
                                GuildIndex = Convert.ToInt16(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "GUILD", "GUILDINDEX", EmptySpaces: ref argEmptySpaces)));

                                if (GuildIndex > 0)
                                {
                                    WriteConsoleMsg(UserIndex, "El pj " + UserName + " pertenece a un clan, debe salir del mismo con /salirclan para ser transferido.", FontTypeNames.FONTTYPE_INFO);
                                }
                                else if (!System.IO.File.Exists(Declaraciones.CharPath + newName + ".chr"))
                                {
                                    FileSystem.FileCopy(Declaraciones.CharPath + UserName + ".chr", Declaraciones.CharPath + newName.ToUpper() + ".chr");
                                    ...
                                    int argEmptySpaces1 = 1024;
                                    cantPenas = Convert.ToByte(Migration.ParseVal(ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", EmptySpaces: ref argEmptySpaces1)));

                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "Cant", (cantPenas + 1).ToString());

                                    ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "PENAS", "P" + (cantPenas + 1).ToString(), withBlock.name.ToLower() + ": BAN POR Cambio de nick a " + newName.ToUpper() + " " + Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay));

                                    string argtexto = "Ha cambiado de nombre al usuario " + UserName + ". Ahora se llama " + newName;
                                    General.LogGM(ref withBlock.name, ref argtexto);
                                }
                                else
                                {
                                    WriteConsoleMsg(UserIndex, "El nick solicitado ya existe.", FontTypeNames.FONTTYPE_INFO);
                                }
                            }
                        }
                    }
                ...
                string newMail;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        else
                        {
                            if (!System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr"))
                            {
                                WriteConsoleMsg(UserIndex, "No existe el charfile " + UserName + ".chr", FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
                                ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "CONTACTO", "Email", newMail);
                                WriteConsoleMsg(UserIndex, "Email de " + UserName + " cambiado a: " + newMail, FontTypeNames.FONTTYPE_INFO);
                            }

                            string argtexto = "Le ha cambiado el mail a " + UserName;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                    }
        ...
        public static void HandleAlterPassword(short UserIndex)
        {
            ...
            try
            {
                ...
                string Password;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "Ha alterado la contraseña de " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        else if (!System.IO.File.Exists(Declaraciones.CharPath + UserName + ".chr") | !System.IO.File.Exists(Declaraciones.CharPath + copyFrom + ".chr"))
                        {
                            WriteConsoleMsg(UserIndex, "Alguno de los PJs no existe " + UserName + "@" + copyFrom, FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            int argEmptySpaces = 1024;
                            Password = ES.GetVar(Declaraciones.CharPath + copyFrom + ".chr", "INIT", "Password", EmptySpaces: ref argEmptySpaces);
                            ES.WriteVar(Declaraciones.CharPath + UserName + ".chr", "INIT", "Password", Password);

                            WriteConsoleMsg(UserIndex, "Password de " + UserName + " ha cambiado por la de " + copyFrom, FontTypeNames.FONTTYPE_INFO);
                        }
                    }
        ...
        public static void HandleCreateNPC(short UserIndex)
        {
            ...
            short NpcIndex;
            {
                ...
                if (NpcIndex != 0)
                {
                    string argtexto = "Sumoneó a " + Declaraciones.Npclist[NpcIndex].name + " en mapa " + withBlock.Pos.Map;
                    General.LogGM(ref withBlock.name, ref argtexto);
                }
            }
        }
        ...
        public static void HandleCreateNPCWithRespawn(short UserIndex)
        {
            ...
            short NpcIndex;
            {
                ...
                if (NpcIndex != 0)
                {
                    string argtexto = "Sumoneó con respawn " + Declaraciones.Npclist[NpcIndex].name + " en mapa " + withBlock.Pos.Map;
                    General.LogGM(ref withBlock.name, ref argtexto);
                }
            }
        }
        ...
        public static void HandleTurnOffServer(short UserIndex)
        {
...

            {
                ...
                string argtexto = "/APAGAR";
                General.LogGM(ref withBlock.name, ref argtexto);
                modSendData.SendData(modSendData.SendTarget.ToAll, 0, PrepareMessageConsoleMsg("¡¡¡" + withBlock.name + " VA A APAGAR EL SERVIDOR!!!", FontTypeNames.FONTTYPE_FIGHT));

                // Log
                General.AppendLog("logs/Main.log", Conversions.ToString(DateTime.Today) + " " + Conversions.ToString(DateAndTime.TimeOfDay) + " server apagado por " + withBlock.name + ". ");
            }
        }
        ...
        public static void HandleTurnCriminal(short UserIndex)
        {
            ...
            try
            {
                ...
                short tUser;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "/CONDEN " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleResetFactions(short UserIndex)
        {
            ...
            try
            {
                ...
                string Char_Renamed;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "/RAJAR " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        {
                            Char_Renamed = Declaraciones.CharPath + UserName + ".chr";

                            if (System.IO.File.Exists(Char_Renamed))
                            {
                                ES.WriteVar(Char_Renamed, "FACCIONES", "EjercitoReal", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "CiudMatados", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "CrimMatados", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "EjercitoCaos", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "FechaIngreso", "No ingresó a ninguna Facción");
                                ES.WriteVar(Char_Renamed, "FACCIONES", "rArCaos", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "rArReal", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "rExCaos", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "rExReal", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "recCaos", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "recReal", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "Reenlistadas", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "NivelIngreso", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "MatadosIngreso", 0.ToString());
                                ES.WriteVar(Char_Renamed, "FACCIONES", "NextRecompensa", 0.ToString());
                            }
                            else
                            {
        ...
        public static void HandleRemoveCharFromGuild(short UserIndex)
        {
            ...
            try
            {
                ...
                short GuildIndex;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "/RAJARCLAN " + UserName;
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        else
                        {
                            ...
                            modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GuildIndex, PrepareMessageConsoleMsg(UserName + " ha sido expulsado del clan por los administradores del servidor.", FontTypeNames.FONTTYPE_GUILD));
                        }
                    }
            ...
            try
            {
                ...
                string mail;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        {
                            int argEmptySpaces = 1024;
                            mail = ES.GetVar(Declaraciones.CharPath + UserName + ".chr", "CONTACTO", "email", EmptySpaces: ref argEmptySpaces);
        ...
        public static void HandleSystemMessage(short UserIndex)
        {
            ...
            try
            {
                ...
                string message;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "Mensaje de sistema:" + message;
                        General.LogGM(ref withBlock.name, ref argtexto);
        ...
        public static void HandleSetMOTD(short UserIndex)
        {
            ...
            try
            {
                ...
                int LoopC;
                {
                    ...
                    if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.RoleMaster) != 0 & (withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        string argtexto = "Ha fijado un nuevo MOTD";
                        General.LogGM(ref withBlock.name, ref argtexto);
                        ...
                        ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + "Dat/Motd.ini", "INIT", "NumLines", Admin.MaxLines.ToString());

                        var loopTo = (int)Admin.MaxLines;
                        for (LoopC = 1; LoopC <= loopTo; LoopC++)
                        {
                            ES.WriteVar(AppDomain.CurrentDomain.BaseDirectory + "Dat/Motd.ini", "Motd", "Line" + LoopC.ToString(), auxiliaryString[LoopC - 1]);
        ...
        public static void HandleChangeMOTD(short UserIndex)
        {
            ...
            int LoopC;
            {
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.RoleMaster | Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.SemiDios)) != 0)
                {
                    return;
                }
                ...
                if (auxiliaryString.Length >= 2)
                {
                    ...
                    {
                        auxiliaryString = auxiliaryString.Substring(0, Math.Min(auxiliaryString.Length - 2, auxiliaryString.Length));
                    }
                }
            ...
            try
            {
                ...
                string sTmp;
                {
                    ...
                    if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.Admin | Declaraciones.PlayerType.Dios)) != 0)
                    {
                        ...
                        if (sLlave.ToUpper() == "INIT" & sClave.ToUpper() == "DIOSES" | sLlave.ToUpper() == "DIOSES")
                        {
                            WriteConsoleMsg(UserIndex, "¡No puedes modificar esa información desde aquí!", FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            // Obtengo el valor según llave y clave
                            int argEmptySpaces = 1024;
                            sTmp = ES.GetVar(Declaraciones.IniPath + "Server.ini", sLlave, sClave, EmptySpaces: ref argEmptySpaces);
                            ...
                            if (Migration.migr_LenB(sTmp) != 0)
                            {
                                ...
                                string argtexto = "Modificó en server.ini (" + sLlave + " " + sClave + ") el valor " + sTmp + " por " + sValor;
                                General.LogGM(ref withBlock.name, ref argtexto);
                                WriteConsoleMsg(UserIndex, "Modificó " + sLlave + " " + sClave + " a " + sValor + ". Valor anterior " + sTmp, FontTypeNames.FONTTYPE_INFO);
                            }
                            else
                            {
        ...
        public static void WriteLoggedMessage(short UserIndex)
        {
            ...
            // Writes the "Logged" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.Logged), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteRemoveAllDialogs(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.RemoveDialogs), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteRemoveCharDialog(short UserIndex, short CharIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageRemoveCharDialog(CharIndex)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteNavigateToggle(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.NavigateToggle), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteDisconnect(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.Disconnect), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUserOfferConfirm(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.UserOfferConfirm), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCommerceEnd(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.CommerceEnd), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteBankEnd(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.BankEnd), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCommerceInit(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.CommerceInit), () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIString(Declaraciones.UserList[UserIndex].ComUsu.DestNick);
    }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUserCommerceEnd(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.UserCommerceEnd), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowBlacksmithForm(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.ShowBlacksmithForm), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowCarpenterForm(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.ShowCarpenterForm), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateSta(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateSta); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinSta); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateMana(short UserIndex)
        {
            ...
            // Writes the "UpdateMana" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateMana); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinMAN); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateHP(short UserIndex)
        {
            ...
            // Writes the "UpdateMana" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateHP); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinHp); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateGold(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateGold); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Stats.GLD); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateBankGold(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateBankGold); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Stats.Banco); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateExp(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateExp); withBlock.WriteLong(Convert.ToInt32(Declaraciones.UserList[UserIndex].Stats.Exp)); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateStrenghtAndDexterity(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateStrenghtAndDexterity); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateDexterity(short UserIndex)
        {
            ...
            // Writes the "UpdateStrenghtAndDexterity" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateDexterity); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateStrenght(short UserIndex)
        {
            ...
            // Writes the "UpdateStrenghtAndDexterity" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateStrenght); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza]); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteChangeMap(short UserIndex, short Map, short version)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ChangeMap); withBlock.WriteInteger(Map); withBlock.WriteInteger(version); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WritePosUpdate(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.PosUpdate); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.X)); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.Y)); } }, () => FlushBuffer(UserIndex));
        }

        public static void WriteChatOverHead(short UserIndex, string Chat, short CharIndex, int color)
        {
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageChatOverHead(Chat, CharIndex, color)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteConsoleMsg(short UserIndex, string Chat, FontTypeNames FontIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageConsoleMsg(Chat, FontIndex)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCommerceChat(short UserIndex, string Chat, FontTypeNames FontIndex)
        {
            ...
            // Writes the "ConsoleMsg" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareCommerceConsoleMsg(ref Chat, FontIndex)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteGuildChat(short UserIndex, string Chat)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageGuildChat(Chat)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowMessageBox(short UserIndex, string message)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ShowMessageBox); withBlock.WriteASCIIString(message); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUserIndexInServer(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UserIndexInServer); withBlock.WriteInteger(UserIndex); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUserCharIndexInServer(short UserIndex)
        {
            ...
            // Writes the "UserIndexInServer" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UserCharIndexInServer); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex); } }, () => FlushBuffer(UserIndex));
        }

        public static void WriteCharacterCreate(short UserIndex, short body, short Head, Declaraciones.eHeading heading, short CharIndex, byte X, byte Y, short weapon, short shield, short FX, short FXLoops, short helmet, string name, byte NickColor, byte Privileges)
        {
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageCharacterCreate(body, Head, heading, CharIndex, X, Y, weapon, shield, FX, FXLoops, helmet, name, NickColor, Privileges)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCharacterRemove(short UserIndex, short CharIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageCharacterRemove(CharIndex)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCharacterMove(short UserIndex, short CharIndex, byte X, byte Y)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageCharacterMove(CharIndex, X, Y)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteForceCharMove(short UserIndex, Declaraciones.eHeading Direccion)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageForceCharMove(Direccion)), () => FlushBuffer(UserIndex));
        }

        public static void WriteCharacterChange(short UserIndex, short body, short Head, Declaraciones.eHeading heading, short CharIndex, short weapon, short shield, short FX, short FXLoops, short helmet)
        {
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageCharacterChange(body, Head, heading, CharIndex, weapon, shield, FX, FXLoops, helmet)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteObjectCreate(short UserIndex, short GrhIndex, byte X, byte Y)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageObjectCreate(GrhIndex, X, Y)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteObjectDelete(short UserIndex, byte X, byte Y)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageObjectDelete(X, Y)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteBlockPosition(short UserIndex, byte X, byte Y, bool Blocked)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.BlockPosition); withBlock.WriteByte(X); withBlock.WriteByte(Y); withBlock.WriteBoolean(Blocked); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WritePlayMidi(short UserIndex, byte midi, short loops = -1)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessagePlayMidi(midi, loops)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WritePlayWave(short UserIndex, byte wave, byte X, byte Y)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessagePlayWave(wave, X, Y)), () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        public static void WriteAreaChanged(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.AreaChanged); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.X)); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.Y)); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WritePauseToggle(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessagePauseToggle()), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteRainToggle(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageRainToggle()), () => FlushBuffer(UserIndex));
        }

        public static void WriteCreateFX(short UserIndex, short CharIndex, short FX, short FXLoops)
        {
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageCreateFX(CharIndex, FX, FXLoops)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteUpdateUserStats(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateUserStats); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MaxHp); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinHp); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MaxMAN); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinMAN); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MaxSta); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.MinSta); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Stats.GLD); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.ELV); withBlock.WriteLong(Convert.ToInt32(Declaraciones.UserList[UserIndex].Stats.ELU)); withBlock.WriteLong(Convert.ToInt32(Declaraciones.UserList[UserIndex].Stats.Exp)); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteWorkRequestTarget(short UserIndex, Declaraciones.eSkill Skill)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.WorkRequestTarget); withBlock.WriteByte(Convert.ToByte((short)Skill)); } }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        var obData = default(Declaraciones.ObjData);
        {
            ...
            ObjIndex = Declaraciones.UserList[UserIndex].Invent.Object_Renamed[Slot].ObjIndex;
            if (ObjIndex > 0)
            {
                obData = Declaraciones.ObjData_Renamed[ObjIndex];
            }
            withBlock.WriteInteger(ObjIndex);
            withBlock.WriteASCIIString(obData.name);
            withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Invent.Object_Renamed[Slot].Amount);
            withBlock.WriteBoolean(Convert.ToBoolean(Declaraciones.UserList[UserIndex].Invent.Object_Renamed[Slot].Equipped));
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        var obData = default(Declaraciones.ObjData);
        {
            ...
            withBlock.WriteByte(Slot);
            ObjIndex = Declaraciones.UserList[UserIndex].BancoInvent.Object_Renamed[Slot].ObjIndex;
            withBlock.WriteInteger(ObjIndex);
            if (ObjIndex > 0)
            {
                obData = Declaraciones.ObjData_Renamed[ObjIndex];
            ...
            withBlock.WriteASCIIString(obData.name);
            withBlock.WriteInteger(Declaraciones.UserList[UserIndex].BancoInvent.Object_Renamed[Slot].Amount);
            withBlock.WriteInteger(obData.GrhIndex);
            withBlock.WriteByte(Convert.ToByte((int)obData.OBJType));
            withBlock.WriteInteger(obData.MaxHIT);
            withBlock.WriteInteger(obData.MinHIT);
        ...
        public static void WriteChangeSpellSlot(short UserIndex, short Slot)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ChangeSpellSlot); withBlock.WriteByte(Convert.ToByte(Slot)); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.UserHechizos[Slot]); if (Declaraciones.UserList[UserIndex].Stats.UserHechizos[Slot] > 0) { withBlock.WriteASCIIString(Declaraciones.Hechizos[Declaraciones.UserList[UserIndex].Stats.UserHechizos[Slot]].Nombre); } else { withBlock.WriteASCIIString("(None)"); } } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteAttributes(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.Atributes); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion]); } }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        validIndexes = new short[Declaraciones.ArmasHerrero.Length];
        {
            ...
            for (i = 1; i <= loopTo; i++)
            {
                if (Declaraciones.ObjData_Renamed[Declaraciones.ArmasHerrero[i]].SkHerreria <= Math.Round((double)(Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Herreria] / Trabajo.ModHerreriA(Declaraciones.UserList[UserIndex].clase)), 0))
                {
                    Count = Convert.ToInt16(Count + 1);
            ...
            for (i = 1; i <= loopTo1; i++)
            {
                Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.ArmasHerrero[validIndexes[i]]];
                withBlock.WriteASCIIString(Obj_Renamed.name);
                withBlock.WriteInteger(Obj_Renamed.GrhIndex);
                withBlock.WriteInteger(Obj_Renamed.LingH);
                withBlock.WriteInteger(Obj_Renamed.LingP);
                withBlock.WriteInteger(Obj_Renamed.LingO);
                withBlock.WriteInteger(Declaraciones.ArmasHerrero[validIndexes[i]]);
                withBlock.WriteInteger(Obj_Renamed.Upgrade);
            }
        }
    }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        validIndexes = new short[Declaraciones.ArmadurasHerrero.Length];
        {
            ...
            for (i = 1; i <= loopTo; i++)
            {
                if (Declaraciones.ObjData_Renamed[Declaraciones.ArmadurasHerrero[i]].SkHerreria <= Math.Round((double)(Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Herreria] / Trabajo.ModHerreriA(Declaraciones.UserList[UserIndex].clase)), 0))
                {
                    Count = Convert.ToInt16(Count + 1);
                    validIndexes[Count] = Convert.ToInt16(i);
                }
            ...
            for (i = 1; i <= loopTo1; i++)
            {
                Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.ArmadurasHerrero[validIndexes[i]]];
                withBlock.WriteASCIIString(Obj_Renamed.name);
                withBlock.WriteInteger(Obj_Renamed.GrhIndex);
                withBlock.WriteInteger(Obj_Renamed.LingH);
                withBlock.WriteInteger(Obj_Renamed.LingP);
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        validIndexes = new short[Declaraciones.ObjCarpintero.Length];
        {
            ...
            for (i = 1; i <= loopTo; i++)
            {
                if (Declaraciones.ObjData_Renamed[Declaraciones.ObjCarpintero[i]].SkCarpinteria <= (short)(Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Carpinteria] / Trabajo.ModCarpinteria(Declaraciones.UserList[UserIndex].clase)))
                {
                    Count = Convert.ToInt16(Count + 1);
                    validIndexes[Count] = Convert.ToInt16(i);
                }
            ...
            for (i = 1; i <= loopTo1; i++)
            {
                Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.ObjCarpintero[validIndexes[i]]];
                withBlock.WriteASCIIString(Obj_Renamed.name);
                withBlock.WriteInteger(Obj_Renamed.GrhIndex);
                withBlock.WriteInteger(Obj_Renamed.Madera);
                withBlock.WriteInteger(Obj_Renamed.MaderaElfica);
        ...
        public static void WriteRestOK(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.RestOK), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteErrorMsg(short UserIndex, string message)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageErrorMsg(message)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteBlind(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.Blind), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteDumb(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.Dumb), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowSignal(short UserIndex, short ObjIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ShowSignal); withBlock.WriteASCIIString(Declaraciones.ObjData_Renamed[ObjIndex].texto); withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].GrhSecundario); } }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        {
            ObjInfo = Declaraciones.ObjData_Renamed[Obj.ObjIndex];
        }
        {
            ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData;
        ...
        public static void WriteUpdateHungerAndThirst(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.UpdateHungerAndThirst); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Stats.MaxAGU)); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Stats.MinAGU)); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Stats.MaxHam)); withBlock.WriteByte(Convert.ToByte(Declaraciones.UserList[UserIndex].Stats.MinHam)); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteFame(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.Fame); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.AsesinoRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.BandidoRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.BurguesRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.LadronesRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.NobleRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.PlebeRep); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Reputacion.Promedio); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteMiniStats(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.MiniStats); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Faccion.CiudadanosMatados); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Faccion.CriminalesMatados); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Stats.UsuariosMatados); withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Stats.NPCsMuertos); withBlock.WriteByte(Convert.ToByte((int)Declaraciones.UserList[UserIndex].clase)); withBlock.WriteLong(Declaraciones.UserList[UserIndex].Counters.Pena); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteLevelUp(short UserIndex, short skillPoints)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.LevelUp); withBlock.WriteInteger(skillPoints); } }, () => FlushBuffer(UserIndex));
        }

        public static void WriteAddForumMsg(short UserIndex, Declaraciones.eForumType ForumType, string Title, string Author, string message)
        {
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.AddForumMsg); withBlock.WriteByte((byte)ForumType); withBlock.WriteASCIIString(Title); withBlock.WriteASCIIString(Author); withBlock.WriteASCIIString(message); } }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        var CanMakeSticky = default(byte);
        {
            ...
            else if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.RoyalCouncil) != 0)
            {
                CanMakeSticky = 1;
            }
        ...
        public static void WriteSetInvisible(short UserIndex, short CharIndex, bool invisible)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteASCIIStringFixed(PrepareMessageSetInvisible(CharIndex, invisible)), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteDiceRoll(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.DiceRoll); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma]); withBlock.WriteByte(Declaraciones.UserList[UserIndex].Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion]); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteMeditateToggle(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.MeditateToggle), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteBlindNoMore(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.BlindNoMore), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteDumbNoMore(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.DumbNoMore), () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        int i;
        {
            ...
            for (i = 1; i <= Declaraciones.NUMSKILLS; i++)
            {
                ...
                {
                    withBlock.outgoingData.WriteByte(Convert.ToByte(Conversion.Int(withBlock.Stats.ExpSkills[i] * 100 / (double)withBlock.Stats.EluSkills[i])));
                }
                else
                {
    ...
    {
        int i;
        var str_Renamed = default(string);
        {
            ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData;
            withBlock.WriteByte((byte)ServerPacketID.TrainerCreatureList);
            var loopTo = (int)Declaraciones.Npclist[NpcIndex].NroCriaturas;
            for (i = 1; i <= loopTo; i++)
                str_Renamed = str_Renamed + Declaraciones.Npclist[NpcIndex].Criaturas[i].NpcName + SEPARATOR;
            if (Migration.migr_LenB(str_Renamed) > 0)
                str_Renamed = str_Renamed.Substring(0, Math.Min(str_Renamed.Length - 1, str_Renamed.Length));
            withBlock.WriteASCIIString(str_Renamed);
        }
    }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        public static void WriteCharacterInfo(short UserIndex, string charName, Declaraciones.eRaza race, Declaraciones.eClass Class_Renamed, Declaraciones.eGenero gender, byte level, int gold, int bank, int reputation, string previousPetitions, string currentGuild, string previousGuilds, bool RoyalArmy, bool CaosLegion, int citicensKilled, int criminalsKilled)
        {
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.CharacterInfo); withBlock.WriteASCIIString(charName); withBlock.WriteByte((byte)race); withBlock.WriteByte(Convert.ToByte((int)Class_Renamed)); withBlock.WriteByte((byte)gender); withBlock.WriteByte(level); withBlock.WriteLong(gold); withBlock.WriteLong(bank); withBlock.WriteLong(reputation); withBlock.WriteASCIIString(previousPetitions); withBlock.WriteASCIIString(currentGuild); withBlock.WriteASCIIString(previousGuilds); withBlock.WriteBoolean(RoyalArmy); withBlock.WriteBoolean(CaosLegion); withBlock.WriteLong(citicensKilled); withBlock.WriteLong(criminalsKilled); } }, () => FlushBuffer(UserIndex));
        }

        public static void WriteGuildLeaderInfo(short UserIndex, string[] guildList, string[] MemberList, string guildNews, string[] joinRequests)
        {
            RetryOnceIfNotEnoughSpace(() =>
    {
        int i;
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        public static void WriteGuildDetails(short UserIndex, string GuildName, string founder, string foundationDate, string leader, string URL, short memberCount, bool electionsOpen, string alignment, short enemiesCount, short AlliesCount, string antifactionPoints, string[] codex, string guildDesc)
        {
            RetryOnceIfNotEnoughSpace(() =>
    {
        int i;
        ...
        public static void WriteShowGuildAlign(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.ShowGuildAlign), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowGuildFundationForm(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.ShowGuildFundationForm), () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        public static void WriteShowUserRequest(short UserIndex, string details)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ShowUserRequest); withBlock.WriteASCIIString(details); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteTradeOK(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.TradeOK), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteBankOK(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.BankOK), () => FlushBuffer(UserIndex));
        }

        public static void WriteChangeUserTradeSlot(short UserIndex, byte OfferSlot, short ObjIndex, int Amount)
        {
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ChangeUserTradeSlot); withBlock.WriteByte(OfferSlot); withBlock.WriteInteger(ObjIndex); withBlock.WriteLong(Amount); if (ObjIndex > 0) { withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].GrhIndex); withBlock.WriteByte(Convert.ToByte((int)Declaraciones.ObjData_Renamed[ObjIndex].OBJType)); withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].MaxHIT); withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].MinHIT); withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].MaxDef); withBlock.WriteInteger(Declaraciones.ObjData_Renamed[ObjIndex].MinDef); withBlock.WriteLong(Convert.ToInt32(modSistemaComercio.SalePrice(ObjIndex))); withBlock.WriteASCIIString(Declaraciones.ObjData_Renamed[ObjIndex].name); } else { withBlock.WriteInteger(0); withBlock.WriteByte(0); withBlock.WriteInteger(0); withBlock.WriteInteger(0); withBlock.WriteInteger(0); withBlock.WriteInteger(0); withBlock.WriteLong(0); withBlock.WriteASCIIString(""); } } }, () => FlushBuffer(UserIndex)); // Borra el item
        }
        ...
        public static void WriteSendNight(short UserIndex, bool night)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.SendNight); withBlock.WriteBoolean(night); } }, () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        var members = new short[(mdParty.PARTY_MAXMEMBERS + 1)];
        {
            ...
            if (PI > 0)
            {
                ...
                for (i = 1; i <= mdParty.PARTY_MAXMEMBERS; i++)
                {
                    if (members[i] > 0)
                    {
                        Tmp = Tmp + Declaraciones.UserList[members[i]].name + " (" + Conversion.Fix(Declaraciones.Parties[PI].MiExperiencia(members[i])) + ")" + SEPARATOR;
                    }
                }
            }
            if (Migration.migr_LenB(Tmp) != 0)
        ...
        public static void WriteShowMOTDEditionForm(short UserIndex, string currentMOTD)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.ShowMOTDEditionForm); withBlock.WriteASCIIString(currentMOTD); } }, () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteShowGMPanelForm(short UserIndex)
        {
            ...
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.ShowGMPanelForm), () => FlushBuffer(UserIndex));
        }
            ...
            RetryOnceIfNotEnoughSpace(() =>
    {
        ...
        public static void WritePong(short UserIndex)
        {
            ...
            // Writes the "Pong" message to the given user's outgoing data buffer
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.Pong), () => FlushBuffer(UserIndex));
        }
        ...
        public static string PrepareMessageSetInvisible(short CharIndex, bool invisible)
        {
            ...
            // ***************************************************
            {
                ref var withBlock = ref Protocol.auxiliarBuffer;
        ...
        public static string PrepareMessageCharacterCreate(short body, short Head, Declaraciones.eHeading heading, short CharIndex, byte X, byte Y, short weapon, short shield, short FX, short FXLoops, short helmet, string name, byte NickColor, byte Privileges)
        {
        ...
        public static string PrepareMessageCharacterChange(short body, short Head, Declaraciones.eHeading heading, short CharIndex, short weapon, short shield, short FX, short FXLoops, short helmet)
        {
        ...
        public static string PrepareMessageUpdateTagAndStatus(short UserIndex, byte NickColor, ref string Tag)
        {
            ...
            // ***************************************************
            {
                ...
                withBlock.WriteInteger(Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex);
                withBlock.WriteByte(NickColor);
        ...
        public static void WriteStopWorking(short UserIndex)
        {
            ...
            // 
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => Declaraciones.UserList[UserIndex].outgoingData.WriteByte((byte)ServerPacketID.StopWorking), () => FlushBuffer(UserIndex));
        }
        ...
        public static void WriteCancelOfferItem(short UserIndex, byte Slot)
        {
            ...
            // 
            // ***************************************************
            RetryOnceIfNotEnoughSpace(() => { { ref var withBlock = ref Declaraciones.UserList[UserIndex].outgoingData; withBlock.WriteByte((byte)ServerPacketID.CancelOfferItem); withBlock.WriteByte(Slot); } }, () => FlushBuffer(UserIndex));
        }
