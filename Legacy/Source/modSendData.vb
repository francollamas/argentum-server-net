                    ...
                    If UserList(LoopC).ConnID <> - 1 Then
                        If _
                            ...
                            (Declaraciones.PlayerType.Admin Or Declaraciones.PlayerType.Dios Or
                             Declaraciones.PlayerType.SemiDios Or Declaraciones.PlayerType.Consejero) Then
                ...
                For LoopC = 1 To LastUser
                    If (UserList(LoopC).ConnID <> - 1) Then
                        If _
                            ...
                            (UserList(LoopC).flags.Privilegios And Declaraciones.PlayerType.RoleMaster) <> 0 Then
                            Call EnviarDatosASlot(LoopC, sndData)
                        End If
                    End If
                Next LoopC
            ...
            Case SendTarget.ToHigherAdmins
                For LoopC = 1 To LastUser
                    If UserList(LoopC).ConnID <> - 1 Then
                        If _
                            UserList(LoopC).flags.Privilegios And
                            (Declaraciones.PlayerType.Admin Or Declaraciones.PlayerType.Dios) Then
                            Call EnviarDatosASlot(LoopC, sndData)
                        End If
                    End If
                Next LoopC
                ...
                If UserList(tempIndex).AreasInfo.AreaReciveY And AreaY Then
                    If _
                        ...
                        (UserList(tempIndex).GuildIndex = UserList(UserIndex).GuildIndex Or
                         ((UserList(tempIndex).flags.Privilegios And Declaraciones.PlayerType.Dios) And
                          (UserList(tempIndex).flags.Privilegios And Declaraciones.PlayerType.RoleMaster) = 0)) Then
                        Call EnviarDatosASlot(tempIndex, sdData)
                    End If
                End If
            End If
                    ...
                    If UserList(tempIndex).ConnIDValida Then
                        If _
                            ...
                            (Declaraciones.PlayerType.SemiDios Or Declaraciones.PlayerType.Dios Or
                             Declaraciones.PlayerType.Admin) Then Call EnviarDatosASlot(tempIndex, sdData)
                    End If
                End If
            End If
        Next LoopC
                ...
                If .AreasInfo.AreaReciveX And AreaX Then 'Esta en el area?
                    If .AreasInfo.AreaReciveY And AreaY Then
                        If .ConnIDValida Then
                            ...
                            If _
                                (.flags.Privilegios And Not Declaraciones.PlayerType.User And
                                 Not Declaraciones.PlayerType.Consejero And Not Declaraciones.PlayerType.RoleMaster) =
