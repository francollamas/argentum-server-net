...
internal static class PraetoriansCoopNPC
{
    ...
    public static short esPretoriano(short NpcIndex)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.EsPretoriano? " + Declaraciones.Npclist[NpcIndex].name;
    ...
    public static void CrearClanPretoriano(short X)
    {
        ...
        try
        {
            ...
            if (TeleFrag > 0)
            {
                ...
                Extra.ClosestLegalPos(ref wp, ref wp2, ref argPuedeAgua, ref argPuedeTierra);
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.CrearClanPretoriano ";
            General.LogError(ref argdesc);
            // do nothing
        }
    }
    ...
    public static void PRCAZA_AI(short npcind)
    {
        try
        {
            ...
            for (X = Convert.ToInt16(NPCPosX + azar * 8); -azar >= 0 ? X <= loopTo : X >= loopTo; X += (short)-azar)
            {
                ...
                for (Y = Convert.ToInt16(NPCPosY + azar2 * 7);
                     -azar2 >= 0 ? Y <= loopTo1 : Y >= loopTo1;
                     Y += (short)-azar2)
                {
                    ...
                    if ((PJEnInd > 0) & (Declaraciones.Npclist[npcind].CanAttack == 1))
                        if (((Declaraciones.UserList[PJEnInd].flags.invisible == 0) |
                             (Declaraciones.UserList[PJEnInd].flags.Oculto == 0)) &
                            !(Declaraciones.UserList[PJEnInd].flags.Muerto == 1) &
                            !(Declaraciones.UserList[PJEnInd].flags.AdminInvisible == 1) &
                            Declaraciones.UserList[PJEnInd].flags.AdminPerseguible)
                        {
                            // ToDo: Borrar los GMs
                            ...
                            else if (BestTarget > 0)
                            {
                                ...
                                if (Math.Sqrt(Math.Pow(X - NPCPosX, 2d) + Math.Pow(Y - NPCPosY, 2d)) <
                                    Math.Sqrt(Math.Pow(NPCPosX - Declaraciones.UserList[BestTarget].Pos.X, 2d) +
                ...
                for (X = Convert.ToInt16(Xc - 16); X <= loopTo2; X++)
                {
                    ...
                    for (Y = Convert.ToInt16(Yc - 14); Y <= loopTo3; Y++)
                        if (!((X <= NPCPosX + 8) & (X >= NPCPosX - 8) & (Y >= NPCPosY - 7) & (Y <= NPCPosY + 7)))
                        {
                            ...
                            PJEnInd = Declaraciones.MapData[NPCPosM, X, Y]
                                .UserIndex; // 'por si implementamos algo contra NPCs
                            if (PJEnInd > 0)
                                if (!((Declaraciones.UserList[PJEnInd].flags.invisible == 1) |
                                      (Declaraciones.UserList[PJEnInd].flags.Oculto == 1) |
                                      (Declaraciones.UserList[PJEnInd].flags.Muerto == 1)))

                                {
                                    // 'si no esta muerto.., ya encontro algo para ir a buscar
                                    GreedyWalkTo(npcind, MAPA_PRETORIANO, Declaraciones.UserList[PJEnInd].Pos.X,
                                        Declaraciones.UserList[PJEnInd].Pos.Y);
                                    return;
                                }
                        }
                }
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.PRCAZA_AI ";
            General.LogError(ref argdesc);
            // do nothing
        }
    }
    ...
    public static void PRMAGO_AI(short npcind)
    {
        try
        {
            ...
            else
            {
                ...
                for (X = Convert.ToInt16(NPCPosX + azar * 8); -azar >= 0 ? X <= loopTo : X >= loopTo; X += (short)-azar)
                {
                    ...
                    for (Y = Convert.ToInt16(NPCPosY + azar2 * 7);
                         ...
                         Y += (short)-azar2)
                    {
                        NPCAlInd = Declaraciones.MapData[NPCPosM, X, Y]
                            .NpcIndex; // 'por si implementamos algo contra NPCs
                        PJEnInd = Declaraciones.MapData[NPCPosM, X, Y].UserIndex;

                        if ((PJEnInd > 0) & (Declaraciones.Npclist[npcind].CanAttack == 1))
                            if (!(Declaraciones.UserList[PJEnInd].flags.Muerto == 1) &
                                !(Declaraciones.UserList[PJEnInd].flags.AdminInvisible == 1) &
                                Declaraciones.UserList[PJEnInd].flags.AdminPerseguible)
                            {
                                if ((Declaraciones.UserList[PJEnInd].flags.invisible == 1) |
                                ...
                                else if (Declaraciones.UserList[PJEnInd].flags.Paralizado == 1)
                                {
                                    if (BestTarget > 0)
                                    {
                                        if (!((Declaraciones.UserList[BestTarget].flags.invisible == 1) |
                                              (Declaraciones.UserList[PJEnInd].flags.Oculto == 1)))
            ...
            if (!(quehacer == 3)) // 'si no ta matandose
            {
                ...
                if (PJEnInd > 0)
                    if (!(Declaraciones.UserList[PJEnInd].flags.Muerto == 1) &
                        !((Declaraciones.UserList[PJEnInd].flags.invisible == 1) |
                          (Declaraciones.UserList[PJEnInd].flags.Oculto == 1)))
                    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.PRMAGO_AI? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void PRREY_AI(short npcind)
    {
        try
        {
            ...
            for (X = Convert.ToInt16(NPCPosX - 8); X <= loopTo; X++)
            {
                ...
                for (Y = Convert.ToInt16(NPCPosY - 7); Y <= loopTo1; Y++)
                {
                    ...
                    PJEnInd = Declaraciones.MapData[NPCPosM, X, Y].UserIndex;
                    if (Declaraciones.Npclist[npcind].CanAttack ==
                        1) // 'saltea el analisis si no puede atacar para evitar cuentas
                    {
                        if (NPCAlInd > 0)
                        {
                            ...
                            else if (Declaraciones.Npclist[NPCAlInd].Stats.MaxHp >
                                     Declaraciones.Npclist[NPCAlInd].Stats.MinHp)
                            {
                        ...
                        if ((PJEnInd > 0) & !hayPretorianos)
...

                            {
                                ...
                                dist = Convert.ToInt16(
                                    Math.Pow(Math.Sqrt(Declaraciones.UserList[PJEnInd].Pos.X - NPCPosX), 2d) +
                                    Math.Pow(Declaraciones.UserList[PJEnInd].Pos.Y - NPCPosY, 2d));
            ...
            if (!hayPretorianos)
            {
                ...
                if (BestTarget > 0)
                {
                    ...
                    {
                        GreedyWalkTo(npcind, Declaraciones.UserList[BestTarget].Pos.Map,
                    ...
                    // 'teclavolaespada
                    for (headingloop = Declaraciones.eHeading.NORTH;
                         headingloop <= Declaraciones.eHeading.WEST;
                         headingloop++)
                    {
                ...
                {
                    VolverAlCentro(npcind);
                    if ((Declaraciones.Npclist[npcind].Stats.MinHp < Declaraciones.Npclist[npcind].Stats.MaxHp) &
                        (Declaraciones.Npclist[npcind].CanAttack == 1))
                    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.PRREY_AI? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void PRGUER_AI(short npcind)
    {
            ...
            for (X = Convert.ToInt16(NPCPosX - 8); X <= loopTo; X++)
            {
                ...
                for (Y = Convert.ToInt16(NPCPosY - 7); Y <= loopTo1; Y++)
                {
                    ...
                    if (PJEnInd > 0)
                        if (!((Declaraciones.UserList[PJEnInd].flags.invisible == 1) |
                              (Declaraciones.UserList[PJEnInd].flags.Oculto == 1) |
                              (Declaraciones.UserList[PJEnInd].flags.Muerto == 1)) & EsAlcanzable(npcind, PJEnInd) &
                            Declaraciones.UserList[PJEnInd].flags.AdminPerseguible)

                        {
                            ...
                            {
                                distBestTarget = Convert.ToInt16(Math.Sqrt(
                                    Math.Pow(Declaraciones.UserList[PJEnInd].Pos.X - NPCPosX, 2d) +
                                    Math.Pow(Declaraciones.UserList[PJEnInd].Pos.Y - NPCPosY, 2d)));
                                BestTarget = PJEnInd;
                            }
                        }
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.PRGUER_AI? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void PRCLER_AI(short npcind)
    {
                     ...
                     Y += (short)-azar2)
                {
                        ...
                        1) // 'saltea el analisis si no puede atacar para evitar cuentas
                    {
                        if (NPCAlInd > 0) // 'allie?
                        {
                            if (esPretoriano(NPCAlInd) == 0)
                            {
                                if ((Declaraciones.Npclist[NPCAlInd].MaestroUser > 0) &
                            ...
                            else if (Declaraciones.Npclist[NPCAlInd].flags.Paralizado ==
                                     1) // es un PJ aliado en combate
                            {
                            ...
                            {
                                if (Declaraciones.Npclist[NPCAlInd].Stats.MaxHp >
                                    Declaraciones.Npclist[NPCAlInd].Stats.MinHp)
                                {
                    ...
                    for (X = Convert.ToInt16(centroX - 16); X <= loopTo2; X++)
                    {
                        ...
                        for (Y = Convert.ToInt16(centroY - 15); Y <= loopTo3; Y++)
                            if (!((X < NPCPosX + 8) & (X > NPCPosX + 8) & (Y < NPCPosY + 7) & (Y > NPCPosY - 7)))
                            {
                                ...
                                if (NPCAlInd > 0)
                                    if ((esPretoriano(NPCAlInd) > 0) &
                                        (Declaraciones.Npclist[NPCAlInd].flags.Paralizado == 1))
                                    {
                                        // 'si esta paralizado lo va a rescatar, sino
                                        // 'ya va a volver por su cuenta
                                        GreedyWalkTo(npcind, NPCPosM, Declaraciones.Npclist[NPCAlInd].Pos.X,
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.PRCLER_AI? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static bool EsMagoOClerigo(short PJEnInd)
    {
        ...
        try
        {
            EsMagoOClerigoRet = (Declaraciones.UserList[PJEnInd].clase == Declaraciones.eClass.Mage) |
                                (Declaraciones.UserList[PJEnInd].clase == Declaraciones.eClass.Cleric) |
                                (Declaraciones.UserList[PJEnInd].clase == Declaraciones.eClass.Druid) |
                                (Declaraciones.UserList[PJEnInd].clase == Declaraciones.eClass.Bard);
        }
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.EsMagoOClerigo? ";
            General.LogError(ref argdesc);
        }
    ...
    public static void NPCRemueveVenenoNPC(short npcind, short NPCAlInd, short indice)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCRemueveVenenoNPC? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCCuraLevesNPC(short npcind, short NPCAlInd, short indice)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCCuraLevesNPC? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCRemueveParalisisNPC(short npcind, short NPCAlInd, short indice)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCRemueveParalisisNPC? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCparalizaNPC(short paralizador, short Paralizado, short indice)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCParalizaNPC? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCcuraNPC(short curador, short curado, short indice)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCcuraNPC? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCLanzaCegueraPJ(short npcind, short PJEnInd, short indice)
    {
        try
        {
            ...
            {
                Protocol.WriteConsoleMsg(PJEnInd, "El rey pretoriano te ha vuelto ciego ",
                    Protocol.FontTypeNames.FONTTYPE_FIGHT);
                Protocol.WriteConsoleMsg(PJEnInd,
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCLanzaCegueraPJ? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCLanzaEstupidezPJ(short npcind, short PJEnInd, short indice)
    {
        try
        {
            ...
            // bardea si es el rey
            if (Declaraciones.Npclist[npcind].name == "Rey Pretoriano")
                Protocol.WriteConsoleMsg(PJEnInd, "El rey pretoriano te ha vuelto estúpido.",
                    Protocol.FontTypeNames.FONTTYPE_FIGHT);
        }
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCLanzaEstupidezPJ? ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NPCRemueveInvisibilidad(short npcind, short PJEnInd, short indice)
    {
        try
        {
            ...
            else
            {
                ...
                Protocol.WriteConsoleMsg(PJEnInd, "Comienzas a hacerte visible.",
                    Protocol.FontTypeNames.FONTTYPE_VENENO);
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCRemueveInvisibilidad ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void NpcLanzaSpellSobreUser2(short NpcIndex, short UserIndex, short Spell)
    {
        ...
        try
        {
            ...
            if (Declaraciones.Hechizos[Spell].SubeHP == 1)
            {
                ...
                Declaraciones.UserList[UserIndex].Stats.MinHp =
                    (short)(Declaraciones.UserList[UserIndex].Stats.MinHp + daño);
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.NPCLanzaSpellSobreUser2 ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void MagoDestruyeWand(short npcind, byte bs, short indice)
    {
                ...
                case 5:
                {
                    ...
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, npcind,
                        Protocol.PrepareMessagePlayWave(Convert.ToByte(SONIDO_Dragon_VIVO),
                            ...
                            Convert.ToByte(Declaraciones.Npclist[npcind].Pos.Y)));
                    break;
                }
                case 4:
                {
                        ...
                        if (PJInd > 0)
                        {
                            ...
                            if ((Declaraciones.UserList[PJInd].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                                Declaraciones.UserList[PJInd].Stats.MinHp =
                                    (short)(Declaraciones.UserList[PJInd].Stats.MinHp - danioI);

                            Protocol.WriteConsoleMsg(PJInd,
                                Declaraciones.Npclist[npcind].name + " te ha quitado " + danioI +
                                " puntos de vida al romper su vara.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        ...
                        else if (MascotaInd > 0)
                        {
                            if (Declaraciones.Npclist[MascotaInd].MaestroUser > 0)
                            {
                                ...
                                modSendData.SendData(modSendData.SendTarget.ToNPCArea, MascotaInd,
                                    Protocol.PrepareMessagePlayWave(
                                        Convert.ToByte(Declaraciones.Hechizos[indireccion].WAV),
                                        Convert.ToByte(Declaraciones.Npclist[MascotaInd].Pos.X),
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.MagoDestruyeWand ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void GreedyWalkTo(short npcorig, short Map, short X, short Y)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.GreedyWalkTo";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void MoverAba(short npcorig)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.MoverAba ";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void MoverArr(short npcorig)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.MoverArr";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void MoverIzq(short npcorig)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.MoverIzq";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void MoverDer(short npcorig)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.MoverDer";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void VolverAlCentro(short npcind)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.VolverAlCentro";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static bool EstoyLejos(short npcind)
    {
        ...
        try
        {
            ...
            // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto npcind. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            retvalue = retvalue & (Declaraciones.Npclist[npcind].Pos.Y > 19) &
                       (Declaraciones.Npclist[npcind].Pos.Y < 31);
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.EstoyLejos";
            General.LogError(ref argdesc);
        }
    ...
    public static bool EsAlcanzable(short npcind, short PJEnInd)
    {
        ...
        try
        {
            ...
            if ((Declaraciones.Npclist[npcind].Pos.Map == MAPA_PRETORIANO) &
                (Declaraciones.UserList[PJEnInd].Pos.Map == MAPA_PRETORIANO))
            {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.EsAlcanzable";
            General.LogError(ref argdesc);
        }
    ...
    public static bool CasperBlock(short npc)
    {
        ...
        try
        {
            ...
            retvalue = !(Extra.LegalPos(NPCPosM, Convert.ToInt16(NPCPosX + 1), NPCPosY) |
                         ...
                         Extra.LegalPos(NPCPosM, NPCPosX, Convert.ToInt16(NPCPosY + 1)) |
                         Extra.LegalPos(NPCPosM, NPCPosX, Convert.ToInt16(NPCPosY - 1)));
            ...
            if (retvalue)
            {
                ...
                if (PJ > 0) retvalue = Declaraciones.UserList[PJ].flags.Muerto == 1;

                PJ = Declaraciones.MapData[NPCPosM, NPCPosX - 1, NPCPosY].UserIndex;
                if (PJ > 0) retvalue = retvalue | (Declaraciones.UserList[PJ].flags.Muerto == 1);
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.CasperBlock";
            General.LogError(ref argdesc);
        }
    ...
    public static void LiberarCasperBlock(short npcind)
    {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en NPCAI.LiberarCasperBlock";
            General.LogError(ref argdesc);
        }
    }
    ...
    public static void CambiarAlcoba(short npcind)
    {
            ...
            switch (Declaraciones.Npclist[npcind].Invent.ArmourEqpSlot)
            {
                case 2:
                {
                    ...
                    if ((Declaraciones.Npclist[npcind].Pos.X == 48) & (Declaraciones.Npclist[npcind].Pos.Y == 70))
                        Declaraciones.Npclist[npcind].Invent.ArmourEqpSlot =
                            Convert.ToByte(Declaraciones.Npclist[npcind].Invent.ArmourEqpSlot + 1);
                    break;
                }
                case 6:
                {
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "Error en CambiarAlcoba " + ex.Message;
            General.LogError(ref argdesc);
        }
    }
}