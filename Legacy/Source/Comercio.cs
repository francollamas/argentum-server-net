...
internal static class modSistemaComercio
{
    ...
    public static void Comercio(eModoComercio Modo, short UserIndex, short NpcIndex, short Slot, short Cantidad)
    {
        ...
        if (Modo == eModoComercio.Compra)
        {
            ...
            if (!(Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[Slot].Amount > 0)) return;
            ...
            Precio = Convert.ToInt32(
                Declaraciones.ObjData_Renamed[Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[Slot].ObjIndex]
            ...
            if (Declaraciones.ObjData_Renamed[Objeto.ObjIndex].Log == 1)
                General.LogDesarrollo(Declaraciones.UserList[UserIndex].name + " compró del NPC " + Objeto.Amount +
                                      " " + Declaraciones.ObjData_Renamed[Objeto.ObjIndex].name);
        ...
        else if (Modo == eModoComercio.Venta)
        {
            ...
            if (((Declaraciones.Npclist[NpcIndex].TipoItems !=
                  (int)Declaraciones.ObjData_Renamed[Objeto.ObjIndex].OBJType) &
            ...
            if (Declaraciones.ObjData_Renamed[Objeto.ObjIndex].Real == 1)
            {
            ...
            if (NpcSlot <= Declaraciones.MAX_INVENTORY_SLOTS) // Slot valido
            {
                ...
                Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[NpcSlot].Amount =
                    (short)(Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[NpcSlot].Amount + Objeto.Amount);
                if (Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[NpcSlot].Amount >
    ...
    private static short SlotEnNPCInv(short NpcIndex, short Objeto, short Cantidad)
    {
        ...
        // *************************************************
        SlotEnNPCInvRet = 1;
        while (!((Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[SlotEnNPCInvRet].ObjIndex == Objeto) &
                 ((short)(Declaraciones.Npclist[NpcIndex].Invent.Object_Renamed[SlotEnNPCInvRet].Amount + Cantidad) <=
                  Declaraciones.MAX_INVENTORY_OBJS)))
