...
namespace Legacy
{
    static class SistemaCombate
    {
        ...
        private static int PoderEvasionEscudo(short UserIndex)
        {
            ...
            PoderEvasionEscudoRet = Convert.ToInt32(Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Defensa] * Declaraciones.ModClase_Renamed[(int)Declaraciones.UserList[UserIndex].clase].Escudo / 2d);
        ...
        private static int PoderEvasion(short UserIndex)
        {
            ...
            int lTemp;
            {
                ...
                lTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Tacticas] + withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Tacticas] / 33d * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].Evasion);
        ...
        private static int PoderAtaqueArma(short UserIndex)
        {
...

            {
                ...
                {
                    PoderAtaqueTemp = Convert.ToInt32(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueArmas);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] < 61)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueArmas);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] < 91)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] + 2 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueArmas);
                }
                else
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Armas] + 3 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueArmas);
                }
        ...
        private static int PoderAtaqueProyectil(short UserIndex)
        {
...

            {
                ...
                {
                    PoderAtaqueTemp = Convert.ToInt32(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueProyectiles);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] < 61)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueProyectiles);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] < 91)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] + 2 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueProyectiles);
                }
                else
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Proyectiles] + 3 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueProyectiles);
                }
        ...
        private static int PoderAtaqueWrestling(short UserIndex)
        {
...

            {
                ...
                {
                    PoderAtaqueTemp = Convert.ToInt32(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueWrestling);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] < 61)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueWrestling);
                }
                else if (withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] < 91)
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] + 2 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueWrestling);
                }
                else
                {
                    PoderAtaqueTemp = Convert.ToInt32((withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] + 3 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad]) * Declaraciones.ModClase_Renamed[(int)withBlock.clase].AtaqueWrestling);
                }
        ...
        public static bool UserImpactoNpc(short UserIndex, short NpcIndex)
        {
            ...
            // Chances are rounded
            ProbExito = MaximoInt(10, MinimoInt(90, Convert.ToInt32(50d + (PoderAtaque - Declaraciones.Npclist[NpcIndex].PoderEvasion) * 0.4d)));
        ...
        public static bool NpcImpacto(short NpcIndex, short UserIndex)
        {
            ...
            if (Declaraciones.UserList[UserIndex].Invent.EscudoEqpObjIndex > 0)
            {
                if (!NpcImpactoRet)
                {
                    ...
                    {
                        // Chances are rounded
                        ProbRechazo = MaximoInt(10, MinimoInt(90, Convert.ToInt32(100 * SkillDefensa / (double)(SkillDefensa + SkillTacticas))));
                        Rechazo = Matematicas.RandomNumber(1, 100) <= ProbRechazo;

                        if (Rechazo)
                        {
                            // Se rechazo el ataque con el escudo
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_ESCUDO, Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.X), Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.Y)));
        ...
        public static int CalcularDaño(short UserIndex, short NpcIndex = 0)
        {
...

            {
                ...
                if (withBlock.Invent.WeaponEqpObjIndex > 0)
                {
                    ...
                    if (NpcIndex > 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (withBlock.Invent.WeaponEqpObjIndex == Declaraciones.EspadaMataDragonesIndex) // Usa la mata Dragones?
                            {
                                if (Declaraciones.Npclist[NpcIndex].NPCtype == Declaraciones.eNPCType.DRAGON) // Ataca Dragon?
                                {
                                    DañoArma = Matematicas.RandomNumber(Arma.MinHIT, Arma.MaxHIT);
                                    DañoMaxArma = Arma.MaxHIT;
                ...
                if (matoDragon)
                {
                    CalcularDañoRet = Declaraciones.Npclist[NpcIndex].Stats.MinHp + Declaraciones.Npclist[NpcIndex].Stats.def;
                }
                else
                {
                    CalcularDañoRet = Convert.ToInt32((3 * DañoArma + DañoMaxArma / 5d * MaximoInt(0, Convert.ToInt32(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] - 15)) + DañoUsuario) * (double)ModifClase);
                }
            }
        ...
        public static void UserDañoNpc(short UserIndex, short NpcIndex)
        {
            ...
            if (Declaraciones.UserList[UserIndex].flags.Navegando == 1)
            {
                ...
                {
                    DañoBase = DañoBase + Matematicas.RandomNumber(Declaraciones.ObjData_Renamed[Declaraciones.UserList[UserIndex].Invent.BarcoObjIndex].MinHIT, Declaraciones.ObjData_Renamed[Declaraciones.UserList[UserIndex].Invent.BarcoObjIndex].MaxHIT);
                }
            }
            ...
            short j;
            {
                ...
                if (withBlock.Stats.MinHp <= 0)
                {
                    ...
                    for (j = 1; j <= Declaraciones.MAXMASCOTAS; j++)
                    {
                        ...
                        {
                            if (Declaraciones.Npclist[Declaraciones.UserList[UserIndex].MascotasIndex[j]].TargetNPC == NpcIndex)
                            {
                                Declaraciones.Npclist[Declaraciones.UserList[UserIndex].MascotasIndex[j]].TargetNPC = 0;
                                Declaraciones.Npclist[Declaraciones.UserList[UserIndex].MascotasIndex[j]].Movement = AI.TipoAI.SigueAmo;
                            }
                        }
                    }
        ...
        public static void NpcDaño(short NpcIndex, short UserIndex)
        {
            ...
            daño = Convert.ToInt16(Matematicas.RandomNumber(Declaraciones.Npclist[NpcIndex].Stats.MinHIT, Declaraciones.Npclist[NpcIndex].Stats.MaxHIT));
            ...
            Declaraciones.ObjData Obj2;
            {
                ...
                Lugar = Convert.ToInt16(Matematicas.RandomNumber(Convert.ToInt32((int)Declaraciones.PartesCuerpo.bCabeza), Convert.ToInt32((int)Declaraciones.PartesCuerpo.bTorso)));
                    ...
                    default:
                        {
                            ...
                            if (withBlock.Invent.ArmourEqpObjIndex > 0)
                            {
                                ...
                                if (withBlock.Invent.EscudoEqpObjIndex != 0)
                                {
                                    ...
                                    absorbido = Convert.ToInt16(Matematicas.RandomNumber(Obj_Renamed.MinDef + Obj2.MinDef, Obj_Renamed.MaxDef + Obj2.MaxDef));
                                }
                                else
                                {
                                    absorbido = Convert.ToInt16(Matematicas.RandomNumber(Obj_Renamed.MinDef, Obj_Renamed.MaxDef));
                ...
                {
                    if (daño > Conversion.Fix(withBlock.Stats.MinHp / 100d * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] * withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Meditar] / 100d * 12d / (Matematicas.RandomNumber(0, 5) + 7)))
                    {
                ...
                if (withBlock.Stats.MinHp <= 0)
                {
                    ...
                    if (ES.criminal(UserIndex) & Declaraciones.Npclist[NpcIndex].NPCtype == Declaraciones.eNPCType.GuardiaReal)
                    {
                        RestarCriminalidad(UserIndex);
                        if (!ES.criminal(UserIndex) & withBlock.Faccion.FuerzasCaos == 1)
                        {
                            bool argExpulsado = true;
                            ModFacciones.ExpulsarFaccionCaos(UserIndex, Expulsado: ref argExpulsado);
                        }
                    }
...

            {
                ...
                for (j = 1; j <= Declaraciones.MAXMASCOTAS; j++)
                {
                    if (withBlock.MascotasIndex[j] > 0)
                    {
                        ...
                        {
                            if (CheckElementales | Declaraciones.Npclist[withBlock.MascotasIndex[j]].Numero != AI.ELEMENTALFUEGO & Declaraciones.Npclist[withBlock.MascotasIndex[j]].Numero != AI.ELEMENTALTIERRA)
                            {
        ...
        public static bool NpcAtacaUser(short NpcIndex, short UserIndex)
        {
...

            {
                ...
                if ((int)(~withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0 & !withBlock.flags.AdminPerseguible)
                    return NpcAtacaUserRet;
            }

            {
                ...
                if (withBlock1.CanAttack == 1)
                {
                    ...
                    if (Declaraciones.UserList[UserIndex].flags.AtacadoPorNpc == 0 & Declaraciones.UserList[UserIndex].flags.AtacadoPorUser == 0)
                    {
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, NpcIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(withBlock1.flags.Snd1), Convert.ToByte(withBlock1.Pos.X), Convert.ToByte(withBlock1.Pos.Y)));
                }
            }
            ...
            {
                {
                    ...
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO, Convert.ToByte(withBlock2.Pos.X), Convert.ToByte(withBlock2.Pos.Y)));

                    if (withBlock2.flags.Meditando == false)
                    {
                        if (withBlock2.flags.Navegando == 0)
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(withBlock2.Char_Renamed.CharIndex, Declaraciones.FXSANGRE, 0));
                        }
                    }
        ...
        public static void NpcDañoNpc(short Atacante, short Victima)
        {
...

            {
                ...
                if (Declaraciones.Npclist[Victima].Stats.MinHp < 1)
                {
                    ...
                    if (Migration.migr_LenB(withBlock.flags.AttackedBy) != 0)
                    {
        ...
        public static void NpcAtacaNpc(short Atacante, short Victima, bool cambiarMOvimiento = true)
        {
...

            {
                ...
                if (Declaraciones.Npclist[Victima].Numero == PraetoriansCoopNPC.PRKING_NPC)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(withBlock.MaestroUser, "Debes matar al resto del ejército antes de atacar al rey!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, Atacante, Protocol.PrepareMessagePlayWave(Convert.ToByte(withBlock.flags.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                }
                ...
                if (NpcImpactoNpc(Atacante, Victima))
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, Victima, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Npclist[Victima].flags.Snd2), Convert.ToByte(Declaraciones.Npclist[Victima].Pos.X), Convert.ToByte(Declaraciones.Npclist[Victima].Pos.Y)));
                    }
                    else
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, Victima, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO2, Convert.ToByte(Declaraciones.Npclist[Victima].Pos.X), Convert.ToByte(Declaraciones.Npclist[Victima].Pos.Y)));
                    }

                    if (withBlock.MaestroUser > 0)
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, Atacante, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                    }
                    else
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, Victima, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO, Convert.ToByte(Declaraciones.Npclist[Victima].Pos.X), Convert.ToByte(Declaraciones.Npclist[Victima].Pos.Y)));
                    }
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, Atacante, Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                }
                else
                {
                    modSendData.SendData(modSendData.SendTarget.ToNPCArea, Victima, Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(Declaraciones.Npclist[Victima].Pos.X), Convert.ToByte(Declaraciones.Npclist[Victima].Pos.Y)));
                }
            }
        }
        ...
        public static bool UsuarioAtacaNpc(short UserIndex, short NpcIndex)
        {
            ...
            try
            {
                ...
                if (UserImpactoNpc(UserIndex, NpcIndex))
                {
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToNPCArea, NpcIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.Npclist[NpcIndex].flags.Snd2), Convert.ToByte(Declaraciones.Npclist[NpcIndex].Pos.X), Convert.ToByte(Declaraciones.Npclist[NpcIndex].Pos.Y)));
                    }
                    else
                    {
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO2, Convert.ToByte(Declaraciones.Npclist[NpcIndex].Pos.X), Convert.ToByte(Declaraciones.Npclist[NpcIndex].Pos.Y)));
                    }
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.X), Convert.ToByte(Declaraciones.UserList[UserIndex].Pos.Y)));
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en UsuarioAtacaNpc. Error " + ex.GetType().Name + " : " + ex.Message;
        ...
        public static void UsuarioAtaca(short UserIndex)
        {
...

            {
                ...
                else
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Estás muy cansado para luchar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Estás muy cansada para luchar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    return;
                }
                ...
                // Exit if not legal
                if (AttackPos.X < Declaraciones.XMinMapSize | AttackPos.X > Declaraciones.XMaxMapSize | AttackPos.Y <= Declaraciones.YMinMapSize | AttackPos.Y > Declaraciones.YMaxMapSize)
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                    return;
                }
                ...
                if (Index > 0)
                {
                    ...
                    {
                        if (Declaraciones.Npclist[Index].MaestroUser > 0 & Declaraciones.MapInfo_Renamed[Declaraciones.Npclist[Index].Pos.Map].Pk == false)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes atacar mascotas en zona segura.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                            return;
                        }
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes atacar a este NPC.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    }
        ...
        public static bool UsuarioImpacto(short AtacanteIndex, short VictimaIndex)
        {
            ...
            try
            {
                ...
                if (Declaraciones.UserList[VictimaIndex].flags.Meditando == true)
                {
                ...
                if (Declaraciones.UserList[VictimaIndex].Invent.EscudoEqpObjIndex > 0)
                {
                    ...
                    if (!UsuarioImpactoRet)
                    {
                        ...
                        {
                            // Se rechazo el ataque con el escudo
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, VictimaIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_ESCUDO, Convert.ToByte(Declaraciones.UserList[VictimaIndex].Pos.X), Convert.ToByte(Declaraciones.UserList[VictimaIndex].Pos.Y)));

                            Protocol.WriteMultiMessage(AtacanteIndex, (short)Declaraciones.eMessages.BlockedWithShieldother);
                ...
                if (!UsuarioImpactoRet)
                {
                    UsUaRiOs.SubirSkill(AtacanteIndex, (short)Skill, false);
                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en UsuarioImpacto. Error " + ex.GetType().Name + " : " + ex.Message + " AtacanteIndex: " + AtacanteIndex + " Nick: " + AtacanteNick + " VictimaIndex: " + VictimaIndex + " Nick: " + VictimaNick;
                General.LogError(ref argdesc);
            }
        ...
        public static bool UsuarioAtacaUsuario(short AtacanteIndex, short VictimaIndex)
        {
            ...
            try
            {
...

                {
                    ...
                    if (Matematicas.Distancia(ref withBlock.Pos, ref Declaraciones.UserList[VictimaIndex].Pos) > MAXDISTANCIAARCO)
                    {
                        Protocol.WriteConsoleMsg(AtacanteIndex, "Estás muy lejos para disparar.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        return UsuarioAtacaUsuarioRet;
                    }
                    ...
                    {
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, AtacanteIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_IMPACTO, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));

                        if (Declaraciones.UserList[VictimaIndex].flags.Navegando == 0)
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, VictimaIndex, Protocol.PrepareMessageCreateFX(Declaraciones.UserList[VictimaIndex].Char_Renamed.CharIndex, Declaraciones.FXSANGRE, 0));
                        }
                    ...
                    else
                    {
                        ...
                        if (withBlock.flags.AdminInvisible == 1)
                        {
                            string argdatos = Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                            TCP.EnviarDatosASlot(AtacanteIndex, ref argdatos);
                        }
                        else
                        {
                            modSendData.SendData(modSendData.SendTarget.ToPCArea, AtacanteIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_SWING, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                        }

                        Protocol.WriteMultiMessage(AtacanteIndex, (short)Declaraciones.eMessages.UserSwing);
                        Protocol.WriteMultiMessage(VictimaIndex, (short)Declaraciones.eMessages.UserAttackedSwing, AtacanteIndex);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en UsuarioAtacaUsuario. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        ...
        public static void UserDañoUser(short AtacanteIndex, short VictimaIndex)
        {
            ...
            try
            {
                ...
                Declaraciones.ObjData Obj2;
                {
                    ...
                    if (Declaraciones.UserList[VictimaIndex].flags.Navegando == 1 & Declaraciones.UserList[VictimaIndex].Invent.BarcoObjIndex > 0)
                    {
                        // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Obj_Renamed. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.UserList[VictimaIndex].Invent.BarcoObjIndex];
                        defbarco = Convert.ToInt16(Matematicas.RandomNumber(Obj_Renamed.MinDef, Obj_Renamed.MaxDef));
                    }
                    ...
                    Lugar = Convert.ToByte(Matematicas.RandomNumber(Convert.ToInt32((int)Declaraciones.PartesCuerpo.bCabeza), Convert.ToInt32((int)Declaraciones.PartesCuerpo.bTorso)));
                        ...
                        case 1:
                            {
                                ...
                                {
                                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Obj_Renamed. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                    Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.UserList[VictimaIndex].Invent.CascoEqpObjIndex];
                        ...
                        default:
                            {
                                ...
                                {
                                    // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Obj_Renamed. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                    Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.UserList[VictimaIndex].Invent.ArmourEqpObjIndex];
                                    if (Declaraciones.UserList[VictimaIndex].Invent.EscudoEqpObjIndex != 0)
                                    {
                                        // UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Obj2. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                                        Obj2 = Declaraciones.ObjData_Renamed[Declaraciones.UserList[VictimaIndex].Invent.EscudoEqpObjIndex];
                                        absorbido = Matematicas.RandomNumber(Obj_Renamed.MinDef + Obj2.MinDef, Obj_Renamed.MaxDef + Obj2.MaxDef);
                                    }
                                    else
                                    {
                                        absorbido = Matematicas.RandomNumber(Obj_Renamed.MinDef, Obj_Renamed.MaxDef);
                    ...
                    Protocol.WriteMultiMessage(AtacanteIndex, (short)Declaraciones.eMessages.UserHittedUser, Declaraciones.UserList[VictimaIndex].Char_Renamed.CharIndex, Lugar, daño);
                    Protocol.WriteMultiMessage(VictimaIndex, (short)Declaraciones.eMessages.UserHittedByUser, withBlock.Char_Renamed.CharIndex, Lugar, daño);

                    Declaraciones.UserList[VictimaIndex].Stats.MinHp = Convert.ToInt16(Declaraciones.UserList[VictimaIndex].Stats.MinHp - daño);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en UserDañoUser. Error " + ex.GetType().Name + " : " + ex.Message + " AtacanteIndex: " + AtacanteIndex + " Nick: " + AtacanteNick + " VictimaIndex: " + VictimaIndex + " Nick: " + VictimaNick;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void UsuarioAtacadoPorUsuario(short AttackerIndex, short VictimIndex)
        {
...

            {
                ...
                if (withBlock.flags.Meditando)
                {
                    ...
                    withBlock.Char_Renamed.FX = 0;
                    withBlock.Char_Renamed.loops = 0;
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, VictimIndex, Protocol.PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, 0, 0));
                }
            }
            ...
            if (ES.criminal(AttackerIndex))
            {
                ...
                {
                    bool argExpulsado = true;
                    ModFacciones.ExpulsarFaccionReal(AttackerIndex, Expulsado: ref argExpulsado);
                }
        ...
        public static void AllMascotasAtacanUser(short victim, short Maestro)
        {
            ...
            for (iCount = 1; iCount <= Declaraciones.MAXMASCOTAS; iCount++)
            {
                if (Declaraciones.UserList[Maestro].MascotasIndex[iCount] > 0)
                {
                    ...
                    Declaraciones.Npclist[Declaraciones.UserList[Maestro].MascotasIndex[iCount]].Movement = AI.TipoAI.NPCDEFENSA;
        ...
        public static bool PuedeAtacar(short AttackerIndex, short VictimIndex)
        {
            ...
            try
            {
                ...
                {
                    Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar a un espíritu.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    PuedeAtacarRet = false;
                    return PuedeAtacarRet;
                }
                ...
                {
                    Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar usuarios mientras estas en consulta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return PuedeAtacarRet;
                }
                ...
                {
                    Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar usuarios mientras estan en consulta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return PuedeAtacarRet;
                }
                    ...
                    case Declaraciones.eTrigger6.TRIGGER6_AUSENTE:
                        {
                            ...
                            if ((Declaraciones.UserList[VictimIndex].flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                            {
                                if (Declaraciones.UserList[VictimIndex].flags.AdminInvisible == 0)
                                    Protocol.WriteConsoleMsg(AttackerIndex, "El ser es demasiado poderoso.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                                PuedeAtacarRet = false;
                                return PuedeAtacarRet;
                            }
                ...
                if (!ES.criminal(VictimIndex))
                {
                    ...
                    if (!ES.criminal(AttackerIndex))
                    {
                        ...
                        if (Extra.esArmada(AttackerIndex))
                        {
                            ...
                            {
                                // No puede
                                Protocol.WriteConsoleMsg(AttackerIndex, "Los soldados del ejército real tienen prohibido atacar ciudadanos.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                                return PuedeAtacarRet;
                            }
                        }
                ...
                else if (Extra.esCaos(VictimIndex))
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros de la legión oscura tienen prohibido atacarse entre sí.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                        return PuedeAtacarRet;
                    }
                }
                ...
                if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                {
                    if (!ES.criminal(VictimIndex))
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar ciudadanos, para hacerlo debes desactivar el seguro.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                        PuedeAtacarRet = false;
                        return PuedeAtacarRet;
                    }
                }
                ...
                if (Declaraciones.MapInfo_Renamed[Declaraciones.UserList[VictimIndex].Pos.Map].Pk == false)
                {
                    if (Extra.esArmada(AttackerIndex))
                    {
                        if (Declaraciones.UserList[AttackerIndex].Faccion.RecompensasReal > 11)
                        {
                            if (Declaraciones.UserList[VictimIndex].Pos.Map == 58 | Declaraciones.UserList[VictimIndex].Pos.Map == 59 | Declaraciones.UserList[VictimIndex].Pos.Map == 60)
                            {
                                Protocol.WriteConsoleMsg(VictimIndex, "¡Huye de la ciudad! Estás siendo atacado y no podrás defenderte.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                    ...
                    if (Extra.esCaos(AttackerIndex))
                    {
                        ...
                        {
                            if (Declaraciones.UserList[VictimIndex].Pos.Map == 151 | Declaraciones.UserList[VictimIndex].Pos.Map == 156)
                            {
                                Protocol.WriteConsoleMsg(VictimIndex, "¡Huye de la ciudad! Estás siendo atacado y no podrás defenderte.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                    ...
                    Protocol.WriteConsoleMsg(AttackerIndex, "Esta es una zona segura, aquí no puedes atacar a otros usuarios.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                    PuedeAtacarRet = false;
                    return PuedeAtacarRet;
                }

                // Estas atacando desde un trigger seguro? o tu victima esta en uno asi?
                if (Declaraciones.MapData[Declaraciones.UserList[VictimIndex].Pos.Map, Declaraciones.UserList[VictimIndex].Pos.X, Declaraciones.UserList[VictimIndex].Pos.Y].trigger == Declaraciones.eTrigger.ZONASEGURA | Declaraciones.MapData[Declaraciones.UserList[AttackerIndex].Pos.Map, Declaraciones.UserList[AttackerIndex].Pos.X, Declaraciones.UserList[AttackerIndex].Pos.Y].trigger == Declaraciones.eTrigger.ZONASEGURA)
                {
                    Protocol.WriteConsoleMsg(AttackerIndex, "No puedes pelear aquí.", Protocol.FontTypeNames.FONTTYPE_WARNING);
                    PuedeAtacarRet = false;
                    return PuedeAtacarRet;
                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en PuedeAtacar. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        ...
        public static bool PuedeAtacarNPC(short AttackerIndex, short NpcIndex, bool Paraliza = false, bool IsPet = false)
        {
            ...
            if (Declaraciones.UserList[AttackerIndex].flags.EnConsulta)
            {
                Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar npcs mientras estas en consulta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return PuedeAtacarNPCRet;
            }
            ...
            {
                Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar esta criatura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return PuedeAtacarNPCRet;
            }

            // Es valida la distancia a la cual estamos atacando?
            if (Matematicas.Distancia(ref Declaraciones.UserList[AttackerIndex].Pos, ref Declaraciones.Npclist[NpcIndex].Pos) >= MAXDISTANCIAARCO)
            {
                Protocol.WriteConsoleMsg(AttackerIndex, "Estás muy lejos para disparar.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                return PuedeAtacarNPCRet;
            }
            ...
            if (Declaraciones.Npclist[NpcIndex].Hostile == 0)
            {
                ...
                if (Declaraciones.Npclist[NpcIndex].NPCtype == Declaraciones.eNPCType.Guardiascaos)
                {
                    ...
                    if (Extra.esCaos(AttackerIndex))
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar Guardias del Caos siendo de la legión oscura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                }
                // Es guardia Real?
                else if (Declaraciones.Npclist[NpcIndex].NPCtype == Declaraciones.eNPCType.GuardiaReal)
                {
                    ...
                    if (Extra.esArmada(AttackerIndex))
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "No puedes atacar Guardias Reales siendo del ejército real.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                    // Tienes el seguro puesto?
                    if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "Para poder atacar Guardias Reales debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "¡Atacaste un Guardia Real! Eres un criminal.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        UsUaRiOs.VolverCriminal(AttackerIndex);
                ...
                else if (Declaraciones.Npclist[NpcIndex].MaestroUser == 0)
                {
                    ...
                    if (!ES.criminal(AttackerIndex))
                    {
                        ...
                        if (Extra.esArmada(AttackerIndex))
                        {
                            Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros del ejército real no pueden atacar npcs no hostiles.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeAtacarNPCRet;
                        }
                        ...
                        if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                        {
                            Protocol.WriteConsoleMsg(AttackerIndex, "Para atacar a este NPC debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeAtacarNPCRet;
                        }
                        else
                        {
                            // No tiene seguro puesto. Puede atacar pero es penalizado.
                            Protocol.WriteConsoleMsg(AttackerIndex, "Atacaste un NPC no-hostil. Continúa haciéndolo y te podrás convertir en criminal.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            // NicoNZ: Cambio para que al atacar npcs no hostiles no bajen puntos de nobleza
                            int argNoblePts = 0;
                            int argBandidoPts = 1000;
            ...
            if (Declaraciones.Npclist[NpcIndex].MaestroUser > 0)
            {
                if (!ES.criminal(Declaraciones.Npclist[NpcIndex].MaestroUser))
                {
                    ...
                    if (Extra.esArmada(AttackerIndex))
                    {
                        ...
                        Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros del ejército real no pueden atacar mascotas de ciudadanos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                    ...
                    if (!ES.criminal(AttackerIndex))
                    {
                        ...
                        if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                        {
                            ...
                            Protocol.WriteConsoleMsg(AttackerIndex, "Para atacar mascotas de ciudadanos debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return PuedeAtacarNPCRet;
                        }
                        else
                        {
                            // El atacante no tiene el seguro puesto. Recibe penalización.
                            Protocol.WriteConsoleMsg(AttackerIndex, "Has atacado la Mascota de un ciudadano. Eres un criminal.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            UsUaRiOs.VolverCriminal(AttackerIndex);
                            PuedeAtacarNPCRet = true;
                            return PuedeAtacarNPCRet;
                        }
                    ...
                    else if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                    {
                        Protocol.WriteConsoleMsg(AttackerIndex, "Para atacar mascotas de ciudadanos debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                ...
                else if (Extra.esCaos(Declaraciones.Npclist[NpcIndex].MaestroUser))
                {
                    ...
                    if (Extra.esCaos(AttackerIndex))
                    {
                        ...
                        Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros de la legión oscura no pueden atacar mascotas de otros legionarios. ", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return PuedeAtacarNPCRet;
                    }
                }
            }
                    ...
                    if (!SameClan(OwnerUserIndex, AttackerIndex) & !SameParty(OwnerUserIndex, AttackerIndex))
                    {
                        ...
                        else if (Paraliza)
                        {
                            ...
                            if (withBlock.flags.Inmovilizado == 1 | withBlock.flags.Paralizado == 1)
                            {
                                ...
                                if (!ES.criminal(AttackerIndex) & !ES.criminal(OwnerUserIndex))
                                {
                                    ...
                                    if (Extra.esArmada(AttackerIndex))
                                    {
                                        ...
                                        if (Extra.esArmada(OwnerUserIndex))
                                        {
                                            ...
                                            Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros del Ejército Real no pueden paralizar criaturas ya paralizadas pertenecientes a otros miembros del Ejército Real", Protocol.FontTypeNames.FONTTYPE_INFO);
                                            return PuedeAtacarNPCRet;
                                        }
                                        ...
                                        {
                                            Protocol.WriteConsoleMsg(AttackerIndex, "Para paralizar criaturas ya paralizadas pertenecientes a ciudadanos debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                            return PuedeAtacarNPCRet;
                                        }
                                        else
                                        {
                                            ...
                                            {
                                                Protocol.WriteConsoleMsg(AttackerIndex, "Has paralizado la criatura de un ciudadano, ahora eres atacable por él.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                                PuedeAtacarNPCRet = true;
                                            }
                                ...
                                // Si ambos son caos
                                else if (Extra.esCaos(AttackerIndex) & Extra.esCaos(OwnerUserIndex))
                                {
                                    // El atacante es Caos y esta intentando paralizar un npc de un Caos
                                    Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros de la legión oscura no pueden paralizar criaturas ya paralizadas por otros legionarios.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return PuedeAtacarNPCRet;
                                }
                            }
                        ...
                        else if (!ES.criminal(OwnerUserIndex))
                        {
                            ...
                            if (Extra.esArmada(AttackerIndex))
                            {
                                ...
                                if (Extra.esArmada(OwnerUserIndex))
                                {
                                    ...
                                    Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros del Ejército Real no pueden atacar criaturas pertenecientes a otros miembros del Ejército Real", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return PuedeAtacarNPCRet;
                                }
                                ...
                                {
                                    Protocol.WriteConsoleMsg(AttackerIndex, "Para atacar criaturas ya pertenecientes a ciudadanos debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return PuedeAtacarNPCRet;
                                }
                                else
                                {
                                    ...
                                    if (UsUaRiOs.ToogleToAtackable(AttackerIndex, OwnerUserIndex))
                                    {
                                        Protocol.WriteConsoleMsg(AttackerIndex, "Has atacado a la criatura de un ciudadano, ahora eres atacable por él.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                        PuedeAtacarNPCRet = true;
                                    }
                            ...
                            else if (!ES.criminal(AttackerIndex))
                            {

                                if (Declaraciones.UserList[AttackerIndex].flags.Seguro)
                                {
                                    // El atacante tiene el seguro puesto. No puede atacar.
                                    Protocol.WriteConsoleMsg(AttackerIndex, "Para atacar criaturas pertenecientes a ciudadanos debes quitarte el seguro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return PuedeAtacarNPCRet;
                                }
                        ...
                        else if (Extra.esCaos(OwnerUserIndex))
                        {
                            ...
                            if (Extra.esCaos(AttackerIndex))
                            {
                                ...
                                Protocol.WriteConsoleMsg(AttackerIndex, "Los miembros de la Legión Oscura no pueden atacar criaturas de otros legionarios. ", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return PuedeAtacarNPCRet;
                            }
                        }
                    }
            ...
            if (PraetoriansCoopNPC.esPretoriano(NpcIndex) == 4)
            {
                if (PraetoriansCoopNPC.pretorianosVivos > 0)
                {
                    Protocol.WriteConsoleMsg(AttackerIndex, "Debes matar al resto del ejército antes de atacar al rey.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    return PuedeAtacarNPCRet;
                }
            }
        ...
        private static bool SameClan(short UserIndex, short OtherUserIndex)
        {
            ...
            // Last Modification: 16/11/2009
            // ***************************************************
            SameClanRet = Declaraciones.UserList[UserIndex].GuildIndex == Declaraciones.UserList[OtherUserIndex].GuildIndex & Declaraciones.UserList[UserIndex].GuildIndex != 0;
            return SameClanRet;
        }
        ...
        private static bool SameParty(short UserIndex, short OtherUserIndex)
        {
            ...
            // Last Modification: 16/11/2009
            // ***************************************************
            SamePartyRet = Declaraciones.UserList[UserIndex].PartyIndex == Declaraciones.UserList[OtherUserIndex].PartyIndex & Declaraciones.UserList[UserIndex].PartyIndex != 0;
            return SamePartyRet;
        }
        ...
        public static void CalcularDarExp(short UserIndex, short NpcIndex, int ElDaño)
        {
            ...
            ExpaDar = Convert.ToInt32(ElDaño * (Declaraciones.Npclist[NpcIndex].GiveEXP / (double)Declaraciones.Npclist[NpcIndex].Stats.MaxHp));
            if (ExpaDar <= 0)
                return;
            ...
            if (ExpaDar > 0)
            {
                ...
                {
                    mdParty.ObtenerExito(UserIndex, ExpaDar, ref Declaraciones.Npclist[NpcIndex].Pos.Map, ref Declaraciones.Npclist[NpcIndex].Pos.X, ref Declaraciones.Npclist[NpcIndex].Pos.Y);
                }
                else
                {
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "Has ganado " + ExpaDar + " puntos de experiencia.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
        ...
        public static Declaraciones.eTrigger6 TriggerZonaPelea(short Origen, short Destino)
        {
            ...
            catch (Exception ex)
            {
                ...
                TriggerZonaPeleaRet = Declaraciones.eTrigger6.TRIGGER6_AUSENTE;
                string argdesc = "Error en TriggerZonaPelea - " + ex.Message;
                General.LogError(ref argdesc);
            }
                ...
                if (ObjInd > 0)
                {
                    if (Declaraciones.ObjData_Renamed[ObjInd].Envenena == 1)
                    {
                        ...
                        if (Matematicas.RandomNumber(1, 100) < 60)
                        {
                            ...
                            Protocol.WriteConsoleMsg(VictimaIndex, "¡¡" + Declaraciones.UserList[AtacanteIndex].name + " te ha envenenado!!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                            Protocol.WriteConsoleMsg(AtacanteIndex, "¡¡Has envenenado a " + Declaraciones.UserList[VictimaIndex].name + "!!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                    }
                }
            }
