...
namespace Legacy
{
    static class InvUsuario
    {
        public static bool TieneObjetosRobables(short UserIndex)
        {
            ...
            try
            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    ...
                    if (ObjIndex > 0)
                    {
                        if (Declaraciones.ObjData_Renamed[ObjIndex].OBJType != Declaraciones.eOBJType.otLlaves & Declaraciones.ObjData_Renamed[ObjIndex].OBJType != Declaraciones.eOBJType.otBarcos)
                        {
        ...
        public static bool ClasePuedeUsarItem(short UserIndex, short ObjIndex, [Optional, DefaultParameterValue("")] ref string sMotivo)
        {
            ...
            try
            {
                ...
                if ((Declaraciones.UserList[UserIndex].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                {
                    if (Declaraciones.ObjData_Renamed[ObjIndex].ClaseProhibida[1] != 0)
                    {
                        ...
                        {
                            if (Declaraciones.ObjData_Renamed[ObjIndex].ClaseProhibida[i] == Declaraciones.UserList[UserIndex].clase)
                            {
            ...
            {
                Console.WriteLine("Error in TieneObjetosRobables: " + ex.Message);
                string argdesc = "Error en ClasePuedeUsarItem";
        ...
        public static void TirarOro(int Cantidad, short UserIndex)
        {
                ...
                var Extra_Renamed = default(int);
                {
                    ...
                    if (Cantidad > 0 & Cantidad <= withBlock.Stats.GLD)
                    {
                            ...
                            for (j = Convert.ToInt16(withBlock.Pos.X - 10); j <= loopTo; j++)
                            {
                                ...
                                for (k = Convert.ToInt16(withBlock.Pos.Y - 10); k <= loopTo1; k++)
                                {
                                    if (Extra.InMapBounds(M, j, k))
                                    {
                                        ...
                                        {
                                            Cercanos = Cercanos + Declaraciones.UserList[Declaraciones.MapData[M, j, k].UserIndex].name + ",";
                                        }
                                    }
                                }
                            }
                        ...
                        while (Cantidad > 0)
                        {
                            ...
                            if (Cantidad > Declaraciones.MAX_INVENTORY_OBJS & withBlock.Stats.GLD > Declaraciones.MAX_INVENTORY_OBJS)
                            {
                            ...
                            {
                                string argtexto = "Tiró cantidad:" + MiObj.Amount + " Objeto:" + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name;
                            ...
                            if (loops > 100)
                            {
                                string argdesc = "Error en tiraroro";
                                General.LogError(ref argdesc);
                                return;
                            }
                        ...
                        if (Extra_Renamed > 0)
                        {
                            withBlock.Stats.GLD = withBlock.Stats.GLD - Extra_Renamed;
                        }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc1 = "Error en TirarOro. Error " + ex.GetType().Name + " : " + ex.Message;
        ...
        public static void QuitarUserInvItem(short UserIndex, byte Slot, short Cantidad)
        {
            ...
            try
            {
...

                {
                    ...
                    if (withBlock.Amount <= Cantidad & withBlock.Equipped == 1)
                    {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en QuitarUserInvItem. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void UpdateUserInv(bool UpdateAll, short UserIndex, byte Slot)
        {
...

                {
                    ...
                    else
                    {
                        ...
                        for (LoopC = 1; LoopC <= loopTo; LoopC++)
                        {
                            ...
                            {
                                UsUaRiOs.ChangeUserInv(UserIndex, Convert.ToByte(LoopC), ref withBlock.Invent.Object_Renamed[LoopC]);
                            }
                            else
                            {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en UpdateUserInv. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DropObj(short UserIndex, byte Slot, short num, short Map, short X, short Y)
        {
...

            {
                ...
                if (num > 0)
                {
                    ...
                    if (ItemNewbie(Obj_Renamed.ObjIndex) && (withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes tirar objetos newbie.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }

                    // Check objeto en el suelo
                    if (Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.ObjIndex == 0 | Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.ObjIndex == Obj_Renamed.ObjIndex)
                    {
                        if ((short)(num + Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.Amount) > Declaraciones.MAX_INVENTORY_OBJS)
                        {
                            num = (short)(Declaraciones.MAX_INVENTORY_OBJS - Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.Amount);
                        }
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡¡ATENCIÓN!! ¡ACABAS DE TIRAR TU BARCA!", Protocol.FontTypeNames.FONTTYPE_TALK);
                        }

                        if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                        {
                            string argtexto = "Tiró cantidad:" + num + " Objeto:" + Declaraciones.ObjData_Renamed[Obj_Renamed.ObjIndex].name;
                            General.LogGM(ref withBlock.name, ref argtexto);
                        }
                        ...
                        {
                            General.LogDesarrollo(withBlock.name + " tiró al piso " + Obj_Renamed.Amount + " " + Declaraciones.ObjData_Renamed[Obj_Renamed.ObjIndex].name + " Mapa: " + Map + " X: " + X + " Y: " + Y);
                        }
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No hay espacio en el piso.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                }
            }
        }
        ...
        public static void EraseObj(short num, short Map, short X, short Y)
        {
...

            {
                ...
                if (withBlock.ObjInfo.Amount <= 0)
                {
                    ...
                    modSendData.SendToAreaByPos(Map, X, Y, Protocol.PrepareMessageObjectDelete(Convert.ToByte(X), Convert.ToByte(Y)));
                }
            }
        }
            ...
            if (Obj.ObjIndex > 0 & Obj.ObjIndex <= Declaraciones.ObjData_Renamed.Length - 1)
            {

                {
                    ...
                    else
                    {
                        ...
                        modSendData.SendToAreaByPos(Map, X, Y, Protocol.PrepareMessageObjectCreate(Declaraciones.ObjData_Renamed[Obj.ObjIndex].GrhIndex, Convert.ToByte(X), Convert.ToByte(Y)));
                    }
                }
            }
        }
        ...
        public static bool MeterItemEnInventario(short UserIndex, ref Declaraciones.Obj MiObj)
        {
            ...
            try
            {
...

                {
                    ...
                    Slot = 1;
                    while (!(withBlock.Invent.Object_Renamed[Slot].ObjIndex == MiObj.ObjIndex & (short)(withBlock.Invent.Object_Renamed[Slot].Amount + MiObj.Amount) <= Declaraciones.MAX_INVENTORY_OBJS))
                    ...
                    if (Slot > withBlock.CurrentInventorySlots)
                    {
                        ...
                        while (withBlock.Invent.Object_Renamed[Slot].ObjIndex != 0)
                        {
                            ...
                            if (Slot > withBlock.CurrentInventorySlots)
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "No puedes cargar más objetos.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    ...
                    if (Slot > Declaraciones.MAX_NORMAL_INVENTORY_SLOTS & Slot < Declaraciones.MAX_INVENTORY_SLOTS)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes contener objetos especiales en tu " + Declaraciones.ObjData_Renamed[withBlock.Invent.MochilaEqpObjIndex].name + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                            MeterItemEnInventarioRet = false;
                            return MeterItemEnInventarioRet;
                        }
                    }
                    // Mete el objeto
                    if ((short)(withBlock.Invent.Object_Renamed[Slot].Amount + MiObj.Amount) <= Declaraciones.MAX_INVENTORY_OBJS)
                    {
                        // Menor que MAX_INV_OBJS
                        withBlock.Invent.Object_Renamed[Slot].ObjIndex = MiObj.ObjIndex;
                        withBlock.Invent.Object_Renamed[Slot].Amount = (short)(withBlock.Invent.Object_Renamed[Slot].Amount + MiObj.Amount);
                    }
                    else
                    {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en MeterItemEnInventario. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        ...
        public static void GetObj(short UserIndex)
        {
            ...
            byte Slot;
            {
                ...
                if (Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].ObjInfo.ObjIndex > 0)
                {
                    ...
                    if (Declaraciones.ObjData_Renamed[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].ObjInfo.ObjIndex].Agarrable != 1)
                    {
                        ...
                        Obj_Renamed = Declaraciones.ObjData_Renamed[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].ObjInfo.ObjIndex];
                        ...
                        if (Obj_Renamed.OBJType == Declaraciones.eOBJType.otGuita)
                        {
                            withBlock.Stats.GLD = withBlock.Stats.GLD + MiObj.Amount;
                            // Quitamos el objeto
                            EraseObj(Declaraciones.MapData[withBlock.Pos.Map, X, Y].ObjInfo.Amount, withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y);
                        ...
                        else if (MeterItemEnInventario(UserIndex, ref MiObj))
                        {
                            ...
                            if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) == 0)
                            {
                                string argtexto = "Agarro:" + MiObj.Amount + " Objeto:" + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name;
                                General.LogGM(ref withBlock.name, ref argtexto);
                            }
                            ...
                            {
                                ObjPos = " Mapa: " + withBlock.Pos.Map + " X: " + withBlock.Pos.X + " Y: " + withBlock.Pos.Y;
                                General.LogDesarrollo(withBlock.name + " juntó del piso " + MiObj.Amount + " " + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name + ObjPos);
                            }
        ...
        public static void Desequipar(short UserIndex, byte Slot)
        {
            ...
            try
            {
...

                {
                    ref var withBlock = ref Declaraciones.UserList[UserIndex];
                    {
                        ...
                        if (Slot < 0 | Slot > withBlock1.Object_Renamed.Length - 1)
                        {
                            return;
                        }
                        else if (withBlock1.Object_Renamed[Slot].ObjIndex == 0)
                        {
                            return;
                        }
                                ...
                                {
                                    {
                                        ...
                                        UsUaRiOs.ChangeUserChar(UserIndex, withBlock3.body, withBlock3.Head, (byte)withBlock3.heading, withBlock3.WeaponAnim, withBlock3.ShieldAnim, withBlock3.CascoAnim);
                                    }
                                }
                        ...
                        case Declaraciones.eOBJType.otArmadura:
                            {
                                ...
                                General.DarCuerpoDesnudo(UserIndex, withBlock.flags.Mimetizado == 1);
                                {
                                    ...
                                    UsUaRiOs.ChangeUserChar(UserIndex, withBlock7.body, withBlock7.Head, (byte)withBlock7.heading, withBlock7.WeaponAnim, withBlock7.ShieldAnim, withBlock7.CascoAnim);
                                }
                                ...
                                {
                                    {
                                        ...
                                        UsUaRiOs.ChangeUserChar(UserIndex, withBlock9.body, withBlock9.Head, (byte)withBlock9.heading, withBlock9.WeaponAnim, withBlock9.ShieldAnim, withBlock9.CascoAnim);
                                    }
                                }
                                ...
                                {
                                    {
                                        ...
                                        UsUaRiOs.ChangeUserChar(UserIndex, withBlock11.body, withBlock11.Head, (byte)withBlock11.heading, withBlock11.WeaponAnim, withBlock11.ShieldAnim, withBlock11.CascoAnim);
                                    }
                                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en Desquipar. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }

        public static bool SexoPuedeUsarItem(short UserIndex, short ObjIndex, [Optional, DefaultParameterValue("")] ref string sMotivo)
        {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "SexoPuedeUsarItem";
                General.LogError(ref argdesc);
            }
        ...
        public static bool FaccionPuedeUsarItem(short UserIndex, short ObjIndex, [Optional, DefaultParameterValue("")] ref string sMotivo)
        {
        ...
        public static void EquiparInvItem(short UserIndex, byte Slot)
        {
            ...
            try
            {
...

                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Sólo los newbies pueden usar este objeto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    ...
                    switch (Obj_Renamed.OBJType)
                    {
                        case Declaraciones.eOBJType.otWeapon:
                            {
                                if (ClasePuedeUsarItem(UserIndex, ObjIndex, ref sMotivo) & FaccionPuedeUsarItem(UserIndex, ObjIndex, ref sMotivo))
                                {
                                    ...
                                    if (!(withBlock.flags.AdminInvisible == 1))
                                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_SACARARMA), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                        ...
                        case Declaraciones.eOBJType.otArmadura:
                            {
                                ...
                                if (ClasePuedeUsarItem(UserIndex, ObjIndex, ref sMotivo) & SexoPuedeUsarItem(UserIndex, ObjIndex, ref sMotivo) & CheckRazaUsaRopa(UserIndex, ref ObjIndex, ref sMotivo) & FaccionPuedeUsarItem(UserIndex, ObjIndex, ref sMotivo))
                                {
                        ...
                        case Declaraciones.eOBJType.otMochilas:
                            {
                                ...
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "¡¡Estas muerto!! Solo podes usar items cuando estas vivo. ", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                                if (withBlock.Invent.Object_Renamed[Slot].Equipped != 0)
                                {
                                ...
                                withBlock.CurrentInventorySlots = Convert.ToByte(Declaraciones.MAX_NORMAL_INVENTORY_SLOTS + Obj_Renamed.MochilaType * 5);
                                Protocol.WriteAddSlots(UserIndex, (Declaraciones.eMochilas)Convert.ToInt32(Obj_Renamed.MochilaType));
                                break;
                            }
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "EquiparInvItem Slot:" + Slot + " - Error: " + ex.GetType().Name + " - Error Description : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }

        private static bool CheckRazaUsaRopa(short UserIndex, ref short ItemIndex, [Optional, DefaultParameterValue("")] ref string sMotivo)
        {
            ...
            try
            {

                {
                    ...
                    if (withBlock.raza == Declaraciones.eRaza.Humano | withBlock.raza == Declaraciones.eRaza.Elfo | withBlock.raza == Declaraciones.eRaza.Drow)
                    {
                    ...
                    if (withBlock.raza != Declaraciones.eRaza.Drow & Declaraciones.ObjData_Renamed[ItemIndex].RazaDrow != 0)
                    {
                        CheckRazaUsaRopaRet = false;
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error CheckRazaUsaRopa ItemIndex:" + ItemIndex;
                General.LogError(ref argdesc);
            }
        ...
        public static void UseInvItem(short UserIndex, byte Slot)
        {
...

            {
                ...
                if (Obj_Renamed.Newbie == 1 & !Extra.EsNewbie(UserIndex))
                {
                    Protocol.WriteConsoleMsg(UserIndex, "Sólo los newbies pueden usar estos objetos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                    ...
                    case Declaraciones.eOBJType.otUseOnce:
                        {
                            if (withBlock.flags.Muerto == 1)
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "¡¡Estás muerto!! Sólo puedes usar ítems cuando estás vivo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return;
                            }
                            ...
                            if (ObjIndex == (int)Declaraciones.e_ObjetosCriticos.Manzana | ObjIndex == (int)Declaraciones.e_ObjetosCriticos.Manzana2 | ObjIndex == (int)Declaraciones.e_ObjetosCriticos.ManzanaNewbie)
                            {
                                Declaraciones.SonidosMapas.ReproducirSonido(modSendData.SendTarget.ToPCArea, UserIndex, Convert.ToInt16((int)SoundMapInfo.e_SoundIndex.MORFAR_MANZANA));
                            }
                            else
                            {
                                Declaraciones.SonidosMapas.ReproducirSonido(modSendData.SendTarget.ToPCArea, UserIndex, Convert.ToInt16((int)SoundMapInfo.e_SoundIndex.SOUND_COMIDA));
                            }
                    ...
                    case Declaraciones.eOBJType.otWeapon:
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Estás muy cansad" + (withBlock.Genero == Declaraciones.eGenero.Hombre ? "o" : "a") + ".", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return;
                            }
                            ...
                            if (Declaraciones.ObjData_Renamed[ObjIndex].proyectil == 1)
                            {
                                if (withBlock.Invent.Object_Renamed[Slot].Equipped == 0)
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Antes de usar la herramienta deberías equipartela.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, (int)Declaraciones.eSkill.Proyectiles);
                            ...
                            else if (withBlock.flags.TargetObj == Declaraciones.Leña)
                            {
                                if (withBlock.Invent.Object_Renamed[Slot].ObjIndex == Declaraciones.DAGA)
                                {
                                    ...
                                    Trabajo.TratarDeHacerFogata(withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY, UserIndex);
                                }
                            }
                            else
                            {
                                ...
                                switch (ObjIndex)
                                {
                                    ...
                                    case Declaraciones.RED_PESCA:
                                        {
                                            if (withBlock.Invent.WeaponEqpObjIndex == Declaraciones.CAÑA_PESCA | withBlock.Invent.WeaponEqpObjIndex == Declaraciones.RED_PESCA)
                                            {
                                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, (int)Declaraciones.eSkill.Pesca);

                                            }
                                            // Call WriteWorkRequestTarget(UserIndex, eSkill.Pesca)
                                            else
                                            {
                                                Protocol.WriteConsoleMsg(UserIndex, "Debes tener equipada la herramienta para trabajar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                            }
                                    ...
                                    case Declaraciones.HACHA_LEÑA_ELFICA:
                                        {
                                            ...
                                            {
                                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, (int)Declaraciones.eSkill.Talar);
                                            }
                                            else
                                            {
                                                Protocol.WriteConsoleMsg(UserIndex, "Debes tener equipada la herramienta para trabajar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    ...
                                    case Declaraciones.PIQUETE_MINERO:
                                        {
                                            ...
                                            {
                                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, (int)Declaraciones.eSkill.Mineria);
                                            }
                                            else
                                            {
                                                Protocol.WriteConsoleMsg(UserIndex, "Debes tener equipada la herramienta para trabajar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    ...
                                    case Declaraciones.MARTILLO_HERRERO:
                                        {
                                            ...
                                            {
                                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, (int)Declaraciones.eSkill.Herreria);
                                            }
                                            else
                                            {
                                                Protocol.WriteConsoleMsg(UserIndex, "Debes tener equipada la herramienta para trabajar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    ...
                                    default:
                                        {
                                            if (Declaraciones.ObjData_Renamed[ObjIndex].SkHerreria > 0)
                                            {
                                                ...
                                                Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.WorkRequestTarget, Declaraciones.FundirMetal);
                    ...
                    case Declaraciones.eOBJType.otPociones:
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "¡¡Debes esperar unos momentos para tomar otra poción!!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                return;
                            }
                            ...
                            switch (withBlock.flags.TipoPocion)
                            {
                                ...
                                case 1: // Modif la agilidad
                                    {
                                        ...
                                        // Usa el item
                                        withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] + Matematicas.RandomNumber(Obj_Renamed.MinModificador, Obj_Renamed.MaxModificador));
                                        if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] > Declaraciones.MAXATRIBUTOS)
                                            withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Declaraciones.MAXATRIBUTOS;
                                        if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] > 2 * withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Agilidad])

                                            withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Convert.ToByte(2 * withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Agilidad]);
                                        ...
                                        if (withBlock.flags.AdminInvisible == 1)
                                        {
                                            string argdatos = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                            TCP.EnviarDatosASlot(UserIndex, ref argdatos);
                                        }
                                        else
                                        {
                                            modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                                        }
                                ...
                                case 2: // Modif la fuerza
                                    {
                                        ...
                                        // Usa el item
                                        withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] + Matematicas.RandomNumber(Obj_Renamed.MinModificador, Obj_Renamed.MaxModificador));
                                        if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] > Declaraciones.MAXATRIBUTOS)
                                            withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Declaraciones.MAXATRIBUTOS;
                                        if (withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] > 2 * withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Fuerza])

                                            withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Convert.ToByte(2 * withBlock.Stats.UserAtributosBackUP[(int)Declaraciones.eAtributos.Fuerza]);
                                        ...
                                        if (withBlock.flags.AdminInvisible == 1)
                                        {
                                            string argdatos1 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                ...
                                case 3: // Pocion roja, restaura HP
                                    {
                                        // Usa el item
                                        withBlock.Stats.MinHp = (short)(withBlock.Stats.MinHp + Convert.ToInt16(Matematicas.RandomNumber(Obj_Renamed.MinModificador, Obj_Renamed.MaxModificador)));
                                        ...
                                        if (withBlock.flags.AdminInvisible == 1)
                                        {
                                            string argdatos2 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                ...
                                case 4: // Pocion azul, restaura MANA
                                    {
                                        ...
                                        withBlock.Stats.MinMAN = Convert.ToInt16(withBlock.Stats.MinMAN + Matematicas.Porcentaje(withBlock.Stats.MaxMAN, 4) + withBlock.Stats.ELV / 2 + 40d / withBlock.Stats.ELV);
                                        ...
                                        if (withBlock.flags.AdminInvisible == 1)
                                        {
                                            string argdatos3 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                ...
                                case 5: // Pocion violeta
                                    {
                                        if (withBlock.flags.Envenenado == 1)
                                        {
                                            ...
                                            Protocol.WriteConsoleMsg(UserIndex, "Te has curado del envenenamiento.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                        }
                                        // Quitamos del inv el item
                                        QuitarUserInvItem(UserIndex, Slot, 1);
                                        ...
                                        if (withBlock.flags.AdminInvisible == 1)
                                        {
                                            string argdatos4 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                ...
                                case 6: // Pocion Negra
                                    {
                                        if ((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                                        {
                                            ...
                                            Protocol.WriteConsoleMsg(UserIndex, "Sientes un gran mareo y pierdes el conocimiento.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                                        }
                    ...
                    case Declaraciones.eOBJType.otBebidas:
                        {
                            ...
                            if (withBlock.flags.AdminInvisible == 1)
                            {
                                string argdatos5 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Declaraciones.SND_BEBER), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                    ...
                    case Declaraciones.eOBJType.otLlaves:
                        {
                            ...
                            if (TargObj.OBJType == Declaraciones.eOBJType.otPuertas)
                            {
                                ...
                                if (TargObj.Cerrada == 1)
                                {
                                    ...
                                    if (TargObj.Llave > 0)
                                    {
                                        if (TargObj.clave == Obj_Renamed.clave)
                                        {
                                            ...
                                            Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex = Declaraciones.ObjData_Renamed[Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex].IndexCerrada;
                                            withBlock.flags.TargetObj = Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex;
                                            Protocol.WriteConsoleMsg(UserIndex, "Has abierto la puerta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                            return;
                                        }
                                        else
                                        {
                                            Protocol.WriteConsoleMsg(UserIndex, "La llave no sirve.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                            return;
                                        }
                                    }
                                    else if (TargObj.clave == Obj_Renamed.clave)
                                    {
                                        Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex = Declaraciones.ObjData_Renamed[Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex].IndexCerradaLlave;
                                        Protocol.WriteConsoleMsg(UserIndex, "Has cerrado con llave la puerta.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                        withBlock.flags.TargetObj = Declaraciones.MapData[withBlock.flags.TargetObjMap, withBlock.flags.TargetObjX, withBlock.flags.TargetObjY].ObjInfo.ObjIndex;
                                        return;
                                    }
                                    else
                                ...
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "No está cerrada.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                            }
                    ...
                    case Declaraciones.eOBJType.otBotellaVacia:
                        {
                            ...
                            MiObj.Amount = 1;
                            MiObj.ObjIndex = Declaraciones.ObjData_Renamed[withBlock.Invent.Object_Renamed[Slot].ObjIndex].IndexAbierta;
                            QuitarUserInvItem(UserIndex, Slot, 1);
                    ...
                    case Declaraciones.eOBJType.otBotellaLlena:
                        {
                            ...
                            Protocol.WriteUpdateHungerAndThirst(UserIndex);
                            MiObj.Amount = 1;
                            MiObj.ObjIndex = Declaraciones.ObjData_Renamed[withBlock.Invent.Object_Renamed[Slot].ObjIndex].IndexCerrada;
                            QuitarUserInvItem(UserIndex, Slot, 1);
                            if (!MeterItemEnInventario(UserIndex, ref MiObj))
                            {
                                bool argNotPirata1 = true;
                                InvNpc.TirarItemAlPiso(ref withBlock.Pos, ref MiObj, NotPirata: ref argNotPirata1);
                            }
                    ...
                    case Declaraciones.eOBJType.otPergaminos:
                        {
                            ...
                            if (withBlock.Stats.MaxMAN > 0)
                            {
                                ...
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Estás demasiado hambriento y sediento.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                }
                            }
                            else
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "No tienes conocimientos de las Artes Arcanas.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            }
                    ...
                    case Declaraciones.eOBJType.otInstrumentos:
                        {
                            ...
                            {
                                string argsMotivo = "";
                                if (FaccionPuedeUsarItem(UserIndex, ObjIndex, sMotivo: ref argsMotivo))
                                {
                                    if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk == false)
                                    {
                                        Protocol.WriteConsoleMsg(UserIndex, "No hay peligro aquí. Es zona segura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                        return;
                                    }
                                    ...
                                    if (withBlock.flags.AdminInvisible == 1)
                                    {
                                        string argdatos6 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Obj_Renamed.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                        TCP.EnviarDatosASlot(UserIndex, ref argdatos6);
                                    }
                                    else
                                    {
                                        modSendData.AlertarFaccionarios(UserIndex);
                                        modSendData.SendData(modSendData.SendTarget.toMap, withBlock.Pos.Map, Protocol.PrepareMessagePlayWave(Convert.ToByte(Obj_Renamed.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                                    }
                                ...
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Sólo miembros del ejército real pueden usar este cuerno.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                            }
                            else if (Obj_Renamed.Caos != 0) // ¿Es el Cuerno Legión?
                            {
                                string argsMotivo1 = "";
                                if (FaccionPuedeUsarItem(UserIndex, ObjIndex, sMotivo: ref argsMotivo1))
                                {
                                    if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk == false)
                                    {
                                        Protocol.WriteConsoleMsg(UserIndex, "No hay peligro aquí. Es zona segura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    ...
                                    if (withBlock.flags.AdminInvisible == 1)
                                    {
                                        string argdatos7 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Obj_Renamed.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                ...
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Sólo miembros de la legión oscura pueden usar este cuerno.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                            }
                            ...
                            if (withBlock.flags.AdminInvisible == 1)
                            {
                                string argdatos8 = Protocol.PrepareMessagePlayWave(Convert.ToByte(Obj_Renamed.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y));
                                TCP.EnviarDatosASlot(UserIndex, ref argdatos8);
                            }
                            else
                            {
                                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Convert.ToByte(Obj_Renamed.Snd1), Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                            }
                    ...
                    case Declaraciones.eOBJType.otBarcos:
                        {
                            ...
                            {
                                if (withBlock.clase != Declaraciones.eClass.Worker & withBlock.clase != Declaraciones.eClass.Pirat)
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Para recorrer los mares debes ser nivel 25 o superior.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                                else if (withBlock.Stats.ELV < 20)
                                {
                                    Protocol.WriteConsoleMsg(UserIndex, "Para recorrer los mares debes ser nivel 20 o superior.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    return;
                                }
                            }

                            if ((Extra.LegalPos(withBlock.Pos.Map, Convert.ToInt16(withBlock.Pos.X - 1), withBlock.Pos.Y, true, false) | Extra.LegalPos(withBlock.Pos.Map, withBlock.Pos.X, Convert.ToInt16(withBlock.Pos.Y - 1), true, false) | Extra.LegalPos(withBlock.Pos.Map, Convert.ToInt16(withBlock.Pos.X + 1), withBlock.Pos.Y, true, false) | Extra.LegalPos(withBlock.Pos.Map, withBlock.Pos.X, Convert.ToInt16(withBlock.Pos.Y + 1), true, false)) & withBlock.flags.Navegando == 0 | withBlock.flags.Navegando == 1)
                            {
                                Trabajo.DoNavega(UserIndex, ref Obj_Renamed, Slot);
                            }
                            else
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "¡Debes aproximarte al agua para usar el barco!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            }
        ...
        public static bool ItemSeCae(short index)
        {
...

            {
                ...
                ItemSeCaeRet = (withBlock.Real != 1 | withBlock.NoSeCae == 0) & (withBlock.Caos != 1 | withBlock.NoSeCae == 0) & withBlock.OBJType != Declaraciones.eOBJType.otLlaves & withBlock.OBJType != Declaraciones.eOBJType.otBarcos & withBlock.NoSeCae == 0;
            }
        ...
        public static Declaraciones.eOBJType getObjType(short ObjIndex)
        {
            ...
            if (ObjIndex > 0)
            {
                getObjTypeRet = Declaraciones.ObjData_Renamed[ObjIndex].OBJType;
            }
