    ...
    static class Trabajo
    {
        ...
        public static void DoPermanecerOculto(short UserIndex)
        {
            ...
            {
                {
                    ...
                    if (withBlock.Counters.TiempoOculto <= 0)
                    {
                        ...
                        if (withBlock.clase == Declaraciones.eClass.Hunter & withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Ocultarse] > 90)
                        {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en Sub DoPermanecerOculto";
        ...
        public static void DoOcultarse(short UserIndex)
        {
...

                {
                    ...
                    if (res <= Suerte)
                    {
                        ...
                        if (withBlock.flags.Navegando == 0)
                        {
                            ...
                            Protocol.WriteConsoleMsg(UserIndex, "¡Te has escondido entre las sombras!", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                    ...
                    else
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡No has logrado esconderte!", Protocol.FontTypeNames.FONTTYPE_INFO);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en Sub DoOcultarse";
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoNavega(short UserIndex, ref Declaraciones.ObjData Barco, short Slot)
        {
...

            {
                ...
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes conocimientos para usar este barco.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    Protocol.WriteConsoleMsg(UserIndex, "Para usar este barco necesitas " + Barco.MinSkill * ModNave + " puntos en navegacion.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return;
                }
                ...
                else
                {
                    ...
                    if (withBlock.flags.Muerto == 0)
                    {
                        ...
                        {
                            withBlock.Char_Renamed.body = Declaraciones.ObjData_Renamed[withBlock.Invent.ArmourEqpObjIndex].Ropaje;
                        }
                        else
                        {
                        ...
                        if (withBlock.Invent.EscudoEqpObjIndex > 0)
                            withBlock.Char_Renamed.ShieldAnim = Declaraciones.ObjData_Renamed[withBlock.Invent.EscudoEqpObjIndex].ShieldAnim;
                        ...
                        if (withBlock.Invent.CascoEqpObjIndex > 0)
                            withBlock.Char_Renamed.CascoAnim = Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].CascoAnim;
                    }
        ...
        public static void FundirMineral(short UserIndex)
        {
            ...
            try
            {

                {
                    ...
                    if (withBlock.flags.TargetObjInvIndex > 0)
                    {
                        ...
                        if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].OBJType == Declaraciones.eOBJType.otMinerales & Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].MinSkill <= withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Mineria] / ModFundicion(withBlock.clase))
                        {
                            DoLingotes(UserIndex);
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No tienes conocimientos de minería suficientes para trabajar este mineral.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en FundirMineral. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void FundirArmas(short UserIndex)
        {
            ...
            {
                {
                    ...
                    if (withBlock.flags.TargetObjInvIndex > 0)
                    {
                        if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].OBJType == Declaraciones.eOBJType.otWeapon)
                        {
                            if (Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].SkHerreria <= withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Herreria] / ModHerreriA(withBlock.clase))
                            {
                                DoFundir(UserIndex);
                            }
                            else
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "No tienes los conocimientos suficientes en herrería para fundir este objeto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            }
                        }
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en FundirArmas. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
            ...
            {
                {
                    ...
                    if (withBlock.ObjIndex == ItemIndex)
                    {
                        ...
                        if (withBlock.Amount <= 0)
                        {
                            ...
                            Declaraciones.UserList[UserIndex].Invent.NroItems = Convert.ToInt16(Declaraciones.UserList[UserIndex].Invent.NroItems - 1);
                            withBlock.Amount = 0;
        ...
        public static bool CarpinteroTieneMateriales(short UserIndex, short ItemIndex, short Cantidad, bool ShowMsg = false)
        {
...

            {
                ...
                if (withBlock.Madera > 0)
                {
                    ...
                    {
                        if (ShowMsg)
                            Protocol.WriteConsoleMsg(UserIndex, "No tienes suficiente madera.", Protocol.FontTypeNames.FONTTYPE_INFO);
                ...
                if (withBlock.MaderaElfica > 0)
                {
                    ...
                    {
                        if (ShowMsg)
                            Protocol.WriteConsoleMsg(UserIndex, "No tienes suficiente madera élfica.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        CarpinteroTieneMaterialesRet = false;
                        return CarpinteroTieneMaterialesRet;
                    }
                }
        ...
        public static bool HerreroTieneMateriales(short UserIndex, short ItemIndex, short CantidadItems)
        {
            ...
            // ***************************************************
            {
                ...
                if (withBlock.LingH > 0)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes lingotes de hierro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                ...
                if (withBlock.LingP > 0)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes lingotes de plata.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        HerreroTieneMaterialesRet = false;
                        return HerreroTieneMaterialesRet;
                    }
                }
                if (withBlock.LingO > 0)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes lingotes de oro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        HerreroTieneMaterialesRet = false;
                        return HerreroTieneMaterialesRet;
                    }
                }
        ...
        public static bool TieneMaterialesUpgrade(short UserIndex, short ItemIndex)
        {
...

            {
                ...
                if (withBlock.LingH > 0)
                {
                    if (!TieneObjetos(Declaraciones.LingoteHierro, Convert.ToInt16(withBlock.LingH - Declaraciones.ObjData_Renamed[ItemIndex].LingH * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex))
                ...
                if (withBlock.LingP > 0)
                {
                    if (!TieneObjetos(Declaraciones.LingotePlata, Convert.ToInt16(withBlock.LingP - Declaraciones.ObjData_Renamed[ItemIndex].LingP * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex))
                ...
                if (withBlock.LingO > 0)
                {
                    if (!TieneObjetos(Declaraciones.LingoteOro, Convert.ToInt16(withBlock.LingO - Declaraciones.ObjData_Renamed[ItemIndex].LingO * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex))
                ...
                if (withBlock.Madera > 0)
                {
                    if (!TieneObjetos(Declaraciones.Leña, Convert.ToInt16(withBlock.Madera - Declaraciones.ObjData_Renamed[ItemIndex].Madera * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex))
                ...
                if (withBlock.MaderaElfica > 0)
                {
                    if (!TieneObjetos(Declaraciones.LeñaElfica, Convert.ToInt16(withBlock.MaderaElfica - Declaraciones.ObjData_Renamed[ItemIndex].MaderaElfica * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex))
        ...
        public static void QuitarMaterialesUpgrade(short UserIndex, short ItemIndex)
        {
...

            {
                ref var withBlock = ref Declaraciones.ObjData_Renamed[ItemUpgrade];
                if (withBlock.LingH > 0)
                    QuitarObjetos(Declaraciones.LingoteHierro, Convert.ToInt16(withBlock.LingH - Declaraciones.ObjData_Renamed[ItemIndex].LingH * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex);
                if (withBlock.LingP > 0)
                    QuitarObjetos(Declaraciones.LingotePlata, Convert.ToInt16(withBlock.LingP - Declaraciones.ObjData_Renamed[ItemIndex].LingP * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex);
                if (withBlock.LingO > 0)
                    QuitarObjetos(Declaraciones.LingoteOro, Convert.ToInt16(withBlock.LingO - Declaraciones.ObjData_Renamed[ItemIndex].LingO * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex);
                if (withBlock.Madera > 0)
                    QuitarObjetos(Declaraciones.Leña, Convert.ToInt16(withBlock.Madera - Declaraciones.ObjData_Renamed[ItemIndex].Madera * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex);
                if (withBlock.MaderaElfica > 0)
                    QuitarObjetos(Declaraciones.LeñaElfica, Convert.ToInt16(withBlock.MaderaElfica - Declaraciones.ObjData_Renamed[ItemIndex].MaderaElfica * Declaraciones.PORCENTAJE_MATERIALES_UPGRADE), UserIndex);
            }
        ...
        public static bool PuedeConstruir(short UserIndex, short ItemIndex, short CantidadItems)
        {
            ...
            // ***************************************************
            PuedeConstruirRet = HerreroTieneMateriales(UserIndex, ItemIndex, CantidadItems) & Math.Round((double)(Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Herreria] / ModHerreriA(Declaraciones.UserList[UserIndex].clase)), 0) >= Declaraciones.ObjData_Renamed[ItemIndex].SkHerreria;
        ...
        public static void HerreroConstruirItem(short UserIndex, short ItemIndex)
        {
            ...
            Declaraciones.Obj MiObj;
            {
                ...
                if (PuedeConstruirHerreria(ItemIndex))
                {
                    ...
                    if (!TieneMateriales)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes materiales.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        Protocol.WriteStopWorking(UserIndex);
                        return;
                    }
                    ...
                    if (withBlock.clase == Declaraciones.eClass.Worker)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No tienes suficiente energía.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return;
                        }
                    }
                    // Chequeamos que tenga los puntos antes de sacarselos
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Has construido " + (CantidadItems > 1 ? CantidadItems + " armas!" : "el arma!"), Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else if (Declaraciones.ObjData_Renamed[ItemIndex].OBJType == Declaraciones.eOBJType.otESCUDO)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Has construido " + (CantidadItems > 1 ? CantidadItems + " escudos!" : "el escudo!"), Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else if (Declaraciones.ObjData_Renamed[ItemIndex].OBJType == Declaraciones.eOBJType.otCASCO)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Has construido " + (CantidadItems > 1 ? CantidadItems + " cascos!" : "el casco!"), Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else if (Declaraciones.ObjData_Renamed[ItemIndex].OBJType == Declaraciones.eOBJType.otArmadura)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Has construido " + (CantidadItems > 1 ? CantidadItems + " armaduras" : "la armadura!"), Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    ...
                    if (!InvUsuario.MeterItemEnInventario(UserIndex, ref MiObj))
                    {
                        ...
                        InvNpc.TirarItemAlPiso(ref withBlock.Pos, ref MiObj, NotPirata: ref argNotPirata);
                    }

                    // Log de construcción de Items. Pablo (ToxicWaste) 10/09/07
                    if (Declaraciones.ObjData_Renamed[MiObj.ObjIndex].Log == 1)
                    {
                        General.LogDesarrollo(withBlock.name + " ha construído " + MiObj.Amount + " " + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name);
                    }

                    UsUaRiOs.SubirSkill(UserIndex, (short)Declaraciones.eSkill.Herreria, true);
                    InvUsuario.UpdateUserInv(true, UserIndex, 0);
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.MARTILLOHERRERO, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
        ...
        public static void CarpinteroConstruirItem(short UserIndex, short ItemIndex)
        {
            ...
            Declaraciones.Obj MiObj;
            {
                ...
                if (Math.Round((decimal)(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Carpinteria] / ModCarpinteria(withBlock.clase)), 0) >= Declaraciones.ObjData_Renamed[ItemIndex].SkCarpinteria & PuedeConstruirCarpintero(ItemIndex) & withBlock.Invent.WeaponEqpObjIndex == Declaraciones.SERRUCHO_CARPINTERO)
                {
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "Has construido " + CantidadItems + (CantidadItems == 1 ? " objeto!" : " objetos!"), Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    InvUsuario.UpdateUserInv(true, UserIndex, 0);
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.LABUROCARPINTERO, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                ...
                {
                    Protocol.WriteConsoleMsg(UserIndex, "Debes tener equipado el serrucho para trabajar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void DoLingotes(short UserIndex)
        {
            ...
            {
                ref var withBlock = ref Declaraciones.UserList[UserIndex];
                CantidadItems = Convert.ToInt16(SistemaCombate.MaximoInt(1, Convert.ToInt32((withBlock.Stats.ELV - 4) / 5d)));
                ...
                {
                    if (withBlock.Invent.Object_Renamed[Slot].Amount >= (short)(MineralesParaLingote((Declaraciones.iMinerales)obji) * CantidadItems))
                    {
                        TieneMinerales = true;
                    }
                    else
                ...
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes minerales para hacer un lingote.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    return;
                }

                withBlock.Invent.Object_Renamed[Slot].Amount = (short)(withBlock.Invent.Object_Renamed[Slot].Amount - (short)(MineralesParaLingote((Declaraciones.iMinerales)obji) * CantidadItems));
                ...
                Protocol.WriteConsoleMsg(UserIndex, "¡Has obtenido " + CantidadItems + " lingote" + (CantidadItems == 1 ? "" : "s") + "!", Protocol.FontTypeNames.FONTTYPE_INFO);
        ...
        public static void DoFundir(short UserIndex)
        {
            ...
            var MiObj = new Declaraciones.Obj[3];
            {
                ...
                Lingotes[0] = Convert.ToInt16(Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].LingH * num * 0.01d);
                Lingotes[1] = Convert.ToInt16(Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].LingP * num * 0.01d);
                Lingotes[2] = Convert.ToInt16(Declaraciones.ObjData_Renamed[withBlock.flags.TargetObjInvIndex].LingO * num * 0.01d);
                ...
                for (i = 0; i <= 2; i++)
                {
                    ...
                    if (MiObj[i].Amount > 0)
                    {
                        ...
                        {
                            bool argNotPirata = true;
                            InvNpc.TirarItemAlPiso(ref withBlock.Pos, ref MiObj[i], NotPirata: ref argNotPirata);
                        }
                        InvUsuario.UpdateUserInv(true, UserIndex, Slot);
                    }
                }

                Protocol.WriteConsoleMsg(UserIndex, "¡Has obtenido el " + num + "% de los lingotes utilizados para la construcción del objeto!", Protocol.FontTypeNames.FONTTYPE_INFO);
        ...
        public static void DoUpgrade(short UserIndex, short ItemIndex)
        {
            ...
            Declaraciones.Obj MiObj;
            {
                ...
                if (PuedeConstruirHerreria(ItemUpgrade))
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Debes equiparte el martillo de herrero.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    if (Math.Round((double)(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Herreria] / ModHerreriA(withBlock.clase)), 0) < Declaraciones.ObjData_Renamed[ItemUpgrade].SkHerreria)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes skills.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    ...
                    switch (Declaraciones.ObjData_Renamed[ItemIndex].OBJType)
                    {
                        case Declaraciones.eOBJType.otWeapon:
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado el arma!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }

                        case Declaraciones.eOBJType.otESCUDO: // Todavía no hay, pero just in case
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado el escudo!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }

                        case Declaraciones.eOBJType.otCASCO:
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado el casco!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }

                        case Declaraciones.eOBJType.otArmadura:
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado la armadura!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }
                    }
                ...
                else if (PuedeConstruirCarpintero(ItemUpgrade))
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Debes equiparte el serrucho.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    if (Math.Round((decimal)(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Carpinteria] / ModCarpinteria(withBlock.clase)), 0) < Declaraciones.ObjData_Renamed[ItemUpgrade].SkCarpinteria)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No tienes suficientes skills.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        return;
                    }
                    ...
                    switch (Declaraciones.ObjData_Renamed[ItemIndex].OBJType)
                    {
                        case Declaraciones.eOBJType.otFlechas:
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado la flecha!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }
                        ...
                        case Declaraciones.eOBJType.otBarcos:
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "Has mejorado el barco!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                break;
                            }
                    }
                ...
                if (Declaraciones.ObjData_Renamed[ItemIndex].Log == 1)
                    General.LogDesarrollo(withBlock.name + " ha mejorado el ítem " + Declaraciones.ObjData_Renamed[ItemIndex].name + " a " + Declaraciones.ObjData_Renamed[ItemUpgrade].name);
        ...
        public static void DoDomar(short UserIndex, short NpcIndex)
        {
            ...
            try
            {
                ...
                short index;
                {
                    ...
                    if (withBlock.NroMascotas < Declaraciones.MAXMASCOTAS)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "La criatura ya tiene amo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return;
                        }

                        if (!PuedeDomarMascota(UserIndex, NpcIndex))
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes domar más de dos criaturas del mismo tipo.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            return;
                        }

                        puntosDomar = (short)(Convert.ToInt16(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma]) * Convert.ToInt16(withBlock.Stats.UserSkills[(int)Declaraciones.eSkill.Domar]));
                        ...
                        if (puntosRequeridos <= puntosDomar & Matematicas.RandomNumber(1, 5) == 1)
                        {
                            ...
                            Protocol.WriteConsoleMsg(UserIndex, "La criatura te ha aceptado como su amo.", Protocol.FontTypeNames.FONTTYPE_INFO);

                            // Es zona segura?
                            CanStay = Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk == true;
                        ...
                        else
                        {
                            ...
                            {
                                Protocol.WriteConsoleMsg(UserIndex, "No has logrado domar la criatura.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "No puedes controlar más criaturas.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                }
            }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en DoDomar. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoAdminInvisible(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.AdminInvisible == 0)
                {
                    ...
                    string argdatos = Protocol.PrepareMessageSetInvisible(withBlock.Char_Renamed.CharIndex, true);
                    TCP.EnviarDatosASlot(UserIndex, ref argdatos);
                    // Le mandamos el mensaje para que borre el personaje a los clientes que estén cerca
                    modSendData.SendData(modSendData.SendTarget.ToPCAreaButIndex, UserIndex, Protocol.PrepareMessageCharacterRemove(withBlock.Char_Renamed.CharIndex));
                }
                else
                {
                    ...
                    string argdatos1 = Protocol.PrepareMessageCharacterChange(withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, withBlock.Char_Renamed.heading, withBlock.Char_Renamed.CharIndex, withBlock.Char_Renamed.WeaponAnim, withBlock.Char_Renamed.ShieldAnim, withBlock.Char_Renamed.FX, withBlock.Char_Renamed.loops, withBlock.Char_Renamed.CascoAnim);
                    TCP.EnviarDatosASlot(UserIndex, ref argdatos1);
                    string argdatos2 = Protocol.PrepareMessageSetInvisible(withBlock.Char_Renamed.CharIndex, false);
                    ...
                    bool argButIndex = true;
                    UsUaRiOs.MakeUserChar(true, withBlock.Pos.Map, UserIndex, withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y, ref argButIndex);
                }
            }
        }
        ...
        public static void TratarDeHacerFogata(short Map, short X, short Y, short UserIndex)
        {
            ...
            {
                Protocol.WriteConsoleMsg(UserIndex, "Necesitas clickear sobre leña para hacer ramitas.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return;
            }

            if (Matematicas.Distancia(ref posMadera, ref Declaraciones.UserList[UserIndex].Pos) > 2)
            {
                Protocol.WriteConsoleMsg(UserIndex, "Estás demasiado lejos para prender la fogata.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return;
            }

            if (Declaraciones.UserList[UserIndex].flags.Muerto == 1)
            {
                Protocol.WriteConsoleMsg(UserIndex, "No puedes hacer fogatas estando muerto.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return;
            }

            if (Declaraciones.MapData[Map, X, Y].ObjInfo.Amount < 3)
            {
                Protocol.WriteConsoleMsg(UserIndex, "Necesitas por lo menos tres troncos para hacer una fogata.", Protocol.FontTypeNames.FONTTYPE_INFO);
                return;
            }
            ...
            if (exito == 1)
            {
                ...
                Protocol.WriteConsoleMsg(UserIndex, "Has hecho " + Obj_Renamed.Amount + " fogatas.", Protocol.FontTypeNames.FONTTYPE_INFO);
            ...
            else
            {
                ...
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No has podido hacer la fogata.", Protocol.FontTypeNames.FONTTYPE_INFO);
        ...
        public static void DoPescar(short UserIndex)
        {
            ...
            try
            {
                ...
                if (res <= 6)
                {
                    ...
                    if (Declaraciones.UserList[UserIndex].clase == Declaraciones.eClass.Worker)
                    {
                        {
                            ref var withBlock = ref Declaraciones.UserList[UserIndex];
                            CantidadItems = Convert.ToInt16(1 + SistemaCombate.MaximoInt(1, Convert.ToInt32((withBlock.Stats.ELV - 4) / 5d)));
                        }
                    ...
                    {
                        bool argNotPirata = true;
                        InvNpc.TirarItemAlPiso(ref Declaraciones.UserList[UserIndex].Pos, ref MiObj, NotPirata: ref argNotPirata);
                    }
                ...
                Declaraciones.UserList[UserIndex].Reputacion.PlebeRep = Declaraciones.UserList[UserIndex].Reputacion.PlebeRep + Declaraciones.vlProleta;
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en DoPescar. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoPescarRed(short UserIndex)
        {
            ...
            try
            {
                ...
                if (Suerte > 0)
                {
                    ...
                    if (res < 6)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "¡Has pescado algunos peces!", Protocol.FontTypeNames.FONTTYPE_INFO);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en DoPescarRed";
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoRobar(short LadrOnIndex, short VictimaIndex)
        {
            ...
            try
            {
                ...
                if (Declaraciones.UserList[LadrOnIndex].flags.Seguro)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(LadrOnIndex, "Debes quitarte el seguro para robarle a un ciudadano.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        return;
                    }
                }
                else if (Declaraciones.UserList[LadrOnIndex].Faccion.ArmadaReal == 1)
                {
                    Protocol.WriteConsoleMsg(LadrOnIndex, "Los miembros del ejército real no tienen permitido robarle a ciudadanos.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    return;
                }
                ...
                short N;
                {
                    ...
                    // Caos robando a caos?
                    if (Declaraciones.UserList[VictimaIndex].Faccion.FuerzasCaos == 1 & withBlock.Faccion.FuerzasCaos == 1)
                    {
                        Protocol.WriteConsoleMsg(LadrOnIndex, "No puedes robar a otros miembros de la legión oscura.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        return;
                    }
                    ...
                    if (withBlock.Stats.MinSta < 15)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(LadrOnIndex, "Estás muy cansado para robar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                        else
                        {
                            Protocol.WriteConsoleMsg(LadrOnIndex, "Estás muy cansada para robar.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                    ...
                    if ((Declaraciones.UserList[VictimaIndex].flags.Privilegios & Declaraciones.PlayerType.User) != 0)
                    {
                        ...
                        if (res < 3) // Exito robo
                        {
                            ...
                            if (Matematicas.RandomNumber(1, 50) < 25 & withBlock.clase == Declaraciones.eClass.Thief)
                            {
                                ...
                                {
                                    Protocol.WriteConsoleMsg(LadrOnIndex, Declaraciones.UserList[VictimaIndex].name + " no tiene objetos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                                }
                            }
                            else if (Declaraciones.UserList[VictimaIndex].Stats.GLD > 0) // Roba oro
                            {
                                ...
                                if (withBlock.clase == Declaraciones.eClass.Thief)
                                {
                                    ...
                                    if (GuantesHurto)
                                    {
                                        N = Convert.ToInt16(Matematicas.RandomNumber(withBlock.Stats.ELV * 50, withBlock.Stats.ELV * 100));
                                    }
                                    else
                                    {
                                        N = Convert.ToInt16(Matematicas.RandomNumber(withBlock.Stats.ELV * 25, withBlock.Stats.ELV * 50));
                                    }
                                }
                                else
                                {
                                ...
                                Declaraciones.UserList[VictimaIndex].Stats.GLD = Declaraciones.UserList[VictimaIndex].Stats.GLD - N;
                                ...
                                Protocol.WriteConsoleMsg(LadrOnIndex, "Le has robado " + N + " monedas de oro a " + Declaraciones.UserList[VictimaIndex].name, Protocol.FontTypeNames.FONTTYPE_INFO);
                            ...
                            {
                                Protocol.WriteConsoleMsg(LadrOnIndex, Declaraciones.UserList[VictimaIndex].name + " no tiene oro.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            }
                        ...
                        {
                            Protocol.WriteConsoleMsg(LadrOnIndex, "¡No has logrado robar nada!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            Protocol.WriteConsoleMsg(VictimaIndex, "¡" + withBlock.name + " ha intentado robarte!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            Protocol.WriteConsoleMsg(VictimaIndex, "¡" + withBlock.name + " es un criminal!", Protocol.FontTypeNames.FONTTYPE_INFO);
                            Protocol.FlushBuffer(VictimaIndex);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en DoRobar. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static bool ObjEsRobable(short VictimaIndex, short Slot)
        {
            ...
            ObjEsRobableRet = Declaraciones.ObjData_Renamed[OI].OBJType != Declaraciones.eOBJType.otLlaves & Declaraciones.UserList[VictimaIndex].Invent.Object_Renamed[Slot].Equipped == 0 & Declaraciones.ObjData_Renamed[OI].Real == 0 & Declaraciones.ObjData_Renamed[OI].Caos == 0 & Declaraciones.ObjData_Renamed[OI].OBJType != Declaraciones.eOBJType.otBarcos;
        ...
        public static void RobarObjeto(short LadrOnIndex, short VictimaIndex)
        {
            ...
            if (flag)
            {
                ...
                num = Convert.ToByte(SistemaCombate.MaximoInt(1, Matematicas.RandomNumber(Convert.ToInt32(ObjAmount * 0.05d), Convert.ToInt32(ObjAmount * 0.1d))));
                ...
                {
                    bool argNotPirata = true;
                    InvNpc.TirarItemAlPiso(ref Declaraciones.UserList[LadrOnIndex].Pos, ref MiObj, NotPirata: ref argNotPirata);
                }

                if (Declaraciones.UserList[LadrOnIndex].clase == Declaraciones.eClass.Thief)
                {
                    Protocol.WriteConsoleMsg(LadrOnIndex, "Has robado " + MiObj.Amount + " " + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
                    Protocol.WriteConsoleMsg(LadrOnIndex, "Has hurtado " + MiObj.Amount + " " + Declaraciones.ObjData_Renamed[MiObj.ObjIndex].name, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
            else
            {
                Protocol.WriteConsoleMsg(LadrOnIndex, "No has logrado robar ningún objeto.", Protocol.FontTypeNames.FONTTYPE_INFO);
            }
        ...
        public static void DoApuñalar(short UserIndex, short VictimNpcIndex, short VictimUserIndex, short daño)
        {
            ...
            switch (Declaraciones.UserList[UserIndex].clase)
            {
                case Declaraciones.eClass.Assasin:
                    {
                        Suerte = Convert.ToInt16(Conversion.Int(((0.00003d * Skill - 0.002d) * Skill + 0.098d) * Skill + 4.25d));
                        break;
                    }
                ...
                case Declaraciones.eClass.Pirat:
                    {
                        Suerte = Convert.ToInt16(Conversion.Int(((0.000003d * Skill + 0.0006d) * Skill + 0.0107d) * Skill + 4.93d));
                        break;
                    }

                case Declaraciones.eClass.Bard:
                    {
                        Suerte = Convert.ToInt16(Conversion.Int(((0.000002d * Skill + 0.0002d) * Skill + 0.032d) * Skill + 4.81d));
                        break;
                    }
            ...
            if (Matematicas.RandomNumber(0, 100) < Suerte)
            {
                if (VictimUserIndex != 0)
                {
                    ...
                    Declaraciones.UserList[VictimUserIndex].Stats.MinHp = (short)(Declaraciones.UserList[VictimUserIndex].Stats.MinHp - daño);
                    Protocol.WriteConsoleMsg(UserIndex, "Has apuñalado a " + Declaraciones.UserList[VictimUserIndex].name + " por " + daño, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    Protocol.WriteConsoleMsg(VictimUserIndex, "Te ha apuñalado " + Declaraciones.UserList[UserIndex].name + " por " + daño, Protocol.FontTypeNames.FONTTYPE_FIGHT);

                    Protocol.FlushBuffer(VictimUserIndex);
                }
                else
                {
                    Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp = Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp - Conversion.Int(daño * 2);
                    Protocol.WriteConsoleMsg(UserIndex, "Has apuñalado la criatura por " + Conversion.Int(daño * 2), Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    // [Alejo]
            ...
            {
                Protocol.WriteConsoleMsg(UserIndex, "¡No has logrado apuñalar a tu enemigo!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
        ...
        public static void DoAcuchillar(short UserIndex, short VictimNpcIndex, short VictimUserIndex, short daño)
        {
            ...
            if (Matematicas.RandomNumber(0, 100) < Declaraciones.PROB_ACUCHILLAR)
            {
                ...
                {
                    Declaraciones.UserList[VictimUserIndex].Stats.MinHp = (short)(Declaraciones.UserList[VictimUserIndex].Stats.MinHp - daño);
                    Protocol.WriteConsoleMsg(UserIndex, "Has acuchillado a " + Declaraciones.UserList[VictimUserIndex].name + " por " + daño, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    Protocol.WriteConsoleMsg(VictimUserIndex, Declaraciones.UserList[UserIndex].name + " te ha acuchillado por " + daño, Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
                else
                {
                    Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp = Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp - daño;
                    Protocol.WriteConsoleMsg(UserIndex, "Has acuchillado a la criatura por " + daño, Protocol.FontTypeNames.FONTTYPE_FIGHT);
        ...
        public static void DoGolpeCritico(short UserIndex, short VictimNpcIndex, short VictimUserIndex, short daño)
        {
            ...
            if (Declaraciones.UserList[UserIndex].Invent.WeaponEqpSlot == 0)
                return;
            if (Declaraciones.ObjData_Renamed[Declaraciones.UserList[UserIndex].Invent.WeaponEqpObjIndex].name != "Espada Vikinga")
                return;


            Skill = Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling];

            Suerte = Convert.ToInt16(Conversion.Int((((0.00000003d * Skill + 0.000006d) * Skill + 0.000107d) * Skill + 0.0893d) * 100d));
            ...
            if (Matematicas.RandomNumber(0, 100) < Suerte)
            {
                ...
                {
                    Declaraciones.UserList[VictimUserIndex].Stats.MinHp = (short)(Declaraciones.UserList[VictimUserIndex].Stats.MinHp - daño);
                    Protocol.WriteConsoleMsg(UserIndex, "Has golpeado críticamente a " + Declaraciones.UserList[VictimUserIndex].name + " por " + daño + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    Protocol.WriteConsoleMsg(VictimUserIndex, Declaraciones.UserList[UserIndex].name + " te ha golpeado críticamente por " + daño + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
                else
                {
                    Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp = Declaraciones.Npclist[VictimNpcIndex].Stats.MinHp - daño;
                    Protocol.WriteConsoleMsg(UserIndex, "Has golpeado críticamente a la criatura por " + daño + ".", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                    // [Alejo]
                    SistemaCombate.CalcularDarExp(UserIndex, VictimNpcIndex, daño);
                }
            }
        ...
        public static void QuitarSta(short UserIndex, short Cantidad)
        {
            ...
            try
            {
                ...
                Declaraciones.UserList[UserIndex].Stats.MinSta = (short)(Declaraciones.UserList[UserIndex].Stats.MinSta - Cantidad);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en QuitarSta. Error " + ex.GetType().Name + " : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoTalar(short UserIndex, bool DarMaderaElfica = false)
        {
            ...
            try
            {
                ...
                if (res <= 6)
                {
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "¡Has conseguido algo de leña!", Protocol.FontTypeNames.FONTTYPE_INFO);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en DoTalar";
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoMineria(short UserIndex)
        {
            ...
            try
            {
                ...
                Declaraciones.Obj MiObj;
                {
                    ...
                    if (res <= 5)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "¡Has extraido algunos minerales!", Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    else
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "¡No has conseguido nada!", Protocol.FontTypeNames.FONTTYPE_INFO);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en Sub DoMineria";
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void DoMeditar(short UserIndex)
        {
            ...
            int TActual;
            {
                ...
                if (TActual - withBlock.Counters.tInicioMeditar < Declaraciones.TIEMPO_INICIOMEDITAR)
                {
                    return;
                }

                if (withBlock.Counters.bPuedeMeditar == false)
                {
                    withBlock.Counters.bPuedeMeditar = true;
                }
                ...
                if (withBlock.Stats.MinMAN >= withBlock.Stats.MaxMAN)
                {
                    ...
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, 0, 0));
                    return;
                }
                ...
                if (res == 1)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "¡Has recuperado " + cant + " puntos de maná!", Protocol.FontTypeNames.FONTTYPE_INFO);
...

            {
                ...
                if (withBlock1.Invent.EscudoEqpObjIndex > 0)
                {
                    ...
                    if (Resultado <= Probabilidad)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "Has logrado desequipar el escudo de tu oponente!", Protocol.FontTypeNames.FONTTYPE_FIGHT);

                        if (withBlock1.Stats.ELV < 20)
                        {
                            Protocol.WriteConsoleMsg(VictimIndex, "¡Tu oponente te ha desequipado el escudo!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                ...
                if (withBlock1.Invent.WeaponEqpObjIndex > 0)
                {
                    ...
                    if (Resultado <= Probabilidad)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "Has logrado desarmar a tu oponente!", Protocol.FontTypeNames.FONTTYPE_FIGHT);

                        if (withBlock1.Stats.ELV < 20)
                        {
                            Protocol.WriteConsoleMsg(VictimIndex, "¡Tu oponente te ha desarmado!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                ...
                if (withBlock1.Invent.CascoEqpObjIndex > 0)
                {
                    ...
                    if (Resultado <= Probabilidad)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "Has logrado desequipar el casco de tu oponente!", Protocol.FontTypeNames.FONTTYPE_FIGHT);

                        if (withBlock1.Stats.ELV < 20)
                        {
                            Protocol.WriteConsoleMsg(VictimIndex, "¡Tu oponente te ha desequipado el casco!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                        }
                ...
                if (AlgoEquipado)
                {
                    Protocol.WriteConsoleMsg(UserIndex, "Tu oponente no tiene equipado items!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
                else
                {
                    Protocol.WriteConsoleMsg(UserIndex, "No has logrado desequipar ningún item a tu oponente!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
        ...
        public static void DoHurtar(short UserIndex, short VictimaIndex)
        {
            ...
            if (res < 20)
            {
                if (InvUsuario.TieneObjetosRobables(VictimaIndex))
                {
                    ...
                    Protocol.WriteConsoleMsg(VictimaIndex, "¡" + Declaraciones.UserList[UserIndex].name + " es un Bandido!", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
                    Protocol.WriteConsoleMsg(UserIndex, Declaraciones.UserList[VictimaIndex].name + " no tiene objetos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void DoHandInmo(short UserIndex, short VictimaIndex)
        {
            ...
            if (res < Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Wrestling] / 4d)
            {
                ...
                Protocol.WriteConsoleMsg(UserIndex, "Tu golpe ha dejado inmóvil a tu oponente", Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(VictimaIndex, "¡El golpe te ha dejado inmóvil!", Protocol.FontTypeNames.FONTTYPE_INFO);
            }
        }
        ...
        public static short MaxItemsConstruibles(short UserIndex)
        {
            ...
            // 
            // ***************************************************
            MaxItemsConstruiblesRet = Convert.ToInt16(SistemaCombate.MaximoInt(1, Convert.ToInt32((Declaraciones.UserList[UserIndex].Stats.ELV - 4) / 5d)));
