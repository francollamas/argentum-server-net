...
Module Acciones
    ...
    Sub Accion(UserIndex As Short, Map As Short, X As Short, Y As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
        ...
        Try
            ...
            If _
                (Math.Abs(UserList(UserIndex).Pos.Y - Y) > RANGO_VISION_Y) Or
                (Math.Abs(UserList(UserIndex).Pos.X - X) > RANGO_VISION_X) Then
                Exit Sub
            End If
            ...
            If InMapBounds(Map, X, Y) Then
                With UserList(UserIndex)
                    If MapData(Map, X, Y).NpcIndex > 0 Then 'Acciones NPCs
                        ...
                        ElseIf _
                            Npclist(tempIndex).NPCtype = eNPCType.Revividor Or
                            Npclist(tempIndex).NPCtype = eNPCType.ResucitadorNewbie Then
                            ...
                            If _
                                .flags.Muerto = 1 And
                                (Npclist(tempIndex).NPCtype = eNPCType.Revividor Or EsNewbie(UserIndex)) Then
    ...
    Public Sub AccionParaForo(Map As Short, X As Short, Y As Short, UserIndex As Short)
        '***************************************************
        'Author: Unknown
    ...
    Sub AccionParaPuerta(Map As Short, X As Short, Y As Short, UserIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
        ...
        Try
            ...
            If Not (Distance(UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y, X, Y) > 2) Then
                ...
                Else
                    Call _
                        WriteConsoleMsg(UserIndex, "La puerta está cerrada con llave.", FontTypeNames.FONTTYPE_INFO)
                End If
            Else
    ...
    Sub AccionParaCartel(Map As Short, X As Short, Y As Short, UserIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Sub AccionParaRamita(Map As Short, X As Short, Y As Short, UserIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
        ...
        Try
            ...
            With UserList(UserIndex)
                ...
                If MapData(Map, X, Y).trigger = eTrigger.ZONASEGURA Or MapInfo_Renamed(Map).Pk = False Then
                    Call _
                ...
                If _
                    .Stats.UserSkills(eSkill.Supervivencia) > 1 And
                    .Stats.UserSkills(eSkill.Supervivencia) < 6 Then
                    Suerte = 3
                ElseIf _
                    .Stats.UserSkills(eSkill.Supervivencia) >= 6 And
