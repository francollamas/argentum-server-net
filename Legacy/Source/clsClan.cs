    ...
    internal class clsClan
    {
        ...
        public short PuntosAntifaccion
        {
            get
            {
                ...
                PuntosAntifaccionRet = Convert.ToInt16(Migration.ParseVal(ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Antifaccion", EmptySpaces: ref argEmptySpaces)));
                return PuntosAntifaccionRet;
            }
            set
            {
                ES.WriteVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Antifaccion", value.ToString());
            }
        }
        ...
        public string Fundador
        {
            get
            {
                ...
                int argEmptySpaces = 1024;
                FundadorRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Founder", EmptySpaces: ref argEmptySpaces);
                return FundadorRet;
            }
        }
        ...
        public short CantidadDeMiembros
        {
            get
            {
                ...
                string OldQ;
                int argEmptySpaces = 1024;
                OldQ = ES.GetVar(MEMBERSFILE, "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces);
        ...
        public short CantidadEnemys
        {
            get
            {
                ...
                for (i = 1; i <= loopTo; i++)
                    CantidadEnemysRet = (short)(CantidadEnemysRet + Convert.ToInt16(p_Relaciones[i] == modGuilds.RELACIONES_GUILD.GUERRA ? 1 : 0));
        ...
        public short CantidadAllies
        {
            get
            {
                ...
                var loopTo = modGuilds.CANTIDADDECLANES;
                for (i = 1; i <= loopTo; i++)
                    CantidadAlliesRet = (short)(CantidadAlliesRet + Convert.ToInt16(p_Relaciones[i] == modGuilds.RELACIONES_GUILD.ALIADOS ? 1 : 0));
        ...
        public void Inicializar(string GuildName, short GuildNumber, modGuilds.ALINEACION_GUILD Alineacion)
        {
            ...
            {
                int argEmptySpaces = 1024;
                p_Relaciones[i] = modGuilds.String2Relacion(ES.GetVar(RELACIONESFILE, "RELACIONES", i.ToString(), EmptySpaces: ref argEmptySpaces));
            }
            var loopTo1 = modGuilds.CANTIDADDECLANES;
            for (i = 1; i <= loopTo1; i++)
            {
                int argEmptySpaces2 = 1024;
                if (Strings.Trim(ES.GetVar(PROPUESTASFILE, i.ToString(), "Pendiente", EmptySpaces: ref argEmptySpaces2)) == "1")
                {
                    int argEmptySpaces1 = 1024;
                    switch (modGuilds.String2Relacion(Strings.Trim(ES.GetVar(PROPUESTASFILE, i.ToString(), "Tipo", EmptySpaces: ref argEmptySpaces1))))
                    {
                        case modGuilds.RELACIONES_GUILD.ALIADOS:
                            {
        ...
        public void InicializarNuevoClan(ref string Fundador)
        {
            ...
            int argEmptySpaces = 1024;
            OldQ = ES.GetVar(GUILDINFOFILE, "INIT", "nroguilds", EmptySpaces: ref argEmptySpaces);
        ...
        public string GetLeader()
        {
            ...
            int argEmptySpaces = 1024;
            GetLeaderRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Leader", EmptySpaces: ref argEmptySpaces);
            return GetLeaderRet;
        }
        ...
        public string[] GetMemberList()
        {
            ...
            {
                int argEmptySpaces = 1024;
                list[i - 1] = ES.GetVar(MEMBERSFILE, "Members", "Member" + i, EmptySpaces: ref argEmptySpaces).ToUpper();
            }
        ...
        public void ConectarMiembro(short UserIndex)
        {
...

            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToDiosesYclan, withBlock.GuildIndex, Protocol.PrepareMessageGuildChat(withBlock.name + " se ha conectado."));
            }
        }
        ...
        public void DesConectarMiembro(short UserIndex)
        {
            ...
            for (i = 0; i <= loopTo; i++)
            {
                ...
                if ((p_OnlineMembers[i] ?? "") == (UserIndex.ToString() ?? ""))
                {
                    ...
                    {
                        ref var withBlock = ref Declaraciones.UserList[UserIndex];
                        modSendData.SendData(modSendData.SendTarget.ToDiosesYclan, withBlock.GuildIndex, Protocol.PrepareMessageGuildChat(withBlock.name + " se ha desconectado."));
                    }
        ...
        public void AceptarNuevoMiembro(ref string Nombre)
        {
            ...
            if (System.IO.File.Exists(ruta))
            {
                ...
                int argEmptySpaces = 1024;
                OldQs = ES.GetVar(MEMBERSFILE, "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces);
        ...
        public void ExpulsarMiembro(ref string Nombre)
        {
            ...
            if (System.IO.File.Exists(Declaraciones.CharPath + Nombre + ".chr"))
            {
                int argEmptySpaces = 1024;
                OldQ = Convert.ToInt16(ES.GetVar(MEMBERSFILE, "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces));
                i = 1;
                Nombre = Nombre.ToUpper();
                int argEmptySpaces1 = 1024;
                while (i <= OldQ & (ES.GetVar(MEMBERSFILE, "Members", "Member" + i, EmptySpaces: ref argEmptySpaces1).Trim().ToUpper() ?? "") != (Nombre ?? ""))
                ...
                if (EsMiembro)
                {
                    ...
                    {
                        int argEmptySpaces2 = 1024;
                        Temps = ES.GetVar(MEMBERSFILE, "Members", "Member" + Convert.ToInt16(i + 1), EmptySpaces: ref argEmptySpaces2);
                    ...
                    MiembroDe = ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "GUILD", "Miembro", EmptySpaces: ref argEmptySpaces3);
                    if (!(MiembroDe.IndexOf(p_GuildName, StringComparison.OrdinalIgnoreCase) + 1 > 0))
                    {
                        if (Migration.migr_LenB(MiembroDe) != 0)
                        {
                            MiembroDe = MiembroDe + ",";
                        }
        ...
        public string[] GetAspirantes()
        {
            ...
            {
                int argEmptySpaces = 1024;
                list[i - 1] = ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + i, "Nombre", EmptySpaces: ref argEmptySpaces);
            }
        ...
        public short CantidadAspirantes()
        {
            ...
            int argEmptySpaces = 1024;
            Temps = ES.GetVar(SOLICITUDESFILE, "INIT", "CantSolicitudes", EmptySpaces: ref argEmptySpaces);
        ...
        public string DetallesSolicitudAspirante(short NroAspirante)
        {
            ...
            int argEmptySpaces = 1024;
            DetallesSolicitudAspiranteRet = ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + NroAspirante, "Detalle", EmptySpaces: ref argEmptySpaces);
        ...
        public short NumeroDeAspirante(ref string Nombre)
        {
            ...
            {
                int argEmptySpaces = 1024;
                if ((ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + i, "Nombre", EmptySpaces: ref argEmptySpaces).Trim().ToUpper() ?? "") == (Nombre.ToUpper() ?? ""))
                {
        ...
        public void NuevoAspirante(ref string Nombre, ref string Peticion)
        {
            ...
            int argEmptySpaces = 1024;
            OldQ = ES.GetVar(SOLICITUDESFILE, "INIT", "CantSolicitudes", EmptySpaces: ref argEmptySpaces);
            if (Information.IsNumeric(OldQ))
            {
            ...
            {
                int argEmptySpaces1 = 1024;
                if (string.IsNullOrEmpty(ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + i, "Nombre", EmptySpaces: ref argEmptySpaces1)))
                {
                    ES.WriteVar(SOLICITUDESFILE, "SOLICITUD" + i, "Nombre", Nombre);
                    ES.WriteVar(SOLICITUDESFILE, "SOLICITUD" + i, "Detalle", string.IsNullOrEmpty(Strings.Trim(Peticion)) ? "Peticion vacia" : Peticion);
        ...
        public void RetirarAspirante(ref string Nombre, ref short NroAspirante)
        {
            ...
            int argEmptySpaces1 = 1024;
            Pedidos = ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "GUILD", "Pedidos", EmptySpaces: ref argEmptySpaces1);
            if (!(Pedidos.IndexOf(p_GuildName, StringComparison.OrdinalIgnoreCase) + 1 > 0))
            {
                if (Migration.migr_LenB(Pedidos) != 0)
                {
                    Pedidos = Pedidos + ",";
                }
            ...
            {
                int argEmptySpaces2 = 1024;
                ES.WriteVar(SOLICITUDESFILE, "SOLICITUD" + i, "Nombre", ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + (i + 1), "Nombre", EmptySpaces: ref argEmptySpaces2));
                int argEmptySpaces3 = 1024;
                ES.WriteVar(SOLICITUDESFILE, "SOLICITUD" + i, "Detalle", ES.GetVar(SOLICITUDESFILE, "SOLICITUD" + (i + 1), "Detalle", EmptySpaces: ref argEmptySpaces3));
            }
        ...
        public string GetFechaFundacion()
        {
            ...
            int argEmptySpaces = 1024;
            GetFechaFundacionRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Date", EmptySpaces: ref argEmptySpaces);
        ...
        public string GetCodex(short CodexNumber)
        {
            ...
            int argEmptySpaces = 1024;
            GetCodexRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Codex" + CodexNumber, EmptySpaces: ref argEmptySpaces);
            return GetCodexRet;
        }
        ...
        public string GetURL()
        {
            ...
            int argEmptySpaces = 1024;
            GetURLRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "URL", EmptySpaces: ref argEmptySpaces);
            return GetURLRet;
        }
        ...
        public string GetGuildNews()
        {
            ...
            int argEmptySpaces = 1024;
            GetGuildNewsRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "GuildNews", EmptySpaces: ref argEmptySpaces);
        ...
        public string GetDesc()
        {
            ...
            int argEmptySpaces = 1024;
            GetDescRet = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "Desc", EmptySpaces: ref argEmptySpaces);
            return GetDescRet;
        }
        ...
        public bool EleccionesAbiertas()
        {
            ...
            string ee;
            int argEmptySpaces = 1024;
            ee = ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "EleccionesAbiertas", EmptySpaces: ref argEmptySpaces);
        ...
        public void ContabilizarVoto(ref string Votante, ref string Votado)
        {
            ...
            int argEmptySpaces = 1024;
            Temps = ES.GetVar(VOTACIONESFILE, "INIT", "NumVotos", EmptySpaces: ref argEmptySpaces);
        ...
        public bool YaVoto(ref string Votante)
        {
            ...
            int argEmptySpaces = 1024;
            YaVotoRet = Migration.migr_LenB(Strings.Trim(ES.GetVar(VOTACIONESFILE, "VOTOS", Votante, EmptySpaces: ref argEmptySpaces))) != 0;
            return YaVotoRet;
        }
        ...
        private string ContarVotos(ref short CantGanadores)
        {
            ...
            try
            {
                ...
                CantGanadores = 0;
                int argEmptySpaces = 1024;
                Temps = ES.GetVar(MEMBERSFILE, "INIT", "NroMembers", EmptySpaces: ref argEmptySpaces);
                q = Convert.ToInt16(Information.IsNumeric(Temps) ? Convert.ToInt16(Temps) : 0);
                if (q > 0)
                {
                    ...
                    for (i = 1; i <= loopTo; i++)
                    {
                        // miembro del clan
                        int argEmptySpaces1 = 1024;
                        Temps = ES.GetVar(MEMBERSFILE, "MEMBERS", "Member" + i, EmptySpaces: ref argEmptySpaces1);

                        // a quienvoto
                        int argEmptySpaces2 = 1024;
                        tempV = ES.GetVar(VOTACIONESFILE, "VOTOS", Temps, EmptySpaces: ref argEmptySpaces2);
                    ...
                    short maxVotes = -1;
                    short cantGan = 0;
                    string claveGanadora = Constants.vbNullString;
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "clsClan.Contarvotos: " + ex.Message;
        ...
        public bool RevisarElecciones()
        {
            ...
            int argEmptySpaces = 1024;
            Temps = Strings.Trim(ES.GetVar(GUILDINFOFILE, "GUILD" + p_GuildNumber, "EleccionesFinalizan", EmptySpaces: ref argEmptySpaces));
            ...
            if (Information.IsDate(Temps))
            {
                ...
                if (FechaSufragio < DateTime.Now) // toca!
                {
                    ...
                    if (CantGanadores > 1)
                    {
                        ...
                        string argNews = "*Empate en la votación. " + Ganador + " con " + CantGanadores + " votos ganaron las elecciones del clan.";
                    ...
                    else if (CantGanadores == 1)
                    {
                        ...
                        if (i <= list.Length - 1)
                        {
                            string argNews2 = "*" + Ganador + " ganó la elección del clan*";
                        ...
                        {
                            string argNews3 = "*" + Ganador + " ganó la elección del clan pero abandonó las filas por lo que la votación queda desierta*";
                            SetGuildNews(ref argNews3);
                        }
                    }
                    else
                    {
                        string argNews1 = "*El período de votación se cerró sin votos*";
            ...
            {
                string argdesc = "clsClan.RevisarElecciones: tempS is not Date";
                General.LogError(ref argdesc);
            }
        ...
        public string GetPropuesta(short OtroGuild, ref modGuilds.RELACIONES_GUILD Tipo)
        {
            ...
            int argEmptySpaces = 1024;
            GetPropuestaRet = ES.GetVar(PROPUESTASFILE, OtroGuild.ToString(), "Detalle", EmptySpaces: ref argEmptySpaces);
            int argEmptySpaces1 = 1024;
            Tipo = modGuilds.String2Relacion(ES.GetVar(PROPUESTASFILE, OtroGuild.ToString(), "Tipo", EmptySpaces: ref argEmptySpaces1));
        ...
        public short Iterador_ProximaRelacion(modGuilds.RELACIONES_GUILD r)
        {
            ...
            if (p_IteradorRelaciones >= Convert.ToInt16(p_Relaciones.Length - 1))
            {
                p_IteradorRelaciones = 0;
            }
        ...
        {
            if (Migration.migr_InStrB(S, "\r") != 0)
            {
                S = S.Replace("\r", Constants.vbNullString);
            }
