    ...
    static class UsUaRiOs
    {
        public static void ActStats(short VictimIndex, short AttackerIndex)
        {
...

            {
                ...
                Protocol.WriteMultiMessage(AttackerIndex, (short)Declaraciones.eMessages.HaveKilledUser, VictimIndex, DaExp);
                ...
                // Log
                string argtexto = withBlock.name + " asesino a " + Declaraciones.UserList[VictimIndex].name;
        ...
        public static void RevivirUsuario(short UserIndex)
        {
...

            {
                ...
                ChangeUserChar(UserIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, (byte)withBlock.Char_Renamed.heading, withBlock.Char_Renamed.WeaponAnim, withBlock.Char_Renamed.ShieldAnim, withBlock.Char_Renamed.CascoAnim);
        ...
        public static void ChangeUserChar(short UserIndex, short body, short Head, byte heading, short Arma, short Escudo, short casco)
        {
            // ***************************************************
            // Author: Unknown
            // Last Modification: -
            ...
            // ***************************************************
            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCharacterChange(body, Head, (Declaraciones.eHeading)heading, withBlock.CharIndex, Arma, Escudo, withBlock.FX, withBlock.loops, casco));
            }
        }
        ...
        public static void EraseUserChar(short UserIndex, bool IsAdminInvisible)
        {
            ...
            try
            {

                {
                    ...
                    if (IsAdminInvisible)
                    {
                        string argdatos = Protocol.PrepareMessageCharacterRemove(withBlock.Char_Renamed.CharIndex);
                        TCP.EnviarDatosASlot(UserIndex, ref argdatos);
                    }
                    else
                    {
                        // Le mandamos el mensaje para que borre el personaje a los clientes que estén cerca
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCharacterRemove(withBlock.Char_Renamed.CharIndex));
                    }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en EraseUserchar " + ex.GetType().Name + ": " + ex.Message;
        ...
        public static void RefreshCharStatus(short UserIndex)
        {
...

            {
                ...
                {
                    string argTag = Constants.vbNullString;
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageUpdateTagAndStatus(UserIndex, NickColor, ref argTag));
                }
        ...
        public static void MakeUserChar(bool toMap, short sndIndex, short UserIndex, short Map, short X, short Y, [Optional, DefaultParameterValue(false)] ref bool ButIndex)
        {
            // *************************************************
            // Author: Unknown
            // Last modified: 15/01/2010
                    ...
                    if (Extra.InMapBounds(Map, X, Y))
                    {
                        ...
                        if (!toMap)
                        {
                            ...
                            if (withBlock.showName)
                            {
                                ...
                                else if ((Declaraciones.UserList[sndIndex].flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero | Declaraciones.PlayerType.RoleMaster)) != 0)
                                {
                                    if (Migration.migr_LenB(ClanTag) != 0)
                                        UserName = UserName + " <" + ClanTag + ">";
                                }
                                else if ((withBlock.flags.invisible != 0 || withBlock.flags.Oculto != 0) && withBlock.flags.AdminInvisible != 1)
                                {
                            ...
                            Protocol.WriteCharacterCreate(sndIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, withBlock.Char_Renamed.heading, withBlock.Char_Renamed.CharIndex, Convert.ToByte(X), Convert.ToByte(Y), withBlock.Char_Renamed.WeaponAnim, withBlock.Char_Renamed.ShieldAnim, withBlock.Char_Renamed.FX, 999, withBlock.Char_Renamed.CascoAnim, UserName, NickColor, Privileges);
                        }
                        else
                        {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "MakeUserChar: num: " + ex.GetType().Name + " desc: " + ex.Message;
                General.LogError(ref argdesc);
        ...
        public static void CheckUserLevel(short UserIndex)
        {
            ...
            try
            {
...

                {
                    ...
                    while (withBlock.Stats.Exp >= withBlock.Stats.ELU)
                    {
                        ...
                        modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_NIVEL, Convert.ToByte(withBlock.Pos.X), Convert.ToByte(withBlock.Pos.Y)));
                        ...
                        Promedio = Declaraciones.ModVida[(int)withBlock.clase] - (21 - withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion]) * 0.5d;
                        ...
                        switch (withBlock.clase)
                        {
                            ...
                            case Declaraciones.eClass.Mage:
                                {
                                    AumentoHIT = 1;
                                    AumentoMANA = Convert.ToInt16(2.8d * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia]);
                            ...
                            case Declaraciones.eClass.Cleric:
                                {
                                    AumentoHIT = 2;
                                    AumentoMANA = Convert.ToInt16(2 * withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia]);
                                    AumentoSTA = Declaraciones.AumentoSTDef;
                                    break;
                                }
                            ...
                            case Declaraciones.eClass.Bandit:
                                {
                                    AumentoHIT = Convert.ToInt16(withBlock.Stats.ELV > 35 ? 1 : 3);
                                    AumentoMANA = Convert.ToInt16(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] / 3d * 2d);
                        ...
                        if (AumentoHP > 0)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Has ganado " + AumentoHP + " puntos de vida.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                        if (AumentoSTA > 0)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Has ganado " + AumentoSTA + " puntos de energía.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                        if (AumentoMANA > 0)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Has ganado " + AumentoMANA + " puntos de maná.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                        if (AumentoHIT > 0)
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Tu golpe máximo aumentó en " + AumentoHIT + " puntos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                            Protocol.WriteConsoleMsg(UserIndex, "Tu golpe mínimo aumentó en " + AumentoHIT + " puntos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }

                        General.LogDesarrollo(withBlock.name + " paso a nivel " + withBlock.Stats.ELV + " gano HP: " + AumentoHP);
                        ...
                        if (withBlock.Stats.ELV == 25)
                        {
                            ...
                            if (GI > 0)
                            {
                                if (modGuilds.GuildAlignment(GI) == "Del Mal" | modGuilds.GuildAlignment(GI) == "Real")
                                {
                                    ...
                                    modSendData.SendData(modSendData.SendTarget.ToGuildMembers, GI, Protocol.PrepareMessageConsoleMsg(withBlock.name + " deja el clan.", Protocol.FontTypeNames.FONTTYPE_GUILD));
                                    Protocol.WriteConsoleMsg(UserIndex, "¡Ya tienes la madurez suficiente como para decidir bajo que estandarte pelearás! Por esta razón, hasta tanto no te enlistes en la facción bajo la cual tu clan está alineado, estarás excluído del mismo.", Protocol.FontTypeNames.FONTTYPE_GUILD);
                                }
                            }
                        }
                    ...
                    if (!Extra.EsNewbie(UserIndex) & WasNewbie)
                    {
                        ...
                        if (Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Restringir.ToUpper() == "NEWBIE")
                        {
                            ...
                            Protocol.WriteConsoleMsg(UserIndex, "Debes abandonar el Dungeon Newbie.", Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                    }
                    ...
                    if (Pts > 0)
                    {
                        ...
                        Protocol.WriteConsoleMsg(UserIndex, "Has ganado un total de " + Pts + " skillpoints.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en la subrutina CheckUserLevel - Error : " + ex.GetType().Name + " - Description : " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static bool PuedeAtravesarAgua(short UserIndex)
        {
            ...
            PuedeAtravesarAguaRet = Declaraciones.UserList[UserIndex].flags.Navegando == 1 | Declaraciones.UserList[UserIndex].flags.Vuela == 1;
        ...
        public static void MoveUserChar(short UserIndex, Declaraciones.eHeading nHeading)
        {
                ...
                if (Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].NumUsers > 1)
                {
                    ...
                    if (CasperIndex > 0)
                    {
                        ...
                        if (!(Declaraciones.UserList[UserIndex].flags.AdminInvisible == 1))
                        {
                            ...
                            if (SistemaCombate.TriggerZonaPelea(UserIndex, CasperIndex) == Declaraciones.eTrigger6.TRIGGER6_PROHIBE)
                            {
                                if (Declaraciones.UserList[CasperIndex].flags.SeguroResu == false)
                                {
                                    Declaraciones.UserList[CasperIndex].flags.SeguroResu = true;
                                    Protocol.WriteMultiMessage(CasperIndex, (short)Declaraciones.eMessages.ResuscitationSafeOn);
                                }
                            }
...

                            {
                                ...
                                if (!(withBlock.flags.AdminInvisible == 1))
                                    modSendData.SendData(modSendData.SendTarget.ToPCAreaButIndex, CasperIndex, Protocol.PrepareMessageCharacterMove(withBlock.Char_Renamed.CharIndex, Convert.ToByte(CasPerPos.X), Convert.ToByte(CasPerPos.Y)));
                    ...
                    // Si es un admin invisible, no se avisa a los demas clientes
                    if (!(Declaraciones.UserList[UserIndex].flags.AdminInvisible == 1))
                        modSendData.SendData(modSendData.SendTarget.ToPCAreaButIndex, UserIndex, Protocol.PrepareMessageCharacterMove(Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex, Convert.ToByte(nPos.X), Convert.ToByte(nPos.Y)));
            ...
            if (Declaraciones.UserList[UserIndex].Counters.Trabajando != 0)
                Declaraciones.UserList[UserIndex].Counters.Trabajando = Declaraciones.UserList[UserIndex].Counters.Trabajando - 1;
        ...
        public static short NextOpenUser()
        {
            ...
            for (LoopC = 1; LoopC <= loopTo; LoopC++)
            {
                if (LoopC > Declaraciones.MaxUsers)
                    break;
                if (Declaraciones.UserList[LoopC].ConnID == -1 & Declaraciones.UserList[LoopC].flags.UserLogged == false)
                    break;
            }
        ...
        public static void SendUserStatsTxt(short sendIndex, short UserIndex)
        {
            ...
            {
                ref var withBlock = ref Declaraciones.UserList[UserIndex];
                Protocol.WriteConsoleMsg(sendIndex, "Estadísticas de: " + withBlock.name, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Nivel: " + withBlock.Stats.ELV + "  EXP: " + withBlock.Stats.Exp + "/" + withBlock.Stats.ELU, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Salud: " + withBlock.Stats.MinHp + "/" + withBlock.Stats.MaxHp + "  Maná: " + withBlock.Stats.MinMAN + "/" + withBlock.Stats.MaxMAN + "  Energía: " + withBlock.Stats.MinSta + "/" + withBlock.Stats.MaxSta, Protocol.FontTypeNames.FONTTYPE_INFO);

                if (withBlock.Invent.WeaponEqpObjIndex > 0)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Menor Golpe/Mayor Golpe: " + withBlock.Stats.MinHIT + "/" + withBlock.Stats.MaxHIT + " (" + Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].MinHIT + "/" + Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].MaxHIT + ")", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Menor Golpe/Mayor Golpe: " + withBlock.Stats.MinHIT + "/" + withBlock.Stats.MaxHIT, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                ...
                if (withBlock.Invent.ArmourEqpObjIndex > 0)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(sendIndex, "(CUERPO) Mín Def/Máx Def: " + (Declaraciones.ObjData_Renamed[withBlock.Invent.ArmourEqpObjIndex].MinDef + Declaraciones.ObjData_Renamed[withBlock.Invent.EscudoEqpObjIndex].MinDef) + "/" + (Declaraciones.ObjData_Renamed[withBlock.Invent.ArmourEqpObjIndex].MaxDef + Declaraciones.ObjData_Renamed[withBlock.Invent.EscudoEqpObjIndex].MaxDef), Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
                        Protocol.WriteConsoleMsg(sendIndex, "(CUERPO) Mín Def/Máx Def: " + Declaraciones.ObjData_Renamed[withBlock.Invent.ArmourEqpObjIndex].MinDef + "/" + Declaraciones.ObjData_Renamed[withBlock.Invent.ArmourEqpObjIndex].MaxDef, Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                }
                else
                {
                    Protocol.WriteConsoleMsg(sendIndex, "(CUERPO) Mín Def/Máx Def: 0", Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                if (withBlock.Invent.CascoEqpObjIndex > 0)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "(CABEZA) Mín Def/Máx Def: " + Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].MinDef + "/" + Declaraciones.ObjData_Renamed[withBlock.Invent.CascoEqpObjIndex].MaxDef, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
                    Protocol.WriteConsoleMsg(sendIndex, "(CABEZA) Mín Def/Máx Def: 0", Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                GuildI = withBlock.GuildIndex;
                if (GuildI > 0)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Clan: " + modGuilds.GuildName(GuildI), Protocol.FontTypeNames.FONTTYPE_INFO);
                ...
                TempSecs = withBlock.UpTime + Math.Abs(TempDate.Day - 30) * 24 * 3600 + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetHour(TempDate) * 3600 + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetMinute(TempDate) * 60 + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetSecond(TempDate);
                tempStr = TempSecs / 86400 + " Dias, " + TempSecs % 86400 / 3600 + " Horas, " + TempSecs % 86400 % 3600 / 60 + " Minutos, " + TempSecs % 86400 % 3600 % 60 + " Segundos.";
                Protocol.WriteConsoleMsg(sendIndex, "Logeado hace: " + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetHour(TempDate) + ":" + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetMinute(TempDate) + ":" + System.Threading.Thread.CurrentThread.CurrentCulture.Calendar.GetSecond(TempDate), Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Total: " + tempStr, Protocol.FontTypeNames.FONTTYPE_INFO);

                Protocol.WriteConsoleMsg(sendIndex, "Oro: " + withBlock.Stats.GLD + "  Posición: " + withBlock.Pos.X + "," + withBlock.Pos.Y + " en mapa " + withBlock.Pos.Map, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Dados: " + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] + ", " + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] + ", " + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] + ", " + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma] + ", " + withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion], Protocol.FontTypeNames.FONTTYPE_INFO);
            }
        }
        ...
        public static void SendUserMiniStatsTxt(short sendIndex, short UserIndex)
        {
            ...
            // *************************************************
            {
                ...
                Protocol.WriteConsoleMsg(sendIndex, "Ciudadanos matados: " + withBlock.Faccion.CiudadanosMatados + " Criminales matados: " + withBlock.Faccion.CriminalesMatados + " usuarios matados: " + withBlock.Stats.UsuariosMatados, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "NPCs muertos: " + withBlock.Stats.NPCsMuertos, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Clase: " + Declaraciones.ListaClases[(int)withBlock.clase], Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Pena: " + withBlock.Counters.Pena, Protocol.FontTypeNames.FONTTYPE_INFO);

                if (withBlock.Faccion.ArmadaReal == 1)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Ejército real desde: " + withBlock.Faccion.FechaIngreso, Protocol.FontTypeNames.FONTTYPE_INFO);
                    Protocol.WriteConsoleMsg(sendIndex, "Ingresó en nivel: " + withBlock.Faccion.NivelIngreso + " con " + withBlock.Faccion.MatadosIngreso + " ciudadanos matados.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + withBlock.Faccion.Reenlistadas, Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                else if (withBlock.Faccion.FuerzasCaos == 1)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Legión oscura desde: " + withBlock.Faccion.FechaIngreso, Protocol.FontTypeNames.FONTTYPE_INFO);
                    Protocol.WriteConsoleMsg(sendIndex, "Ingresó en nivel: " + withBlock.Faccion.NivelIngreso, Protocol.FontTypeNames.FONTTYPE_INFO);
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + withBlock.Faccion.Reenlistadas, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                ...
                Protocol.WriteConsoleMsg(sendIndex, "Asesino: " + withBlock.Reputacion.AsesinoRep, Protocol.FontTypeNames.FONTTYPE_INFO);
                Protocol.WriteConsoleMsg(sendIndex, "Noble: " + withBlock.Reputacion.NobleRep, Protocol.FontTypeNames.FONTTYPE_INFO);

                if (withBlock.GuildIndex > 0)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Clan: " + modGuilds.GuildName(withBlock.GuildIndex), Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void SendUserMiniStatsTxtFromChar(short sendIndex, string charName)
        {
            ...
            if (System.IO.File.Exists(CharFile))
            {
                ...
                Protocol.WriteConsoleMsg(sendIndex, "Ciudadanos matados: " + ES.GetVar(CharFile, "FACCIONES", "CiudMatados", EmptySpaces: ref argEmptySpaces) + " CriminalesMatados: " + ES.GetVar(CharFile, "FACCIONES", "CrimMatados", EmptySpaces: ref argEmptySpaces1) + " usuarios matados: " + ES.GetVar(CharFile, "MUERTES", "UserMuertes", EmptySpaces: ref argEmptySpaces2), Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces3 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "NPCs muertos: " + ES.GetVar(CharFile, "MUERTES", "NpcsMuertes", EmptySpaces: ref argEmptySpaces3), Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces4 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Clase: " + Declaraciones.ListaClases[Convert.ToInt32(ES.GetVar(CharFile, "INIT", "Clase", EmptySpaces: ref argEmptySpaces4))], Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces5 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Pena: " + ES.GetVar(CharFile, "COUNTERS", "PENA", EmptySpaces: ref argEmptySpaces5), Protocol.FontTypeNames.FONTTYPE_INFO);

                int argEmptySpaces15 = 1024;
                int argEmptySpaces16 = 1024;
                int argEmptySpaces17 = 1024;
                int argEmptySpaces18 = 1024;
                if (Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "EjercitoReal", EmptySpaces: ref argEmptySpaces15)) == 1)
                {
                    int argEmptySpaces6 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Ejército real desde: " + ES.GetVar(CharFile, "FACCIONES", "FechaIngreso", EmptySpaces: ref argEmptySpaces6), Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces7 = 1024;
                    int argEmptySpaces8 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Ingresó en nivel: " + Convert.ToInt16(ES.GetVar(CharFile, "FACCIONES", "NivelIngreso", EmptySpaces: ref argEmptySpaces7)) + " con " + Convert.ToInt16(ES.GetVar(CharFile, "FACCIONES", "MatadosIngreso", EmptySpaces: ref argEmptySpaces8)) + " ciudadanos matados.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces9 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "Reenlistadas", EmptySpaces: ref argEmptySpaces9)), Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                else if (Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "EjercitoCaos", EmptySpaces: ref argEmptySpaces16)) == 1)
                {
                    int argEmptySpaces10 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Legión oscura desde: " + ES.GetVar(CharFile, "FACCIONES", "FechaIngreso", EmptySpaces: ref argEmptySpaces10), Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces11 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Ingresó en nivel: " + Convert.ToInt16(ES.GetVar(CharFile, "FACCIONES", "NivelIngreso", EmptySpaces: ref argEmptySpaces11)), Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces12 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "Reenlistadas", EmptySpaces: ref argEmptySpaces12)), Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                else if (Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "rExReal", EmptySpaces: ref argEmptySpaces17)) == 1)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Fue ejército real", Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces13 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "Reenlistadas", EmptySpaces: ref argEmptySpaces13)), Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                else if (Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "rExCaos", EmptySpaces: ref argEmptySpaces18)) == 1)
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Fue legión oscura", Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces14 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Veces que ingresó: " + Convert.ToByte(ES.GetVar(CharFile, "FACCIONES", "Reenlistadas", EmptySpaces: ref argEmptySpaces14)), Protocol.FontTypeNames.FONTTYPE_INFO);
                }


                int argEmptySpaces19 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Asesino: " + Convert.ToInt32(ES.GetVar(CharFile, "REP", "Asesino", EmptySpaces: ref argEmptySpaces19)), Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces20 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Noble: " + Convert.ToInt32(ES.GetVar(CharFile, "REP", "Nobles", EmptySpaces: ref argEmptySpaces20)), Protocol.FontTypeNames.FONTTYPE_INFO);

                int argEmptySpaces22 = 1024;
                if (Information.IsNumeric(ES.GetVar(CharFile, "Guild", "GUILDINDEX", EmptySpaces: ref argEmptySpaces22)))
                {
                    int argEmptySpaces21 = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Clan: " + modGuilds.GuildName(Convert.ToInt16(ES.GetVar(CharFile, "Guild", "GUILDINDEX", EmptySpaces: ref argEmptySpaces21))), Protocol.FontTypeNames.FONTTYPE_INFO);
                }

                int argEmptySpaces23 = 1024;
                Ban = ES.GetVar(CharFile, "FLAGS", "Ban", EmptySpaces: ref argEmptySpaces23);
                ...
                if (Ban == "1")
                {
                    ...
                    Protocol.WriteConsoleMsg(sendIndex, "Ban por: " + ES.GetVar(CharFile, charName, "BannedBy", EmptySpaces: ref argEmptySpaces24) + " Motivo: " + ES.GetVar(BanDetailPath, charName, "Reason", EmptySpaces: ref argEmptySpaces25), Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
            else
            {
        ...
        public static void SendUserInvTxt(short sendIndex, short UserIndex)
        {
            ...
            try
            {
...

                {
                    ...
                    Protocol.WriteConsoleMsg(sendIndex, "Tiene " + withBlock.Invent.NroItems + " objetos.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    for (j = 1; j <= loopTo; j++)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(sendIndex, "Objeto " + j + " " + Declaraciones.ObjData_Renamed[withBlock.Invent.Object_Renamed[j].ObjIndex].name + " Cantidad:" + withBlock.Invent.Object_Renamed[j].Amount, Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                    }
                }
            }
        ...
        public static void SendUserInvTxtFromChar(short sendIndex, string charName)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(CharFile))
                {
                    ...
                    int argEmptySpaces = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Tiene " + ES.GetVar(CharFile, "Inventory", "CantidadItems", EmptySpaces: ref argEmptySpaces) + " objetos.", Protocol.FontTypeNames.FONTTYPE_INFO);

                    for (j = 1; j <= Declaraciones.MAX_INVENTORY_SLOTS; j++)
                    {
                        int argEmptySpaces1 = 1024;
                        Tmp = ES.GetVar(CharFile, "Inventory", "Obj" + j, EmptySpaces: ref argEmptySpaces1);
                        ...
                        if (ObjInd > 0)
                        {
                            Protocol.WriteConsoleMsg(sendIndex, "Objeto " + j + " " + Declaraciones.ObjData_Renamed[ObjInd].name + " Cantidad:" + ObjCant, Protocol.FontTypeNames.FONTTYPE_INFO);
                        }
                    }
                }
                else
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Usuario inexistente: " + charName, Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        ...
        public static void SendUserSkillsTxt(short sendIndex, short UserIndex)
        {
            ...
            try
            {
                ...
                Protocol.WriteConsoleMsg(sendIndex, Declaraciones.UserList[UserIndex].name, Protocol.FontTypeNames.FONTTYPE_INFO);

                for (j = 1; j <= Declaraciones.NUMSKILLS; j++)
                    Protocol.WriteConsoleMsg(sendIndex, Declaraciones.SkillsNames[j] + " = " + Declaraciones.UserList[UserIndex].Stats.UserSkills[j], Protocol.FontTypeNames.FONTTYPE_INFO);

                Protocol.WriteConsoleMsg(sendIndex, "SkillLibres:" + Declaraciones.UserList[UserIndex].Stats.SkillPts, Protocol.FontTypeNames.FONTTYPE_INFO);
            }
        ...
        private static bool EsMascotaCiudadano(short NpcIndex, short UserIndex)
        {
            ...
            if (Declaraciones.Npclist[NpcIndex].MaestroUser > 0)
            {
                ...
                {
                    Protocol.WriteConsoleMsg(Declaraciones.Npclist[NpcIndex].MaestroUser, "¡¡" + Declaraciones.UserList[UserIndex].name + " esta atacando tu mascota!!", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        ...
        public static void NPCAtacado(short NpcIndex, short UserIndex)
        {
            ...
            else
            {
                ...
                {
                    Declaraciones.UserList[UserIndex].Reputacion.PlebeRep = Declaraciones.UserList[UserIndex].Reputacion.PlebeRep + Convert.ToInt32(Declaraciones.vlCAZADOR / 2d);
        ...
        public static bool PuedeApuñalar(short UserIndex)
        {
            ...
            if (Declaraciones.UserList[UserIndex].Invent.WeaponEqpObjIndex > 0)
            {
                ...
                {
                    PuedeApuñalarRet = Declaraciones.UserList[UserIndex].Stats.UserSkills[(int)Declaraciones.eSkill.Apuñalar] >= Declaraciones.MIN_APUÑALAR | Declaraciones.UserList[UserIndex].clase == Declaraciones.eClass.Assasin;
                }
            }
        ...
        public static bool PuedeAcuchillar(short UserIndex)
        {
...

            {
                ...
                if (withBlock.clase == Declaraciones.eClass.Pirat)
                {
                    if (withBlock.Invent.WeaponEqpObjIndex > 0)
                    {
                        PuedeAcuchillarRet = Declaraciones.ObjData_Renamed[withBlock.Invent.WeaponEqpObjIndex].Acuchilla == 1;
                    }
                }
            }
            ...
            short Lvl;
            {
                ...
                if (withBlock.flags.Hambre == 0 & withBlock.flags.Sed == 0)
                {
                    if (withBlock.Counters.AsignedSkills < 10)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "Para poder entrenar un skill debes asignar los 10 skills iniciales.", Protocol.FontTypeNames.FONTTYPE_INFO);
...

                    {
                        ...
                        if (withBlock1.ExpSkills[Skill] >= withBlock1.EluSkills[Skill])
                        {
                            ...
                            Protocol.WriteConsoleMsg(UserIndex, "¡Has mejorado tu skill " + Declaraciones.SkillsNames[Skill] + " en un punto! Ahora tienes " + withBlock1.UserSkills[Skill] + " pts.", Protocol.FontTypeNames.FONTTYPE_INFO);

                            withBlock1.Exp = withBlock1.Exp + 50d;
                            if (withBlock1.Exp > Declaraciones.MAXEXP)
                                withBlock1.Exp = Declaraciones.MAXEXP;

                            Protocol.WriteConsoleMsg(UserIndex, "¡Has ganado 50 puntos de experiencia!", Protocol.FontTypeNames.FONTTYPE_FIGHT);
        ...
        public static void UserDie(short UserIndex)
        {
            ...
            try
            {
...

                {
                    ...
                    {
                        Declaraciones.SonidosMapas.ReproducirSonido(modSendData.SendTarget.ToPCArea, UserIndex, Convert.ToInt16((int)SoundMapInfo.e_SoundIndex.MUERTE_MUJER));
                    }
                    else
                    {
                        Declaraciones.SonidosMapas.ReproducirSonido(modSendData.SendTarget.ToPCArea, UserIndex, Convert.ToInt16((int)SoundMapInfo.e_SoundIndex.MUERTE_HOMBRE));
                    }

                    // Quitar el dialogo del user muerto
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageRemoveCharDialog(withBlock.Char_Renamed.CharIndex));
                    ...
                    if (withBlock.flags.TomoPocion == true)
                    {
                        for (i = 1; i <= 5; i++)
                    ...
                    ChangeUserChar(UserIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, (byte)withBlock.Char_Renamed.heading, Declaraciones.NingunArma, Declaraciones.NingunEscudo, Declaraciones.NingunCasco);
                    Protocol.WriteUpdateUserStats(UserIndex);
                    Protocol.WriteUpdateStrenghtAndDexterity(UserIndex);
                    // <<Castigos por party>>
                    if (withBlock.PartyIndex > 0)
                    {
                        mdParty.ObtenerExito(UserIndex, withBlock.Stats.ELV * -10 * mdParty.CantMiembros(UserIndex), ref withBlock.Pos.Map, ref withBlock.Pos.X, ref withBlock.Pos.Y);
                    }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en SUB USERDIE. Error: " + ex.GetType().Name + " Descripción: " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void ContarMuerte(short Muerto, short Atacante)
        {
...

            {
                ...
                if (ES.criminal(Muerto))
                {
                    ...
                    if (withBlock.Faccion.RecibioExpInicialCaos == 1 & Declaraciones.UserList[Muerto].Faccion.FuerzasCaos == 1)
                    {
        ...
        public static void Tilelibre(ref Declaraciones.WorldPos Pos, ref Declaraciones.WorldPos nPos, ref Declaraciones.Obj Obj, ref bool Agua, ref bool Tierra)
        {
            // **************************************************************
            // Author: Unknown
                ...
                for (tY = Pos.Y - LoopC; tY <= loopTo; tY++)
                {
                    ...
                    for (tX = Pos.X - LoopC; tX <= loopTo1; tX++)
                    {
                        ...
                        if (Extra.LegalPos(nPos.Map, Convert.ToInt16(tX), Convert.ToInt16(tY), Agua, Tierra))
                        {
                            ...
                            hayobj = Declaraciones.MapData[nPos.Map, tX, tY].ObjInfo.ObjIndex > 0 & Declaraciones.MapData[nPos.Map, tX, tY].ObjInfo.ObjIndex != Obj.ObjIndex;
                            if (!hayobj)
                                hayobj = (short)(Declaraciones.MapData[nPos.Map, tX, tY].ObjInfo.Amount + Obj.Amount) > Declaraciones.MAX_INVENTORY_OBJS;
        ...
        public static void WarpUserChar(short UserIndex, short Map, short X, short Y, bool FX, bool Teletransported = false)
        {
            ...
            bool previousMap;
            {
                ...
                if (OldMap != Map)
                {
                    ...
                    Protocol.WritePlayMidi(UserIndex, Convert.ToByte(Migration.ParseVal(General.ReadField(1, ref Declaraciones.MapInfo_Renamed[Map].Music, 45))));

                    // Update new Map Users
                    Declaraciones.MapInfo_Renamed[Map].NumUsers = Convert.ToInt16(Declaraciones.MapInfo_Renamed[Map].NumUsers + 1);

                    // Update old Map Users
                    Declaraciones.MapInfo_Renamed[OldMap].NumUsers = Convert.ToInt16(Declaraciones.MapInfo_Renamed[OldMap].NumUsers - 1);
                    ...
                    previousMap = Declaraciones.distanceToCities[withBlock.Pos.Map].distanceToCity[(int)withBlock.Hogar] >= 0 ? true : false;
                ...
                bool argButIndex = false;
                MakeUserChar(true, Map, UserIndex, Map, X, Y, ButIndex: ref argButIndex);
                ...
                if ((withBlock.flags.invisible == 1 | withBlock.flags.Oculto == 1) & !(withBlock.flags.AdminInvisible == 1))
                {
                    SetInvisible(UserIndex, withBlock.Char_Renamed.CharIndex, true);
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessagePlayWave(Declaraciones.SND_WARP, Convert.ToByte(X), Convert.ToByte(Y)));
                    modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(withBlock.Char_Renamed.CharIndex, (short)Declaraciones.FXIDs.FXWARP, 0));
                }
        ...
        private static void WarpMascotas(short UserIndex)
        {
            ...
            canWarp = Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Pk == true;
            ...
            for (i = 1; i <= Declaraciones.MAXMASCOTAS; i++)
            {
                ...
                if (petType > 0 & canWarp)
                {
                    ...
                    if (Index == 0)
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Tus mascotas no pueden transitar este mapa.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    }
                    else
                    {
                        ...
                        Declaraciones.Npclist[Index].Stats.MinHp = iMinHP == 0 ? Declaraciones.Npclist[Index].Stats.MinHp : Convert.ToInt32(iMinHP);
            ...
            {
                Protocol.WriteConsoleMsg(UserIndex, "Pierdes el control de tus mascotas invocadas.", Protocol.FontTypeNames.FONTTYPE_INFO);
            }

            if (!canWarp)
            {
                Protocol.WriteConsoleMsg(UserIndex, "No se permiten mascotas en zona segura. Éstas te esperarán afuera.", Protocol.FontTypeNames.FONTTYPE_INFO);
            }
        ...
        public static void WarpMascota(short UserIndex, short PetIndex)
        {
...

            {
                ...
                if (NpcIndex == 0)
                {
                    Protocol.WriteConsoleMsg(UserIndex, "Tu mascota no pueden transitar este sector del mapa, intenta invocarla en otra parte.", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
        ...
        public static void Cerrar_Usuario(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.UserLogged & !withBlock.Counters.Saliendo)
                {
                    ...
                    withBlock.Counters.salir = Convert.ToInt16((withBlock.flags.Privilegios & Declaraciones.PlayerType.User) != 0 && Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk ? Admin.IntervaloCerrarConexion : 0);
                    ...
                    if (isNotVisible)
                    {
                        ...
                        if (withBlock.flags.Oculto != 0)
                        {
                            if (withBlock.flags.Navegando == 1)
                            {
                                if (withBlock.clase == Declaraciones.eClass.Pirat)
                                {
                                    ...
                                    ToogleBoatBody(UserIndex);
                                    Protocol.WriteConsoleMsg(UserIndex, "¡Has recuperado tu apariencia normal!", Protocol.FontTypeNames.FONTTYPE_INFO);
                                    ChangeUserChar(UserIndex, withBlock.Char_Renamed.body, withBlock.Char_Renamed.Head, (byte)withBlock.Char_Renamed.heading, Declaraciones.NingunArma, Declaraciones.NingunEscudo, Declaraciones.NingunCasco);
                                    HiddenPirat = true;
                                }
                            }
                        ...
                        if (!HiddenPirat)
                            Protocol.WriteConsoleMsg(UserIndex, "Has vuelto a ser visible.", Protocol.FontTypeNames.FONTTYPE_INFO);
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "Cerrando...Se cerrará el juego en " + withBlock.Counters.salir + " segundos...", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
            }
        }
        ...
        public static void CancelExit(short UserIndex)
        {
            ...
            if (Declaraciones.UserList[UserIndex].Counters.Saliendo)
            {
                ...
                {
                    // Simply reset
                    Declaraciones.UserList[UserIndex].Counters.salir = Convert.ToInt16((Declaraciones.UserList[UserIndex].flags.Privilegios & Declaraciones.PlayerType.User) != 0 && Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Pk ? Admin.IntervaloCerrarConexion : 0);
                }
            }
        }
        ...
        public static void CambiarNick(short UserIndex, short UserIndexDestino, string NuevoNick)
        {
            ...
            if (System.IO.File.Exists(Declaraciones.CharPath + ViejoNick + ".chr"))
            {
        ...
        public static void SendUserStatsTxtOFF(short sendIndex, string Nombre)
        {
            ...
            int TempSecs;
            string tempStr;
            if (System.IO.File.Exists(Declaraciones.CharPath + Nombre + ".chr") == false)
            {
            ...
            else
            {
                ...
                int argEmptySpaces1 = 1024;
                int argEmptySpaces2 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Nivel: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "elv", EmptySpaces: ref argEmptySpaces) + "  EXP: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "Exp", EmptySpaces: ref argEmptySpaces1) + "/" + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "elu", EmptySpaces: ref argEmptySpaces2), Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces3 = 1024;
                int argEmptySpaces4 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Energía: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "minsta", EmptySpaces: ref argEmptySpaces3) + "/" + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "maxSta", EmptySpaces: ref argEmptySpaces4), Protocol.FontTypeNames.FONTTYPE_INFO);
                int argEmptySpaces5 = 1024;
                int argEmptySpaces6 = 1024;
                int argEmptySpaces7 = 1024;
                int argEmptySpaces8 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Salud: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "MinHP", EmptySpaces: ref argEmptySpaces5) + "/" + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "Stats", "MaxHP", EmptySpaces: ref argEmptySpaces6) + "  Maná: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "Stats", "MinMAN", EmptySpaces: ref argEmptySpaces7) + "/" + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "Stats", "MaxMAN", EmptySpaces: ref argEmptySpaces8), Protocol.FontTypeNames.FONTTYPE_INFO);

                int argEmptySpaces9 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Menor Golpe/Mayor Golpe: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "MaxHIT", EmptySpaces: ref argEmptySpaces9), Protocol.FontTypeNames.FONTTYPE_INFO);

                int argEmptySpaces10 = 1024;
                Protocol.WriteConsoleMsg(sendIndex, "Oro: " + ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "stats", "GLD", EmptySpaces: ref argEmptySpaces10), Protocol.FontTypeNames.FONTTYPE_INFO);

                int argEmptySpaces11 = 1024;
                TempSecs = Convert.ToInt32(ES.GetVar(Declaraciones.CharPath + Nombre + ".chr", "INIT", "UpTime", EmptySpaces: ref argEmptySpaces11));
                tempStr = TempSecs / 86400 + " Días, " + TempSecs % 86400 / 3600 + " Horas, " + TempSecs % 86400 % 3600 / 60 + " Minutos, " + TempSecs % 86400 % 3600 % 60 + " Segundos.";
        ...
        public static void SendUserOROTxtFromChar(short sendIndex, string charName)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(CharFile))
                {
                    Protocol.WriteConsoleMsg(sendIndex, charName, Protocol.FontTypeNames.FONTTYPE_INFO);
                    int argEmptySpaces = 1024;
                    Protocol.WriteConsoleMsg(sendIndex, "Tiene " + ES.GetVar(CharFile, "STATS", "BANCO", EmptySpaces: ref argEmptySpaces) + " en el banco.", Protocol.FontTypeNames.FONTTYPE_INFO);
                }
                else
                {
                    Protocol.WriteConsoleMsg(sendIndex, "Usuario inexistente: " + charName, Protocol.FontTypeNames.FONTTYPE_INFO);
        ...
        public static void VolverCriminal(short UserIndex)
        {
            ...
            {
                ref var withBlock = ref Declaraciones.UserList[UserIndex];
                if (Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].trigger == Declaraciones.eTrigger.ZONAPELEA)
                    return;
                ...
                if ((withBlock.flags.Privilegios & (Declaraciones.PlayerType.User | Declaraciones.PlayerType.Consejero)) != 0)
                {
                    ...
                    if (withBlock.Faccion.ArmadaReal == 1)
                    {
                        ...
                        ModFacciones.ExpulsarFaccionReal(UserIndex, Expulsado: ref argExpulsado);
                    }
        ...
        public static bool BodyIsBoat(short body)
        {
            ...
            if (body == Declaraciones.iFragataReal | body == Declaraciones.iFragataCaos | body == Declaraciones.iBarcaPk | body == Declaraciones.iGaleraPk | body == Declaraciones.iGaleonPk | body == Declaraciones.iBarcaCiuda | body == Declaraciones.iGaleraCiuda | body == Declaraciones.iGaleonCiuda | body == Declaraciones.iFragataFantasmal)
            {
                BodyIsBoatRet = true;
            }
        ...
        public static void SetInvisible(short UserIndex, short userCharIndex, bool invisible)
        {
            ...
            {
                ref var withBlock = ref Declaraciones.UserList[UserIndex];
                modSendData.SendData(modSendData.SendTarget.ToUsersAndRmsAndCounselorsAreaButGMs, UserIndex, Protocol.PrepareMessageSetInvisible(userCharIndex, invisible));
                ...
                modSendData.SendData(modSendData.SendTarget.ToGMsAreaButRmsOrCounselors, UserIndex, Protocol.PrepareMessageCharacterChangeNick(userCharIndex, sndNick));
            }
        }
        ...
        public static void SetConsulatMode(short UserIndex)
        {
...

            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCharacterChangeNick(withBlock.Char_Renamed.CharIndex, sndNick));
            }
        }
        ...
        public static bool SameFaccion(short UserIndex, short OtherUserIndex)
        {
            ...
            // **************************************************************
            SameFaccionRet = Extra.esCaos(UserIndex) & Extra.esCaos(OtherUserIndex) | Extra.esArmada(UserIndex) & Extra.esArmada(OtherUserIndex);
        ...
        public static short FarthestPet(short UserIndex)
        {
                        ...
                        if (withBlock.MascotasIndex[PetIndex] > 0)
                        {
                            ...
                            if (Declaraciones.Npclist[withBlock.MascotasIndex[PetIndex]].Contadores.TiempoExistencia == 0)
                            {
                                if (FarthestPetRet == 0)
                                {
                                    ...
                                    Distancia = (short)(Math.Abs((short)(withBlock.Pos.X - Declaraciones.Npclist[withBlock.MascotasIndex[PetIndex]].Pos.X)) + Math.Abs((short)(withBlock.Pos.Y - Declaraciones.Npclist[withBlock.MascotasIndex[PetIndex]].Pos.Y)));
                                }
                                else
                                {
                                    // La distancia de la proxima mascota
                                    OtraDistancia = (short)(Math.Abs((short)(withBlock.Pos.X - Declaraciones.Npclist[withBlock.MascotasIndex[PetIndex]].Pos.X)) + Math.Abs((short)(withBlock.Pos.Y - Declaraciones.Npclist[withBlock.MascotasIndex[PetIndex]].Pos.Y)));
                                    // Esta mas lejos?
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en FarthestPet";
                General.LogError(ref argdesc);
            }
        ...
        public static void CheckEluSkill(short UserIndex, byte Skill, bool Allocation)
        {
...

            {
                ...
                if (withBlock.UserSkills[Skill] < Declaraciones.MAXSKILLPOINTS)
                {
                    ...
                    withBlock.EluSkills[Skill] = Convert.ToInt32(Declaraciones.ELU_SKILL_INICIAL * Math.Pow(1.05d, withBlock.UserSkills[Skill]));
                }
                else
                {
                    withBlock.ExpSkills[Skill] = 0;
        ...
        public static byte getMaxInventorySlots(short UserIndex)
        {
            ...
            {
                getMaxInventorySlotsRet = Convert.ToByte(Declaraciones.MAX_NORMAL_INVENTORY_SLOTS + Declaraciones.ObjData_Renamed[Declaraciones.UserList[UserIndex].Invent.MochilaEqpObjIndex].MochilaType * 5);
            }
        ...
        public static void goHome(short UserIndex)
        {
...

            {
                ...
                if (withBlock.flags.Muerto == 1)
                {
                    ...
                    {
                        Distance = (short)(Declaraciones.distanceToCities[withBlock.flags.lastMap].distanceToCity[(int)withBlock.Hogar] + Declaraciones.GOHOME_PENALTY);
                    }
                    ...
                    Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.Home, Distance, tiempo, StringArg1: Declaraciones.MapInfo_Renamed[Declaraciones.Ciudades[(int)withBlock.Hogar].Map].name);
                }
                else
                {
                    Protocol.WriteConsoleMsg(UserIndex, "Debes estar muerto para poder utilizar este comando.", Protocol.FontTypeNames.FONTTYPE_FIGHT);
                }
            }
        }
...

            {
                ...
                if (AtacablePor > 0)
                {
                    ...
                    if (StealingNpc)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(UserIndex, "No puedes atacar otra criatura con dueño hasta que haya terminado tu castigo.", Protocol.FontTypeNames.FONTTYPE_INFO);
        ...
        public static void setHome(short UserIndex, Declaraciones.eCiudad newHome, short NpcIndex)
        {
            ...
            Protocol.WriteChatOverHead(UserIndex, "¡¡¡Bienvenido a nuestra humilde comunidad, este es ahora tu nuevo hogar!!!", Declaraciones.Npclist[NpcIndex].Char_Renamed.CharIndex, ColorTranslator.ToOle(Color.White));
        }
    }
}