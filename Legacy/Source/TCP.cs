...
namespace Legacy
{
    ...
    static class TCP
    {
                ...
                case (byte)Declaraciones.eGenero.Hombre:
                    {
                        switch (UserRaza)
                        {
                            case (byte)Declaraciones.eRaza.Humano:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.HUMANO_H_PRIMER_CABEZA & Head <= Declaraciones.HUMANO_H_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Elfo:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.ELFO_H_PRIMER_CABEZA & Head <= Declaraciones.ELFO_H_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Drow:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.DROW_H_PRIMER_CABEZA & Head <= Declaraciones.DROW_H_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Enano:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.ENANO_H_PRIMER_CABEZA & Head <= Declaraciones.ENANO_H_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Gnomo:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.GNOMO_H_PRIMER_CABEZA & Head <= Declaraciones.GNOMO_H_ULTIMA_CABEZA;
                                    break;
                                }
                        }
                ...
                case (byte)Declaraciones.eGenero.Mujer:
                    {
                        switch (UserRaza)
                        {
                            case (byte)Declaraciones.eRaza.Humano:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.HUMANO_M_PRIMER_CABEZA & Head <= Declaraciones.HUMANO_M_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Elfo:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.ELFO_M_PRIMER_CABEZA & Head <= Declaraciones.ELFO_M_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Drow:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.DROW_M_PRIMER_CABEZA & Head <= Declaraciones.DROW_M_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Enano:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.ENANO_M_PRIMER_CABEZA & Head <= Declaraciones.ENANO_M_ULTIMA_CABEZA;
                                    break;
                                }
                            case (byte)Declaraciones.eRaza.Gnomo:
                                {
                                    ValidarCabezaRet = Head >= Declaraciones.GNOMO_M_PRIMER_CABEZA & Head <= Declaraciones.GNOMO_M_ULTIMA_CABEZA;
                                    break;
                                }
                        }
        ...
        public static void ConnectNewUser(short UserIndex, ref string name, ref string Password, Declaraciones.eRaza UserRaza, Declaraciones.eGenero UserSexo, Declaraciones.eClass UserClase, ref string UserEmail, Declaraciones.eCiudad Hogar, short Head)
        {
            // *************************************************
            // Author: Unknown
            ...
            bool IsPaladin;
            {
                ...
                {
                    string argtexto = "El usuario " + Declaraciones.UserList[UserIndex].name + " ha intentado crear a " + name + " desde la IP " + Declaraciones.UserList[UserIndex].ip;
                ...
                // ¿Existe el personaje?
                if (System.IO.File.Exists(Declaraciones.CharPath + name.ToUpper() + ".chr") == true)
                {
                ...
                {
                    string argtexto1 = "El usuario " + name + " ha seleccionado la cabeza " + Head + " desde la IP " + withBlock.ip;
                ...
                withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Fuerza] + Declaraciones.ModRaza_Renamed[(int)UserRaza].Fuerza);
                withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] + Declaraciones.ModRaza_Renamed[(int)UserRaza].Agilidad);
                withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Inteligencia] + Declaraciones.ModRaza_Renamed[(int)UserRaza].Inteligencia);
                withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Carisma] + Declaraciones.ModRaza_Renamed[(int)UserRaza].Carisma);
                withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion] = Convert.ToByte(withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion] + Declaraciones.ModRaza_Renamed[(int)UserRaza].Constitucion);
                // [/Pablo (Toxic Waste)]
                ...
                MiInt = Matematicas.RandomNumber(1, withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Constitucion] / 3);

                withBlock.Stats.MaxHp = Convert.ToInt16(15 + MiInt);
                withBlock.Stats.MinHp = Convert.ToInt16(15 + MiInt);

                MiInt = Matematicas.RandomNumber(1, withBlock.Stats.UserAtributos[(int)Declaraciones.eAtributos.Agilidad] / 6);
                if (MiInt == 1)
                    MiInt = 2;
                ...
                else if (UserClase == Declaraciones.eClass.Cleric | UserClase == Declaraciones.eClass.Druid | UserClase == Declaraciones.eClass.Bard | UserClase == Declaraciones.eClass.Assasin)
                {
                ...
                if (UserClase == Declaraciones.eClass.Mage | UserClase == Declaraciones.eClass.Cleric | UserClase == Declaraciones.eClass.Druid | UserClase == Declaraciones.eClass.Bard | UserClase == Declaraciones.eClass.Assasin)
                {
                ...
                switch (UserClase)
                {
                    ...
                    case Declaraciones.eClass.Worker:
                        {
                            // Herramienta (Newbie)
                            withBlock.Invent.Object_Renamed[Slot].ObjIndex = Convert.ToInt16(Matematicas.RandomNumber(561, 565));
                            break;
                        }
        ...
        public static void CloseSocket(short UserIndex)
        {
            ...
            try
            {
                ...
                if (Declaraciones.UserList[UserIndex].ComUsu.DestUsu > 0)
                {
                    if (Declaraciones.UserList[Declaraciones.UserList[UserIndex].ComUsu.DestUsu].flags.UserLogged)
                    {
                        ...
                        {
                            Protocol.WriteConsoleMsg(Declaraciones.UserList[UserIndex].ComUsu.DestUsu, "Comercio cancelado por el otro usuario", Protocol.FontTypeNames.FONTTYPE_TALK);
                ...
                Declaraciones.UserList[UserIndex].incomingData.ReadASCIIStringFixed(Declaraciones.UserList[UserIndex].incomingData.length);
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "CloseSocket - Error = " + ex.GetType().Name + " - Descripción = " + ex.Message + " - UserIndex = " + UserIndex;
        ...
        public static bool EstaPCarea(ref short Index, ref short Index2)
        {
            ...
            for (Y = Convert.ToInt16(Declaraciones.UserList[Index].Pos.Y - Declaraciones.MinYBorder + 1); Y <= loopTo; Y++)
            {
                ...
                for (X = Convert.ToInt16(Declaraciones.UserList[Index].Pos.X - Declaraciones.MinXBorder + 1); X <= loopTo1; X++)
                {
        ...
        public static bool ValidateChr(short UserIndex)
        {
            ...
            ValidateChrRet = Declaraciones.UserList[UserIndex].Char_Renamed.Head != 0 & Declaraciones.UserList[UserIndex].Char_Renamed.body != 0 & ValidateSkills(UserIndex);
        ...
        public static void ConnectUser(short UserIndex, ref string name, ref string Password)
        {
            ...
            Declaraciones.ObjData Barco;
            {
                ...
                {
                    string argtexto = "El usuario " + withBlock.name + " ha intentado loguear a " + name + " desde la IP " + withBlock.ip;
                    General.LogCheating(ref argtexto);
                    // Kick player ( and leave character inside :D )!
                    CloseSocketSL(UserIndex);
                    UsUaRiOs.Cerrar_Usuario(UserIndex);
                ...
                {
                    Protocol.WriteErrorMsg(UserIndex, "El servidor ha alcanzado el máximo de usuarios soportado, por favor vuelva a intertarlo más tarde.");
                ...
                {
                    if (Extra.CheckForSameIP(UserIndex, withBlock.ip) == true)
                    {
                ...
                // ¿Existe el personaje?
                if (!System.IO.File.Exists(Declaraciones.CharPath + name.ToUpper() + ".chr"))
                {
                ...
                if ((Password.ToUpper() ?? "") != (ES.GetVar(Declaraciones.CharPath + name.ToUpper() + ".chr", "INIT", "Password", EmptySpaces: ref argEmptySpaces).ToUpper() ?? ""))
                {
                ...
                if (ES.EsAdmin(name))
                {
                    ...
                    string argtexto1 = "Se conecto con ip:" + withBlock.ip;
                ...
                else if (ES.EsDios(name))
                {
                    ...
                    string argtexto2 = "Se conecto con ip:" + withBlock.ip;
                ...
                else if (ES.EsSemiDios(name))
                {
                    ...
                    string argtexto3 = "Se conecto con ip:" + withBlock.ip;
                ...
                else if (ES.EsConsejero(name))
                {
                    ...
                    string argtexto4 = "Se conecto con ip:" + withBlock.ip;
                ...
                if (Declaraciones.ServerSoloGMs > 0)
                {
                    ...
                    {
                        Protocol.WriteErrorMsg(UserIndex, "Servidor restringido a administradores. Por favor reintente en unos momentos.");
                        Protocol.FlushBuffer(UserIndex);
                        CloseSocket(UserIndex);
                        return;
                    }
                ...
                {
                    withBlock.CurrentInventorySlots = Convert.ToByte(Declaraciones.MAX_NORMAL_INVENTORY_SLOTS + Declaraciones.ObjData_Renamed[withBlock.Invent.Object_Renamed[withBlock.Invent.MochilaEqpSlot].ObjIndex].MochilaType * 5);
                }
                else
                {
                ...
                if (Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex != 0 | Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].NpcIndex != 0)
                {
                    ...
                    for (tY = withBlock.Pos.Y - 1; tY <= loopTo; tY++)
                    {
                        ...
                        for (tX = withBlock.Pos.X - 1; tX <= loopTo1; tX++)
                        {
                            if (esAgua)
                            {
                                ...
                                if (Extra.LegalPos(withBlock.Pos.Map, Convert.ToInt16(tX), Convert.ToInt16(tY), true, false))
                                {
                                    FoundPlace = true;
                                    break;
                                }
                            ...
                            else if (Extra.LegalPos(withBlock.Pos.Map, Convert.ToInt16(tX), Convert.ToInt16(tY), false, true))
                            {
                                FoundPlace = true;
                                break;
                            }
                    ...
                    else if (Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex != 0)
                    {
                        ...
                        if (Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].ComUsu.DestUsu > 0)
                        {
                            // Le avisamos al que estaba comerciando que se tuvo que ir.
                            if (Declaraciones.UserList[Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].ComUsu.DestUsu].flags.UserLogged)
                            {
                                mdlCOmercioConUsuario.FinComerciarUsu(Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].ComUsu.DestUsu);
                                Protocol.WriteConsoleMsg(Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].ComUsu.DestUsu, "Comercio cancelado. El otro usuario se ha desconectado.", Protocol.FontTypeNames.FONTTYPE_TALK);
                                Protocol.FlushBuffer(Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].ComUsu.DestUsu);
                            }
                            // Lo sacamos.
                            if (Declaraciones.UserList[Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex].flags.UserLogged)
                            {
                                mdlCOmercioConUsuario.FinComerciarUsu(Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex);
                                Protocol.WriteErrorMsg(Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex, "Alguien se ha conectado donde te encontrabas, por favor reconéctate...");
                                Protocol.FlushBuffer(Declaraciones.MapData[withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y].UserIndex);
                            }
                        }
                ...
                if (withBlock.Invent.BarcoObjIndex > 0 & (General.HayAgua(withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y) | UsUaRiOs.BodyIsBoat(withBlock.Char_Renamed.body)))
                {
                ...
                Protocol.WriteChangeMap(UserIndex, withBlock.Pos.Map, Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].MapVersion); // Carga el mapa
                Protocol.WritePlayMidi(UserIndex, Convert.ToByte(Migration.ParseVal(General.ReadField(1, ref Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Music, 45))));

                if (withBlock.flags.Privilegios == Declaraciones.PlayerType.Dios)
                {
                    withBlock.flags.ChatColor = Information.RGB(250, 250, 150);
                }
                else if (withBlock.flags.Privilegios != Declaraciones.PlayerType.User & withBlock.flags.Privilegios != (Declaraciones.PlayerType.User | Declaraciones.PlayerType.ChaosCouncil) & withBlock.flags.Privilegios != (Declaraciones.PlayerType.User | Declaraciones.PlayerType.RoyalCouncil))
                {
                    withBlock.flags.ChatColor = Information.RGB(0, 255, 0);
                }
                else if (withBlock.flags.Privilegios == (Declaraciones.PlayerType.User | Declaraciones.PlayerType.RoyalCouncil))
                {
                    withBlock.flags.ChatColor = Information.RGB(0, 255, 255);
                }
                else if (withBlock.flags.Privilegios == (Declaraciones.PlayerType.User | Declaraciones.PlayerType.ChaosCouncil))
                {
                ...
                UsUaRiOs.MakeUserChar(true, withBlock.Pos.Map, UserIndex, withBlock.Pos.Map, withBlock.Pos.X, withBlock.Pos.Y, ButIndex: ref argButIndex);
                ...
                if (Declaraciones.haciendoBK)
                {
                    ...
                    Protocol.WriteConsoleMsg(UserIndex, "Servidor> Por favor espera algunos segundos, el WorldSave está ejecutándose.", Protocol.FontTypeNames.FONTTYPE_SERVER);
                }

                if (Declaraciones.EnPausa)
                {
                    Protocol.WritePauseToggle(UserIndex);
                    Protocol.WriteConsoleMsg(UserIndex, "Servidor> Lo sentimos mucho pero el servidor se encuentra actualmente detenido. Intenta ingresar más tarde.", Protocol.FontTypeNames.FONTTYPE_SERVER);
                }

                if (Declaraciones.EnTesting & withBlock.Stats.ELV >= 18)
                {
                    Protocol.WriteErrorMsg(UserIndex, "Servidor en Testing por unos minutos, conectese con PJs de nivel menor a 18. No se conecte con Pjs que puedan resultar importantes por ahora pues pueden arruinarse.");
                    Protocol.FlushBuffer(UserIndex);
                    CloseSocket(UserIndex);
                    return;
                }
                ...
                Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].NumUsers = Convert.ToInt16(Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].NumUsers + 1);
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToAll, 0, Protocol.PrepareMessageConsoleMsg("Record de usuarios conectados simultaneamente." + "Hay " + Declaraciones.NumUsers + " usuarios.", Protocol.FontTypeNames.FONTTYPE_INFO));
                    Declaraciones.recordusuarios = Declaraciones.NumUsers;
                    ES.WriteVar(Declaraciones.IniPath + "Server.ini", "INIT", "Record", Conversion.Str(Declaraciones.recordusuarios));

                    Admin.EstadisticasWeb.Informar(clsEstadisticasIPC.EstaNotificaciones.RECORD_USUARIOS, Declaraciones.recordusuarios);
                }
                ...
                if (withBlock.NroMascotas > 0 & Declaraciones.MapInfo_Renamed[withBlock.Pos.Map].Pk)
                {
                    for (i = 1; i <= Declaraciones.MAXMASCOTAS; i++)
                    {
                        ...
                        {
                            withBlock.MascotasIndex[i] = NPCs.SpawnNpc(withBlock.MascotasType[i], ref withBlock.Pos, true, true);
                ...
                {
                    Protocol.WriteMultiMessage(UserIndex, (short)Declaraciones.eMessages.SafeModeOff); // Call WriteSafeModeOff(UserIndex)
                ...
                if (withBlock.GuildIndex > 0)
                {
                    ...
                    {
                        Protocol.WriteConsoleMsg(UserIndex, "Tu estado no te permite entrar al clan.", Protocol.FontTypeNames.FONTTYPE_GUILD);
                    }
                }
                ...
                {
                    Protocol.WriteShowMessageBox(UserIndex, "Tu solicitud de ingreso al clan ha sido rechazada. El clan te explica que: " + tStr);
                }
                ...
                System.IO.File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "logs/numusers.log", Declaraciones.NumUsers.ToString() + Environment.NewLine);

                // Log
                General.AppendLog("logs/Connect.log", withBlock.name + " ha entrado al juego. UserIndex:" + UserIndex + " " + Conversions.ToString(DateAndTime.TimeOfDay) + " " + Conversions.ToString(DateTime.Today));
        ...
        public static void CloseUser(short UserIndex)
        {
            ...
            try
            {
                ...
                modSendData.SendData(modSendData.SendTarget.ToPCArea, UserIndex, Protocol.PrepareMessageCreateFX(Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex, 0, 0));
                ...
                {
                    modSendData.SendData(modSendData.SendTarget.ToPCAreaButIndex, UserIndex, Protocol.PrepareMessageRemoveCharDialog(Declaraciones.UserList[UserIndex].Char_Renamed.CharIndex));
                }
                ...
                if (Declaraciones.MapInfo_Renamed[Map].NumUsers < 0)
                {
                    Declaraciones.MapInfo_Renamed[Map].NumUsers = 0;
                }
                ...
                General.AppendLog("logs/Connect.log", name + " ha dejado el juego. " + "User Index:" + UserIndex + " " + Conversions.ToString(DateAndTime.TimeOfDay) + " " + Conversions.ToString(DateTime.Today));
            }
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en CloseUser. Número " + ex.GetType().Name + " Descripción: " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void ReloadSokcet()
        {
            ...
            catch (Exception ex)
            {
                ...
                string argdesc = "Error en CheckSocketState " + ex.GetType().Name + ": " + ex.Message;
                General.LogError(ref argdesc);
            }
        }
        ...
        public static void EnviarNoche(short UserIndex)
        {
            ...
            Protocol.WriteSendNight(UserIndex, Admin.DeNoche & ((Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Zona ?? "") == Declaraciones.Campo | (Declaraciones.MapInfo_Renamed[Declaraciones.UserList[UserIndex].Pos.Map].Zona ?? "") == Declaraciones.Ciudad) ? true : false);
        ...
        public static void EcharPjsNoPrivilegiados()
        {
            ...
            {
                if (Declaraciones.UserList[LoopC].flags.UserLogged & Declaraciones.UserList[LoopC].ConnID >= 0 & Declaraciones.UserList[LoopC].ConnIDValida)
                {
