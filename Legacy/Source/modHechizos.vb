...
Module modHechizos
    ...
    Sub NpcLanzaSpellSobreUser(NpcIndex As Short, UserIndex As Short, Spell As Short)
        '***************************************************
                ...
                If .flags.Privilegios And PlayerType.User Then
                    ...
                    If .Stats.MinHp < 1 Then
                        ...
                        If Npclist(NpcIndex).MaestroUser > 0 Then
                            'Store it!
                            Call StoreFrag(Npclist(NpcIndex).MaestroUser, UserIndex)
    ...
    Sub NpcLanzaSpellSobreNpc(NpcIndex As Short, TargetNPC As Short, Spell As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Function TieneHechizo(i As Short, UserIndex As Short) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Sub AgregarHechizo(UserIndex As Short, Slot As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Sub DecirPalabrasMagicas(SpellWords As String, UserIndex As Short)
        '***************************************************
        'Author: Unknown
    ...
    Function PuedeLanzar(UserIndex As Short, HechizoIndex As Short) As Boolean
        '***************************************************
        'Author: Unknown
        ...
        With UserList(UserIndex)
            ...
            If .clase = eClass.Druid Then
                If .Invent.AnilloEqpObjIndex = FLAUTAELFICA Then
                    ...
                    ElseIf Hechizos(HechizoIndex).Tipo = TipoHechizo.uInvocacion Then
                        DruidManaBonus = 0.7
    ...
    Sub HechizoTerrenoEstado(UserIndex As Short, ByRef b As Boolean)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Sub HechizoInvocacion(UserIndex As Short, ByRef HechizoCasteado As Boolean)
        '***************************************************
        'Author: Uknown
        ...
        Try
            With UserList(UserIndex)
                ...
                If _
                    ...
                    MapData(.Pos.Map, .Pos.X, .Pos.Y).trigger = eTrigger.ZONASEGURA Then
                    Call _
    ...
    Sub HandleHechizoTerreno(UserIndex As Short, SpellIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: 18/11/2009
    ...
    Sub HandleHechizoUsuario(UserIndex As Short, SpellIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: 12/01/2010
        '18/11/2009: ZaMa - Optimizacion de codigo.
    ...
    Sub HandleHechizoNPC(UserIndex As Short, HechizoIndex As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: 12/01/2010
    ...
    Sub LanzarHechizo(SpellIndex As Short, UserIndex As Short)
        '***************************************************
        'Autor: Unknown (orginal version)
                    ...
                    Select Case Hechizos(SpellIndex).Target
                        Case TargetType.uUsuarios
                            If .flags.TargetUser > 0 Then
                                If Math.Abs(UserList(.flags.TargetUser).Pos.Y - .Pos.Y) <= RANGO_VISION_Y Then
                        ...
                        Case TargetType.uNPC
                            If .flags.TargetNPC > 0 Then
                                If Math.Abs(Npclist(.flags.TargetNPC).Pos.Y - .Pos.Y) <= RANGO_VISION_Y Then
    ...
    Sub HechizoEstadoUsuario(UserIndex As Short, ByRef HechizoCasteado As Boolean)
        '***************************************************
        'Autor: Unknown (orginal version)
    ...
    Sub HechizoEstadoNPC(NpcIndex As Short, SpellIndex As Short, ByRef HechizoCasteado As Boolean,
                         UserIndex As Short)
        '***************************************************
        'Autor: Unknown (orginal version)
        ...
        With Npclist(NpcIndex)
            ...
            If Hechizos(SpellIndex).Inmoviliza = 1 Then
                ...
                Else
                    Call _
                        WriteConsoleMsg(UserIndex, "El NPC es inmune al hechizo.", FontTypeNames.FONTTYPE_INFO)
                End If
            End If
        End With
    ...
    Sub HechizoPropNPC(SpellIndex As Short, NpcIndex As Short, UserIndex As Short,
    ...
    Sub InfoHechizo(UserIndex As Short)
        '***************************************************
        'Autor: Unknown (orginal version)
        ...
        With UserList(UserIndex)
            ...
            If tUser > 0 Then
                ...
                Else
                    Call _
                        WriteConsoleMsg(UserIndex, Hechizos(SpellIndex).PropioMsg, FontTypeNames.FONTTYPE_FIGHT)
                End If
            ElseIf tNPC > 0 Then
                Call _
    ...
    Public Function HechizoPropUsuario(UserIndex As Short) As Boolean
        '***************************************************
        'Autor: Unknown (orginal version)
        'Last Modification: 28/04/2010
            ...
            ElseIf Hechizos(SpellIndex).SubeHP = 2 Then
                ...
                If .Stats.MinHp < 1 Then
                    ...
                    If .flags.AtacablePor <> UserIndex Then
                        'Store it!
                        Call StoreFrag(UserIndex, TargetIndex)
    ...
    Public Function CanSupportUser(CasterIndex As Short, TargetIndex As Short,
        ...
        Try
            ...
            With UserList(CasterIndex)
                ...
                If TriggerZonaPelea(CasterIndex, TargetIndex) = eTrigger6.TRIGGER6_PERMITE Then
                    CanSupportUser = True
                    Exit Function
                End If
    ...
    Sub UpdateUserHechizos(UpdateAll As Boolean, UserIndex As Short, Slot As Byte)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Sub ChangeUserHechizo(UserIndex As Short, Slot As Byte, Hechizo As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Sub DesplazarHechizo(UserIndex As Short, Dire As Short, HechizoDesplazado As Short)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
    ...
    Public Sub DisNobAuBan(UserIndex As Short, ByRef NoblePts As Integer, ByRef BandidoPts As Integer)
        '***************************************************
        'Author: Unknown
        'Last Modification: -
        '
        ...
        With UserList(UserIndex)
            ...
            If .flags.Privilegios And (PlayerType.User Or PlayerType.Consejero) Then
                ...
                Call WriteMultiMessage(UserIndex, eMessages.NobilityLost) _
