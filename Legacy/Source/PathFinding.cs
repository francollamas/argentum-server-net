...
namespace Legacy
{
    static class PathFinding
    {
        ...
        private static bool IsWalkable(short map, short row, short Col, short NpcIndex)
        {
            ...
            IsWalkableRet = Declaraciones.MapData[map, row, Col].Blocked == 0 & Declaraciones.MapData[map, row, Col].NpcIndex == 0;
        ...
        private static void ProcessAdjacents(short MapIndex, ref tIntermidiateWork[,] T, ref short vfila, ref short vcolu, short NpcIndex)
        {
            // ***************************************************
            // Author: Unknown
            // Last Modification: -
        ...
        public static void SeekPath(short NpcIndex, short MaxSteps = 30)
        {
            ...
            tar_npc_pos.X = Declaraciones.Npclist[NpcIndex].PFINFO.Target.X; // UserList(NPCList(NpcIndex).PFINFO.TargetUser).Pos.X
            tar_npc_pos.Y = Declaraciones.Npclist[NpcIndex].PFINFO.Target.Y; // UserList(NPCList(NpcIndex).PFINFO.TargetUser).Pos.Y
