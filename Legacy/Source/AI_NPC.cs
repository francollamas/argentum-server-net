...
internal static class AI
{
        ...
        short OwnerIndex;
        {
            ...
            if (withBlock.flags.Inmovilizado == 1)
            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    ...
                    if ((Math.Abs((short)(Declaraciones.UserList[UserIndex].Pos.X - withBlock.Pos.X)) <=
                         RANGO_VISION_X) &
                        (Math.Sign((short)(Declaraciones.UserList[UserIndex].Pos.X - withBlock.Pos.X)) == SignoEO))
                        if ((Math.Abs((short)(Declaraciones.UserList[UserIndex].Pos.Y - withBlock.Pos.Y)) <=
                             RANGO_VISION_Y) &
                            (Math.Sign((short)(Declaraciones.UserList[UserIndex].Pos.Y - withBlock.Pos.Y)) == SignoNS))
                        {
            ...
            else
            {
                ...
                if (OwnerIndex > 0)
                    ...
                    if (Math.Abs((short)(Declaraciones.UserList[OwnerIndex].Pos.X - withBlock.Pos.X)) <= RANGO_VISION_X)
                        if (Math.Abs((short)(Declaraciones.UserList[OwnerIndex].Pos.Y - withBlock.Pos.Y)) <=
                            RANGO_VISION_Y)
...

                            {
                                ...
                                tHeading = (byte)Extra.FindDirection(ref withBlock.Pos,
                                    ref Declaraciones.UserList[OwnerIndex].Pos);
                ...
                for (i = 1; i <= loopTo1; i++)
                {
                    ...
                    if (Math.Abs((short)(Declaraciones.UserList[UserIndex].Pos.X - withBlock.Pos.X)) <= RANGO_VISION_X)
                            ...
                            RANGO_VISION_Y)
                        {
                            ...
                            UserProtected = !modNuevoTimer.IntervaloPermiteSerAtacado(UserIndex) &
                                            withBlock1.flags.NoPuedeSerAtacado;
                            UserProtected = UserProtected | withBlock1.flags.Ignorado | withBlock1.flags.EnConsulta;

                            if ((withBlock1.flags.Muerto == 0) & (withBlock1.flags.invisible == 0) &
                                (withBlock1.flags.Oculto == 0) & withBlock1.flags.AdminPerseguible & !UserProtected)
                            {
                                if (Declaraciones.Npclist[NpcIndex].flags.LanzaSpells != 0)
                                    NpcLanzaUnSpell(NpcIndex, UserIndex);

                                tHeading = (byte)Extra.FindDirection(ref Declaraciones.Npclist[NpcIndex].Pos,
                                    ref withBlock1.Pos);
                                NPCs.MoveNPCChar(NpcIndex, tHeading);
                                return;
                            }
                ...
                if (Matematicas.RandomNumber(0, 10) == 0)
                    NPCs.MoveNPCChar(NpcIndex,
                        Convert.ToByte(Matematicas.RandomNumber((int)Declaraciones.eHeading.NORTH,
                            (int)Declaraciones.eHeading.WEST)));
            }
        }
            ...
            if ((withBlock.flags.Paralizado == 1) | (withBlock.flags.Inmovilizado == 1))
            {
                ...
                for (i = 1; i <= loopTo; i++)
                {
                    ...
                    if ((Math.Abs((short)(Declaraciones.UserList[UI].Pos.X - withBlock.Pos.X)) <= RANGO_VISION_X) &
                        (Math.Sign((short)(Declaraciones.UserList[UI].Pos.X - withBlock.Pos.X)) == SignoEO))
                        if ((Math.Abs((short)(Declaraciones.UserList[UI].Pos.Y - withBlock.Pos.Y)) <= RANGO_VISION_Y) &
                            (Math.Sign((short)(Declaraciones.UserList[UI].Pos.Y - withBlock.Pos.Y)) == SignoNS))
                            if ((Declaraciones.UserList[UI].name ?? "") == (withBlock.flags.AttackedBy ?? ""))
                            {
                                if (withBlock.MaestroUser > 0)
                                    if (!ES.criminal(withBlock.MaestroUser) & !ES.criminal(UI) &
                                        (Declaraciones.UserList[withBlock.MaestroUser].flags.Seguro |
                                         (Declaraciones.UserList[withBlock.MaestroUser].Faccion.ArmadaReal == 1)))
                                    {
                                    ...
                                    (Declaraciones.UserList[UI].flags.Oculto == 0))
                                {
                                    if (withBlock.flags.LanzaSpells > 0)
                                        NpcLanzaUnSpell(NpcIndex, UI);
                                    else if (Matematicas.Distancia(ref Declaraciones.UserList[UI].Pos,
                                                 ref Declaraciones.Npclist[NpcIndex].Pos) <= 1)
                        ...
                        if (Math.Abs((short)(Declaraciones.UserList[UI].Pos.Y - withBlock.Pos.Y)) <= RANGO_VISION_Y)
                            if ((Declaraciones.UserList[UI].name ?? "") == (withBlock.flags.AttackedBy ?? ""))
                            {
                                    ...
                                    (Declaraciones.UserList[UI].flags.Oculto == 0))
                                {
                                    ...
                                    tHeading = (byte)Extra.FindDirection(ref withBlock.Pos,
                                        ref Declaraciones.UserList[UI].Pos);
                                    NPCs.MoveNPCChar(NpcIndex, tHeading);
                ...
                if (Math.Abs((short)(Declaraciones.UserList[UserIndex].Pos.X - withBlock.Pos.X)) <= RANGO_VISION_X)
                    if (Math.Abs((short)(Declaraciones.UserList[UserIndex].Pos.Y - withBlock.Pos.Y)) <= RANGO_VISION_Y)
                        if (!ES.criminal(UserIndex))
                        {
                            ...
                            {
                                if (withBlock.flags.LanzaSpells > 0) NpcLanzaUnSpell(NpcIndex, UserIndex);
                                tHeading = (byte)Extra.FindDirection(ref withBlock.Pos,
                                    ref Declaraciones.UserList[UserIndex].Pos);
                                NPCs.MoveNPCChar(NpcIndex, tHeading);
                                return;
                            }
                        }
                    ...
                    if (Math.Abs((short)(Declaraciones.UserList[UI].Pos.X - withBlock.Pos.X)) <= RANGO_VISION_X)
                        if (Math.Abs((short)(Declaraciones.UserList[UI].Pos.Y - withBlock.Pos.Y)) <= RANGO_VISION_Y)
                            if ((Declaraciones.UserList[UI].flags.Muerto == 0) &
                                (Declaraciones.UserList[UI].flags.invisible == 0) &
                                (Declaraciones.UserList[UI].flags.Oculto == 0) &
                                (Matematicas.Distancia(ref withBlock.Pos, ref Declaraciones.UserList[UI].Pos) > 3))
                            {
                                tHeading = (byte)Extra.FindDirection(ref withBlock.Pos,
                                    ref Declaraciones.UserList[UI].Pos);
                                NPCs.MoveNPCChar(NpcIndex, tHeading);
    ...
    private static void AiNpcAtacaNpc(short NpcIndex)
    {
...

        {
            ...
            if (withBlock.flags.Inmovilizado == 1)
            {
                ...
                for (Y = withBlock.Pos.Y;
                     SignoNS == 0 || (SignoNS >= 0 ? Y <= loopTo : Y >= loopTo);
                     Y += (short)(SignoNS == 0 ? 1 : SignoNS))
                {
                    var loopTo1 = withBlock.Pos.X + (short)(SignoEO * RANGO_VISION_X);
                    for (X = withBlock.Pos.X;
                         SignoEO == 0 || (SignoEO >= 0 ? X <= loopTo1 : X >= loopTo1);
                         X += (short)(SignoEO == 0 ? 1 : SignoEO))
                        if ((X >= Declaraciones.MinXBorder) & (X <= Declaraciones.MaxXBorder) &
                            (Y >= Declaraciones.MinYBorder) & (Y <= Declaraciones.MaxYBorder))
                        {
                            ...
                            if (NI > 0)
                                if (withBlock.TargetNPC == NI)
                                {
                                    ...
                                    else if (Matematicas.Distancia(ref withBlock.Pos,
                                                 ref Declaraciones.Npclist[NI].Pos) <= 1)
                                    {
                            ...
                            (Y >= Declaraciones.MinYBorder) & (Y <= Declaraciones.MaxYBorder))
                        {
                            ...
                            if (NI > 0)
                                if (withBlock.TargetNPC == NI)
                                {
                                    ...
                                    tHeading = (byte)Extra.FindDirection(ref withBlock.Pos,
                                        ref Declaraciones
                                            .Npclist[Declaraciones.MapData[withBlock.Pos.Map, X, Y].NpcIndex].Pos);
                                    NPCs.MoveNPCChar(NpcIndex, tHeading);
                                    return;
                                }
                        }
    ...
    public static void NPCAI(short NpcIndex)
    {
        ...
        {
            {
                ...
                if (withBlock.MaestroUser == 0)
                {
                    ...
                    else if (withBlock.Hostile != 0 && withBlock.Stats.Alineacion == 0) HostilBuenoAI(NpcIndex);
                }
        ...
        catch (Exception ex)
        {
            ...
            var argdesc = "NPCAI " + Declaraciones.Npclist[NpcIndex].name + " " +
                          Declaraciones.Npclist[NpcIndex].MaestroUser + " " +
                          Declaraciones.Npclist[NpcIndex].MaestroNpc + " mapa:" +
                          Declaraciones.Npclist[NpcIndex].Pos.Map + " x:" + Declaraciones.Npclist[NpcIndex].Pos.X +
                          " y:" + Declaraciones.Npclist[NpcIndex].Pos.Y + " Mov:" +
                          ((int)Declaraciones.Npclist[NpcIndex].Movement) + " TargU:" +
                          Declaraciones.Npclist[NpcIndex].Target + " TargN:" +
    ...
    public static bool ReCalculatePath(short NpcIndex)
    {
        ...
        else if (!UserNear(NpcIndex) & (Declaraciones.Npclist[NpcIndex].PFINFO.PathLenght ==
                                        Declaraciones.Npclist[NpcIndex].PFINFO.CurPos - 1)) ReCalculatePathRet = true;
                    ...
                    if ((X > Declaraciones.MinXBorder) & (X < Declaraciones.MaxXBorder) &
                        ...
                        if (Declaraciones.MapData[withBlock.Pos.Map, X, Y].UserIndex > 0)
                        {
                            ...
                            tmpUserIndex = Declaraciones.MapData[withBlock.Pos.Map, X, Y].UserIndex;
                            {
                                ...
                                if ((withBlock1.flags.Muerto == 0) & (withBlock1.flags.invisible == 0) &
                                    (withBlock1.flags.Oculto == 0) & withBlock1.flags.AdminPerseguible)
                                {
