...
Errhandler: 
	...
	Sub ConfigListeningSocket(ByRef Obj As Object, ByVal Port As Short)
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
...
#End If
	...
	Function FileExist(ByVal file As String, Optional ByRef FileType As FileAttribute = vbNormal) As Boolean
		'*****************************************************************
	...
	Function ReadField(ByVal Pos As Short, ByRef Text As String, ByVal SepASCII As Byte) As String
		...
		Dim delimiter As New VB6.FixedLengthString(1)
		
		delimiter.Value = Chr(SepASCII)
		
		For i = 1 To Pos
			LastPos = CurrentPos
			CurrentPos = InStr(LastPos + 1, Text, delimiter.Value, CompareMethod.Binary)
		Next i
