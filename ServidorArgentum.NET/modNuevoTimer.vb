...
Module modNuevoTimer
	...
	' CASTING DE HECHIZOS
	Public Function IntervaloPermiteLanzarSpell(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
	...
	Public Function IntervaloPermiteAtacar(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
	...
	Public Function IntervaloPermiteGolpeUsar(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: ZaMa
	...
	Public Function IntervaloPermiteMagiaGolpe(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
	...
	Public Function IntervaloPermiteGolpeMagia(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
	...
	' USAR OBJETOS
	Public Function IntervaloPermiteUsar(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
	...
	Public Function IntervaloPermiteUsarArcos(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = True) As Boolean
		'***************************************************
		'Author: Unknown
		'Last Modification: -
		'
	...
	Public Function IntervaloPermiteSerAtacado(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = False) As Boolean
		'**************************************************************
		'Author: ZaMa
		'Last Modify by: ZaMa
	...
	Public Function IntervaloPerdioNpc(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = False) As Boolean
		'**************************************************************
		'Author: ZaMa
		'Last Modify by: ZaMa
		'Last Modify Date: 13/11/2009
	...
	Public Function IntervaloEstadoAtacable(ByVal UserIndex As Short, Optional ByVal Actualizar As Boolean = False) As Boolean
		'**************************************************************
		'Author: ZaMa
		'Last Modify by: ZaMa
