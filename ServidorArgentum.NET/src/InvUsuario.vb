...
Module InvUsuario
    ...
    Public Function TieneObjetosRobables(ByVal UserIndex As Short) As Boolean
        ...
        For i = 1 To UserList(UserIndex).CurrentInventorySlots
            ...
            If ObjIndex > 0 Then
                If _
                    (ObjData_Renamed(ObjIndex).OBJType <> Declaraciones.eOBJType.otLlaves And
                     ObjData_Renamed(ObjIndex).OBJType <> Declaraciones.eOBJType.otBarcos) Then
            ...
            If (Cantidad > 0) And (Cantidad <= .Stats.GLD) Then
                ...
                Do While (Cantidad > 0)
                    ...
                    If EsGM(UserIndex) Then _
                        Call _
                            LogGM(.name,
                                  "Tiró cantidad:" & MiObj.Amount & " Objeto:" & ObjData_Renamed(MiObj.ObjIndex).name)
        ...
        With UserList(UserIndex)
            If num > 0 Then
                ...
                If _
                    ...
                    If Not .flags.Privilegios And Declaraciones.PlayerType.User Then _
                        Call _
                            LogGM(.name,
    ...
    Private Function CheckRazaUsaRopa(ByVal UserIndex As Short, ByRef ItemIndex As Short,
        ...
        With UserList(UserIndex)
            ...
            If _
                .raza = Declaraciones.eRaza.Humano Or .raza = Declaraciones.eRaza.Elfo Or
                .raza = Declaraciones.eRaza.Drow Then
        ...
        With UserList(UserIndex)
            ...
            Select Case Obj_Renamed.OBJType
                Case Declaraciones.eOBJType.otUseOnce
                    ...
                    If _
                        ObjIndex = Declaraciones.e_ObjetosCriticos.Manzana Or
                        ObjIndex = Declaraciones.e_ObjetosCriticos.Manzana2 Or
                        ObjIndex = Declaraciones.e_ObjetosCriticos.ManzanaNewbie Then
                        Call _
                ...
                Case Declaraciones.eOBJType.otWeapon
                    ...
                    If Not .Stats.MinSta > 0 Then
                        Call _
                            WriteConsoleMsg(UserIndex,
                                            "Estás muy cansad" & IIf(.Genero = Declaraciones.eGenero.Hombre, "o", "a") &
                                            ".", Protocol.FontTypeNames.FONTTYPE_INFO)
                        Exit Sub
                    End If
                    ...
                    If ObjData_Renamed(ObjIndex).proyectil = 1 Then
                        ...
                        End If
                        Call _
                            WriteMultiMessage(UserIndex, Declaraciones.eMessages.WorkRequestTarget,
                                              Declaraciones.eSkill.Proyectiles) _
                ...
                Case Declaraciones.eOBJType.otPociones
                    ...
                    Select Case .flags.TipoPocion
                        ...
                        Case 1 'Modif la agilidad
                            ...
                            If .Stats.UserAtributos(Declaraciones.eAtributos.Agilidad) > MAXATRIBUTOS Then _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Agilidad) = MAXATRIBUTOS
                            If _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Agilidad) >
                                2*.Stats.UserAtributosBackUP(Declaraciones.eAtributos.Agilidad) Then _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Agilidad) = 2*
                        ...
                        Case 2 'Modif la fuerza
                            ...
                            .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) =
                                .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) +
                                RandomNumber(Obj_Renamed.MinModificador, Obj_Renamed.MaxModificador)
                            If .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) > MAXATRIBUTOS Then _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) = MAXATRIBUTOS
                            If _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) >
                                2*.Stats.UserAtributosBackUP(Declaraciones.eAtributos.Fuerza) Then _
                                .Stats.UserAtributos(Declaraciones.eAtributos.Fuerza) = 2*
                                                                                        .Stats.UserAtributosBackUP(
                                                                                            Declaraciones.eAtributos.
                                                                                                                      Fuerza)
                ...
                Case Declaraciones.eOBJType.otMinerales
                    If .flags.Muerto = 1 Then
                        ...
                        Exit Sub
                    End If
                    Call WriteMultiMessage(UserIndex, Declaraciones.eMessages.WorkRequestTarget, FundirMetal) _
                    'Call WriteWorkRequestTarget(UserIndex, FundirMetal)
                    ...
                    If Obj_Renamed.Real Then '¿Es el Cuerno Real?
                        If FaccionPuedeUsarItem(UserIndex, ObjIndex) Then
                            ...
                            Else
                                ...
                                Call _
                                    SendData(modSendData.SendTarget.toMap, .Pos.Map,
    ...
    Public Function ItemSeCae(ByVal index As Short) As Boolean
        ...
        With ObjData_Renamed(index)
            ItemSeCae = (.Real <> 1 Or .NoSeCae = 0) And (.Caos <> 1 Or .NoSeCae = 0) And
                        .OBJType <> Declaraciones.eOBJType.otLlaves And .OBJType <> Declaraciones.eOBJType.otBarcos And
                        .NoSeCae = 0
        End With
    End Function
