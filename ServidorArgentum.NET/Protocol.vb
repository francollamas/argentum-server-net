...
Errhandler: 
	...
	Private Sub HandleUpTime(ByVal UserIndex As Short)
		...
		time = (CShort(GetTickCount() And &H7FFFFFFF) - tInicioServer) \ 1000
...
Errhandler: 
	...
	Private Sub HandleCreateItem(ByVal UserIndex As Short)
		...
		With UserList(UserIndex)
			...
			'UPGRADE_ISSUE: No se admite la función LenB. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
			If LenB(ObjData_Renamed(tObj).name) = 0 Then Exit Sub
...
Errhandler: 
	...
	Public Sub HandleShowServerForm(ByVal UserIndex As Short)
		...
		With UserList(UserIndex)
			...
			Call frmMain.mnuMostrar_Click(Nothing, New System.EventArgs())
		End With
	End Sub
		...
		With UserList(UserIndex)
			...
			If (Not .flags.Privilegios And Declaraciones.PlayerType.RoleMaster) <> 0 And (.flags.Privilegios And (Declaraciones.PlayerType.Admin Or Declaraciones.PlayerType.Dios)) Then
				...
				Else
					...
					'UPGRADE_ISSUE: No se puede determinar a qué constante se va a actualizar vbNormal. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="B3B44E51-B5F1-4FD7-AA29-CAD31B71F487"'
					If FileExist(Char_Renamed, vbNormal) Then
...
Errhandler: 
	...
	Public Sub WriteTrainerCreatureList(ByVal UserIndex As Short, ByVal NpcIndex As Short)
		...
		With UserList(UserIndex).outgoingData
			...
			'UPGRADE_ISSUE: No se admite la función LenB. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
			If LenB(str_Renamed) > 0 Then str_Renamed = Left(str_Renamed, Len(str_Renamed) - 1)
