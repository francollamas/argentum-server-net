...
Friend Class clsByteQueue
	...
	Public Function WriteASCIIStringFixed(ByVal value As String) As Integer
		...
		'UPGRADE_ISSUE: No se admite la función StrPtr. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="367764E5-F3F8-4E43-AC3E-7FE0B5E074E2"'
	...
	Public Function ReadASCIIStringFixed(ByVal length As Integer) As String
		...
		If queueLength >= length Then
			...
			'UPGRADE_ISSUE: No se actualizó la constante vbUnicode. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="55B59875-9A95-4B71-9D6A-7C294BF7139D"'
	...
	Public Function ReadUnicodeStringFixed(ByVal length As Integer) As String
		...
		If queueLength >= length * 2 Then
			...
			'UPGRADE_TODO: El código se actualizó para usar System.Text.UnicodeEncoding.Unicode.GetString(), que podría no tener el mismo comportamiento. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="93DD716C-10E3-41BE-A4A8-3BA40157905B"'
